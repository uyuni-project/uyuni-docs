...
[source]
--
사용법: org_addtrust YOUR_ORG ORG_TO_TRUST
--
...
[source]
--
사용법: org_removetrust YOUR_ORG TRUSTED_ORG
--
...
[source]
--
사용법: org_rename OLDNAME NEWNAME
--
...
[source]
--
사용법: org_trustdetails TRUSTED_ORG
--
