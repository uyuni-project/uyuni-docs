...
. Create a YAML file describing the infrastructure you intend to install. For an example YAML file, see xref:retail:retail-mass-config-yaml.adoc[].
...
. Create a YAML file describing the infrastructure you intend to install, specifying the hardware address for each terminal. For an example YAML file, see xref:retail:retail-mass-config-yaml.adoc[].
