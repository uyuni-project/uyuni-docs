...
The very first time you set up the {productname} {smr} environment, you will need to perform all three steps. You will need to revisit some of these steps later on as you are working with {productname} {smr}.
