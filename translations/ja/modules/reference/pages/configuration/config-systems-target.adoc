...
To prepare a system, check the box to the left of the profile name then click the btn:[Enable {productname} Configuration Management] button. All of the preparatory steps that can be automatically performed are scheduled by {productname}.
