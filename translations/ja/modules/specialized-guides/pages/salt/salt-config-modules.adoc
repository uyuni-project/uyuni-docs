...
You can use the {uyuni} configuration modules directly or using SLS files. They are especially useful if you have multiple {productname} Servers, for example in Hub installations, but they are also useful for smaller installations.
