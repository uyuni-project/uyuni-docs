...
Then specify the argument you are interested in. For example, [literal]``channels``:
...
[IMPORTANT]
====
{sle} channels can be very large. Synchronization can sometimes take several hours.
====
