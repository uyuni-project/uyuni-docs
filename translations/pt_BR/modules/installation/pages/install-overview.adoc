...
This book provides guidance on installing {productname}. It is split into three sections:
...
It is possible to use a public cloud instance to install {productname}. For more information on using {productname} on a public cloud, see xref:quickstart-public-cloud:qs-publiccloud-overview.adoc[].
