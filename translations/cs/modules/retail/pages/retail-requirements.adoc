...
Before you install {productname} {smr}, ensure your environment meets the minimum requirements. This section lists the requirements for the {productname} {smr} installation.

Review also general requirements of the {productname} listed at xref:installation-and-upgrade:general-requirements.adoc[].
