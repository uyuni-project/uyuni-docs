...
This section contains information about registering Salt clients running openSUSE operating systems. {productname} supports openSUSE Leap 15 clients using Salt. Traditional clients are not supported.
