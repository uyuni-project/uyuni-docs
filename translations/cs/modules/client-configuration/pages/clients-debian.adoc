...
[IMPORTANT]
====
{suse} does not provide support for {debian} operating systems. {productname} allows you to manage {debian} clients, but support is not provided. Using {productname} to manage {debian} clients is experimental. These instructions have been tested on {debian}{nbsp}9 Stretch and {debian}{nbsp}10 Buster. Do not rely on {debian} clients in a production environment.
====
