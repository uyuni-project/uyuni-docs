...
[NOTE]
====
Registering {rocky} clients to {productname} is tested with the default SELinux configuration of ``enforcing`` with a ``targeted`` policy. You do not need to disable SELinux to register {rocky} clients to {productname}.
====
