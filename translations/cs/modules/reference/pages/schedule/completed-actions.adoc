...
The menu:Schedule[Completed Actions] section shows actions that have been successfully completed. Use the [guimenu]``Filter by Action`` field to search the list. Archive completed actions by checking the action in the list, and clicking btn:[Archive Actions].
