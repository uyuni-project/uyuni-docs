...
[IMPORTANT]
====
The formula is used only for connecting {productname} Proxy 4.3. with {productname} Server {productnumber}. Do not use this formula if you want to connect {productname} Proxy {productnumber}.
====
