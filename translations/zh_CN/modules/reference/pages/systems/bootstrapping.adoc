...
When you have completed the details of the client you want to register, click btn:[Bootstrap]. When the client has completed registering, navigate to menu:Systems[System List] to see details.
