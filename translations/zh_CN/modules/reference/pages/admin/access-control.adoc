...
. Define Namespaces and Permissions. The following permissions types are available:
...
Review and verify the information, and confirm to create the access group. ____
