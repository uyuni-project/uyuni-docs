...
For a fresh server with secure boot, [literal]`shim-x64-15.8-2.el8_10.x86_64` package is installed during liberation. The other components must be updated manually to specific versions.
...
[IMPORTANT]
====
These specific version numbers are for a fresh {rhel} 8.10 installation. If your server has been updated, the required versions may be different.
====
____
