...
If the schema upgrade fails, the database version check and all the other spacewalk services do not start. Run [command]``mgradm start`` on the container host for more information and hints how to proceed.
