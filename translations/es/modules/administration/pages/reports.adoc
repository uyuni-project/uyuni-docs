...
Parches::  List all the patches relevant to the registered systems. You can sort patches by severity, as well as the systems that apply to a particular patch.

Usuarios::  List all registered users and any systems associated with a particular user.
