...
This section provides links to actions related to autoinstallation. You can also access these using the menu:Systems[Autoinstallation] menu.
...
Click btn:[Create Kickstart Profile] to create a new {kickstart} profile. Click btn:[Upload Kickstart/{ay} File] to upload a new autoinstallation file.
