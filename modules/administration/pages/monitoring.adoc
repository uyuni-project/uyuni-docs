...
:description: Monitor your SUSE Manager environment with Prometheus and Grafana, collecting and visualizing real-time metrics from across the network
:revdate: 2025-07-04
...
To enable self-health monitoring on a proxy, you need to manually install exporters, including [literal]``prometheus-postgres_exporter``, and enable them.
====
