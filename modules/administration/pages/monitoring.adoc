...
For more information about the monitoring formulas, see xref:specialized-guides:salt-formula-monitoring.adoc[].
...
For more information about the monitoring formulas with forms, see xref:specialized-guides:salt-formula-monitoring.adoc[].
...
For more information about configuring all available options, see xref:specialized-guides:salt-formula-monitoring.adoc[].
