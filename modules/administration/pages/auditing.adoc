...
1. **Channels:** Channels include the updated software packages, which include patches, and provide insights into the essential patches required to address CVEs.
...
To ensure the integrity and currency of the OVAL data, {productname} exclusively depend on data provided by the OS products maintainers. Below, you can find the list of OVAL data sources.
