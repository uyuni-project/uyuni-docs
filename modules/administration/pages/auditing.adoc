[[auditing]]
= Auditing
:description: Learn how to manage client tracking through auditing tasks in SUSE Manager, including tasks like subscription matching, patch status verification,
:revdate: 2023-12-18
