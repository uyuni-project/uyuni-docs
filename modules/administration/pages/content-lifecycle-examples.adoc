...
NOTE: This procedure can be automated using a filter template. For more information on how to apply a live patching filter template, see xref:administration:content-lifecycle.adoc#filter-templates[].
