[[mgr.sync]]
= Using ``mgr-sync``
:description: Configure your SUSE Manager infrastructure using mgr-sync commands to connect to the SUSE Customer Center, retrieve product and package information,
:revdate: 2024-11-29
