[[mgr.sync]]
= Using ``mgr-sync``
:description: Learn how to use `mgr-sync` with a support subscription to connect to the Customer Center and manage product channels, organization credentials, and products.
:revdate: 2024-11-29
