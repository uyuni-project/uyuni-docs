...
Ideally the root CA should be alone in its file and the server certificate file should start with the certificate and then all the intermediate CA certificate in order.
