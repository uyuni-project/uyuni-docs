[[disconnected-setup]]
= Disconnected Setup
:description: Learn how to configure and set up SUSE Manager in an entirely offline environment by mirroring software channels and repositories to removable storage
:revdate: 2024-12-02
