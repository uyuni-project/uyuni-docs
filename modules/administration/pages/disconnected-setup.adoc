[[disconnected-setup]]
= Disconnected Setup
:description: Use a disconnected setup to manage your Server in an offline systems and synchronize software channels and repositories to a removable storage device.
:revdate: 2025-05-27
