[[disconnected-setup]]
= Disconnected Setup
:description: To synchronize channels and repositories in a disconnected MLM setup, you must first enable the corresponding mandatory Client Tools Channels.
:revdate: 2025-05-27
