[[reports]]
= Generate Reports
:description: Configure and generate various reports in SUSE Manager to track inventory, user accounts, and organizational entities across managed systems
:revdate: 2024-05-08
