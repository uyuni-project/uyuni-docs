:description: To install the SCAP security guide package, search for 'scap-security-guide' in your system's packages and select the suitable one for your operating system.
