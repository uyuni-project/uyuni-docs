[[maintenance-windows]]
= Maintenance Windows
:description: Learn how to schedule actions using the maintenance windows feature in SUSE Manager, which allows you to control when clients can run restricted or unrestricted
:revdate: 2025-08-14
