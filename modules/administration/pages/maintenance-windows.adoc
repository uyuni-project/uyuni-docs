[[maintenance-windows]]
= Maintenance Windows
:description: Setting up maintenance windows in MLM, administrators can manage when restricted actions are allowed on clients, ensuring smoother system updates and minimizing.
:revdate: 2021-09-01
