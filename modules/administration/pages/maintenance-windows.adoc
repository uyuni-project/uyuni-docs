[[maintenance-windows]]
= Maintenance Windows
:description: Schedule maintenance windows in SUSE Manager to restrict actions and ensure system integrity during designated periods by learning about this process
:revdate: 2021-09-01
