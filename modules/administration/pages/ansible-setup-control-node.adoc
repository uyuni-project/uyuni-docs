...
[NOTE]
====
The following procedure applies for {sles} 15 system only.
On some systems, for example {almalinux}_9, Ansible is available from the distribution packages; in such a case, the user can install  it manually.
====


.Procedure: Setting up Ansible Control Node on a {sles} 15 system
