...
. From the {webui} under menu:Admin[Setup Wizard > Products], verify that the product [literal]``SUSE Linux Enterprise Server 15 SP3 x86_64`` channel and [literal]``SUSE Manager Client Tools for SLE 15 x86_64`` are installed and synchronized.
