...
{productname} introduces a container-based KIWI image build system, in addition to the existing legacy KIWI and KIWI NG tools.


==== Configuration and overrides 

Administrators can override the default behavior using the following pillar or custom values.
To configure these, navigate to menu[Systems]: Custom System Info in the Web UI and create the necessary keys
