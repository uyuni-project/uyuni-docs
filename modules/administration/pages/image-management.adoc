...
Images are always stored in [path]``/srv/www/os-images/<organization_id>`` and are accessible via HTTP/HTTPS [url]``https://<susemanager_host>/os-images/<organization_id>``.
endif::[]

ifeval::[{uyuni-content} == true]
Images are always stored in [path]``/srv/www/os-images/<organization_id>`` and are accessible via HTTP/HTTPS [url]``https://<uyuni_host>/os-images/<organization_id>``.
endif::[]
