...
The containers built using {productname} will use channels associated to the activation key as repositories when building the image. This section will guide you into creating an ad-hoc activation key for this purpose.
