[[actions]]
= Actions
:description: Manage and schedule automated recurring actions for clients on your SUSE Manager server using various action types such as highstate execution, custom states
:revdate: 2024-04-09
