[[actions]]
= Actions
:description: You can create and manage recurring actions on Salt clients to automate tasks, such as applying highstates or custom states at specified schedules.
:revdate: 2025-05-12
