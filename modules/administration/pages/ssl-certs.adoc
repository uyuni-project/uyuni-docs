[[ssl-certs]]
= SSL Certificates
:description: Learn how to manage SSL certificates for secure client registration in SUSE Manager, understanding both self-signed and third-party certificate options
:revdate: 2025-01-02
