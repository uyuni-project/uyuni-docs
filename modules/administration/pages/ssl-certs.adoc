[[ssl-certs]]
= SSL Certificates
:description: To use SSL certificates securely with Server, ensure clients trust the root CA and can access the entire chain of intermediate certificates.
:revdate: 2025-05-08
