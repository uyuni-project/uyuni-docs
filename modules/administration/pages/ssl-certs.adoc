[[ssl-certs]]
= SSL Certificates
:description: Configure SSL certificates in SUSE Manager, ensuring secure client-server connections, by validating server identities with trusted certificate authorities
:revdate: 2025-02-06
