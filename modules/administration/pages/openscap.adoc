...
:description: Learn how to prepare your clients, such as Server, Proxy, or Client, for SCAP scanning by installing required packages and meeting memory requirements.
:revdate: 2025-06-17
