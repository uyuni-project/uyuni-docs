...
:description: Deploy OpenSCAP to audit clients in SUSE Manager using SCAP-compliant standards from NIST, enabling system security through compliance scans with customizable
:revdate: 2025-07-01
