...
For scanning {redhat} clients, install the appropriate ``scap-security-guide`` and ``openscap-utils`` packages on the client before you begin:

[[openscap-secguide]]
[cols="1,1", options="header"]
.scap-security-guide packages and client systems
|===
| Package name | Client family
| ``scap-security-guide``        | SLES and openSUSE
| ``scap-security-guide-debian`` | Debian
| ``scap-security-guide-redhat`` | Red Hat, CentOS, and Oracle Linux
| ``scap-security-guide-ubuntu`` | Ubuntu
|===
