[[space-management]]
= Managing Disk Space
:description: Configure and manage disk space to prevent severe impacts on your SUSE Manager database and file structure; ensure sufficient free space is always available
:revdate: 2023-03-14
