[[patch-management]]
= Patch Management
:description: Configure patches effectively using SUSE Manager s mechanisms for managing undesirable side effects, such as retraction and propagation of advisory statuses
:revdate: 2022-02-17
