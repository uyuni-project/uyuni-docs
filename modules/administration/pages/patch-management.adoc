[[patch-management]]
= Patch Management
:description: Learn how to manage retracted patches and packages in your system, including understanding their status, propagation, and impact on Client systems.
:revdate: 2022-02-17
