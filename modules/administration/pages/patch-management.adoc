[[patch-management]]
= Patch Management
:description: You can manage retracted patches by setting their advisory status to retracted and synchronizing cloned channels using Patch Sync or Content Lifecycle.
:revdate: 2022-02-17
