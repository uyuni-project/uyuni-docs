...
When you have registered clients as virtual hosts, you can manage their virtual guests directly using the {productname} {webui}.

Navigate to menu:Systems[Systems List] and select the virtual host.
Navigate to the menu:Systems[Virtualization] subtab to manage the selected clients virtual guests.

For traditional clients registered as virtual hosts, you can use the menu:Systems[Virtualization] subtab to provision and deploy new virtual guests.

For Salt clients registered as virtual hosts, you can use the menu:Systems[Virtualization] subtab to manage your virtual storage pools and volumes.
...
////
Content from Ref Guide. --LKB 2020-08-10
