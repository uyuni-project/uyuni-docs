...
= Task Schedules
:description: Learn how to manage and configure task schedules, including predefined bunches and custom settings for auto-updates, repository metadata, and other tasks
:revdate: 2025-07-02
