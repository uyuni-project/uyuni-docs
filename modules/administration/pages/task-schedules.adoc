...
= Task Schedules
:description: Configure predefined task schedules in SUSE Manager to automate tasks such as updating errata, synchronizing Cobbler data, generating repository metadata files
:revdate: 2025-07-03
