...
:description: Enable server-side synchronization of source repositories in the rhn.conf file to learn how to mirror source packages on SUSE Manager Server
:revdate: 2020-11-12
