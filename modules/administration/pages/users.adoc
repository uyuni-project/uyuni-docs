[[users]]
= Users
:description: Administrators manage users through the Users menu, allowing them to deactivate or delete accounts when no longer required for organizational security.
:revdate: 2025-07-24
