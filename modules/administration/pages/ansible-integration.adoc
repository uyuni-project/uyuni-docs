[[ansible-integration]]
= Ansible Integration
:description: Configure Ansible features with SUSE Manager to manage computer client systems, automate tasks through inventory inspection, discovery, and playbook execution
:revdate: 2025-08-18
