[[ansible-integration]]
= Ansible integration
:description: Configure Ansible integration with SUSE Manager by registering your existing Ansible Control Node as a Salt client and enabling Ansible as the system type
:revdate: 2024-03-11
