[[organizations]]
= Organizations
:description: Learn how to create and manage organizations in MLM, including user access, permissions, authentication methods, and configuring organization settings.
:revdate: 2022-01-13
