[[organizations]]
= Organizations
:description: Learn how to manage user access and permissions in SUSE Manager by setting up organizations with customizable roles and authentication methods
:revdate: 2022-01-13
