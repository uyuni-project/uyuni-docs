[[organizations]]
= Organizations
:description: Manage organizations to create and assign users, configure authentication methods, and set permissions for user access and control within your systems.
:revdate: 2022-01-13
