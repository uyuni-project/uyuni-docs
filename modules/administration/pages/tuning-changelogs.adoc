[[tuning-changelogs]]
= Tuning Changelogs
:description: Learn how to optimize SUSE Manager performance by configuring the java.maxchangelogentries parameter and deleting cached data to minimize disk space usage
:revdate: 2024-05-10
