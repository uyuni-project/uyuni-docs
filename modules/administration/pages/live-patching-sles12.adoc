...
:description: Configure SLES12 systems to manage live patching with kGraft by ensuring SUSE Manager is up-to-date and Salt clients are registered, synchronized, and assigned
:revdate: 2024-02-01
