...
:description: Enable live patching on SLES12 systems with kGraft and SUSE Manager, allowing for the application of security updates without a system reboot
:revdate: 2023-11-10
