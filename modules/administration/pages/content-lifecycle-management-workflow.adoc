[[workflow-clm]]
= Content Lifecycle Management Workflow
...
+
image::workflow_clm_new_project.png[scaledwidth=80%]
...
+
image::workflow_clm_add_sources.png[scaledwidth=80%]
...
+
image::workflow_clm_environments.png[scaledwidth=80%]
. Click btn:[Build] to build version 1 of your project:
+
image::workflow_clm_build_1.png[scaledwidth=80%]
...
+
image::workflow_clm_assign.png[scaledwidth=80%]
...
+
image::workflow_clm_promote.png[scaledwidth=80%]
