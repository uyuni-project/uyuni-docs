...
:description: To set up validation from Client to master in a highly secure network configuration, enter the master's fingerprint within your Salt minion configuration file.
:revdate: 2024-12-12
