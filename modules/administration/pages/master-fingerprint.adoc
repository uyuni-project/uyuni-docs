...
:description: Set up validation from your Client to Master by entering the master's fingerprint in the minion configuration file and restarting the service.
:revdate: 2024-12-12
