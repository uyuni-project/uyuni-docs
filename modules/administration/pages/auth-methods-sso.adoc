...
:description: Configure single sign-on (SSO) in SUSE Manager to enable users to access multiple applications using a single set of credentials, improving authentication
:revdate: 2025-06-06
