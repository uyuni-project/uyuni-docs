...
----
. Sign in as a privileged user, and use the Keycloak {webui} to create a realm using these details:
+
...
* Toggle the ``Includew AuthnStatement`` switch to ``On``.
...
Restart the {productname} Server to pick up your changes, and navigate to the to {productname} {webui}.
