[[channel-management]]
= Channel Management
:description: You can manage software packages by organizing them into channels that are assigned to clients based on their operating system and architecture.
:revdate: 2025-02-28
