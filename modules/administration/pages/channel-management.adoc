[[channel-management]]
= Channel Management
:description: Learn to create and manage software channels in SUSE Manager for efficient package installation and management
:revdate: 2024-03-08
...
* For more information about deleting channels manually, see xref:removing-channels.adoc[].
endif::[]
