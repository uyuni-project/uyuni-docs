...
:description: Learn how to successfully rename a SUSE Manager Server by following detailed procedures for updating settings, reconfiguring clients, and deploying new
:revdate: 2025-06-23
