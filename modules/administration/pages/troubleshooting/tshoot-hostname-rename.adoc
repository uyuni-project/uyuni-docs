...
:description: To successfully rename the Server hostname, update the settings in the PostgreSQL database and internal structures using the spacewalk-hostname-rename script.
:revdate: 2025-02-18
