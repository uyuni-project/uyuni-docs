...
:description: Learn how to successfully rename a SUSE Manager Server by updating its database settings and propagating the changes through its clients and proxies
:revdate: 2025-07-16
