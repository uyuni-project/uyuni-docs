...
= Troubleshooting Disk Space
:description: Learn how to recover disk space in SUSE Manager by removing unused software channels, cleaning up activation keys, and running database maintenance
:revdate: 2022-11-08
