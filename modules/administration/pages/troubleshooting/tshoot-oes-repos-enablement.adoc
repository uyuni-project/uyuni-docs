...
= Troubleshooting OES repositories enablement
:description: Enabling Open Enterprise Server (OES) on Server involves setting up credentials and completing a refresh operation to make OES visible in the product list.
:revdate: 2022-11-03
