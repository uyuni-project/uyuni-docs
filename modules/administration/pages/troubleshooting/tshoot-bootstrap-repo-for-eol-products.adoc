...
:description: To continue using an end-of-life product, create a manual bootstrap repository on the Server via the command prompt of the Container host as root.
:revdate: 2024-10-31
