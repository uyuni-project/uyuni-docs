...
:description: To resolve registration issues with deleted clients, delete specified Salt cache files on the Server before attempting re-registration again.
:revdate: 2024-05-10
