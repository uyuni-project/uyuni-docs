...
= Troubleshooting Firewalls
:description: Configure your firewall to allow access to third-party URLs required by non-Client repositories, allowing synchronization to reach and complete successfully.
:revdate: 2025-02-06
