...
:description: Learn how to register a traditional client as a Salt minion again after deletion, by removing specific files and packages from the client beforehand
:revdate: 2022-11-07
