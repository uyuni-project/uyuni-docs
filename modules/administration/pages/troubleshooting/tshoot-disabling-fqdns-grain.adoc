...
:description: Configure Salt to disable the FQDNs grain with a flag or state module, then leverage network modules for DNS services provisioning to prevent potential client
:revdate: 2022-11-07
