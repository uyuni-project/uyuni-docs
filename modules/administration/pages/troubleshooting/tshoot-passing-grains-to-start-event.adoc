...
:description: To avoid delays when multiple Salt clients start at once, add the start_event_grains configuration helper to Client configurations on Server.
:revdate: 2022-10-18
