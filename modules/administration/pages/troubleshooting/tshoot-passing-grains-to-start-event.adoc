...
:description: To avoid delays in registering clients, enable the start event grains feature on the Server to configure clients with the required settings.
:revdate: 2022-10-18
