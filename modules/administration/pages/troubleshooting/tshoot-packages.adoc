...
:description: Check package locks and exclude lists to determine if packages are locked or excluded, which may help resolve package inconsistencies on your client
:revdate: 2023-09-21
