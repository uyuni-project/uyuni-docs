...
:description: To resolve duplicate machine IDs in cloned Salt Clients, change the hostname, IP addresses, and machine ID to ensure MLM recognizes them as two different.
:revdate: 2025-04-24
