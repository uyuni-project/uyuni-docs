...
:description: Configure the SUSE Manager Web UI login timeout value by adjusting the time in seconds in /etc/rhn/rhn.conf and minutes in web.xml to prevent user logins
:revdate: 2022-11-07
