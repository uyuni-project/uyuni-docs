...
= Troubleshooting Inactive clients
:description: To identify inactive clients, check the System List > Inactive menu for clients that have not responded to Taskomatic checks in 24 hours or more.
:revdate: 2025-01-08
