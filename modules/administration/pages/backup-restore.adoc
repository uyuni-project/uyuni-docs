[[backup-restore]]
= Backup and Restore
:description: Understanding how to back up and restore MLM components ensures continuity in case of system failure or data loss due to hardware issues with the Server.
:revdate: 2025-06-23
