...
[IMPORTANT]
====
When you backup files and directories, the backup tools store the user and group names of the filenames.
The tools will automatically use the right IDs when you extract the files on the target system again.
