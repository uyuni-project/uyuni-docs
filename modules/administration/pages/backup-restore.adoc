...
[NOTE]
====
If you are only backing up and restoring the DB and excluding the copying of the above directories and files you will need to check the [literal]``report_db_password`` on the new server to ensure it is correct.
====
