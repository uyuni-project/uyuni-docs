...
:description: Learn how to configure single sign-on (SSO) between SUSE Manager and Keycloak 21.0.1 or later by installing the identity service provider, adding endpoints
:revdate: 2023-06-19
