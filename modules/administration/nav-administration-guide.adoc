...
// Troubleshooting - always keep as the last chapter
// THIS WILL BE USED TO TEST DOCS BUILDING, BUT WILL BE
// HIDDEN UNTIL READY TO BE COMPLETELY MERGED
//** xref:tshoot-intro-NEW.adoc[Troubleshooting MOVE IT]
...
//
// From Client Config Guide Tshooting
// started as single file
// needs to be reorganized to smaller ones, one topic per file
//*** xref:troubleshooting/tshoot-clients.adoc[Moving here Tshoot Clients before splitting it]
//
// From Install & Upgrade Guide Tshooting
// started as single file
// needs to be reorganized to smaller ones, one topic per file
//*** xref:troubleshooting/troubleshooting.adoc[Moving here Tshoot Install&Upgrade before splitting it]
// AFTER REORGANIZING
...
//*** xref:troubleshooting/tshoot-registeringtradassaltafterdeleting.adoc[Registering a traditional client as Salt minion after deleting it]
