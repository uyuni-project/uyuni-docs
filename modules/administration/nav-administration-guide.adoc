...
** xref:tshoot-intro.adoc[OLD Troubleshooting]
...
*** xref:tshoot-clients.adoc[ADDED TSHOOT CLIENTS]
*** xref:troubleshooting.adoc[ADDED TSHOOT INSTALL]
// Troubleshooting - always keep as the last chapter
** xref:troubleshooting/tshoot-intro.adoc[LEVEL DOWN Troubleshooting]
*** xref:troubleshooting/shoot-corruptrepo.adoc[Troubleshooting Corrupt Repositories]
*** xref:troubleshooting/tshoot-custom-channel.adoc[Troubleshooting Custom Channel]
...
*** xref:troubleshooting/tshoot-taskomatic.adoc[Troubleshooting Taskomatic]
*** xref:troubleshooting/tshoot-clients.adoc[ADDED TSHOOT CLIENTS]
*** xref:troubleshooting/troubleshooting.adoc[ADDED TSHOOT INSTALL]
>>>>>>> 64009c2b42e09ebb32ee9c2116cd0999eeda78dc
