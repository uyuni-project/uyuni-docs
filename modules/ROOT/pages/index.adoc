...
* For more information about other command prompt tools, see xref:reference:command-line-tools.adoc[].
...
* For the latest information about all command prompt tools, see the release notes available from https://www.suse.com/releasenotes/.
