...
| xref:quickstart:quickstart-overview.adoc[Quick Start]  | icon:file-pdf[link="../pdf/suse_manager_quickstart.pdf", window="_blank" role="green"]
...
| xref:common-workflows:common-workflows-overview.adoc[Common Workflows]  | icon:file-pdf[link="../pdf/suse_manager_common-workflows.pdf", window="_blank" role="green"]
...
| xref:specialised-guides:specialised-guides-overview.adoc[Specialised Guides]  | icon:file-pdf[link="../pdf/suse_manager_specialised-guides.pdf", window="_blank" role="green"]
...
|===
| View HTML | View PDF | View HTML | View PDF
| xref:quickstart:quickstart-overview.adoc[Quick Start]  | icon:file-pdf[link="../pdf/uyuni_quickstart.pdf", window="_blank" role="green"]
...
| xref:common-workflows:common-workflows-overview.adoc[Common Workflows]  | icon:file-pdf[link="../pdf/uyuni_common-workflows.pdf", window="_blank" role="green"]
...
| xref:specialised-guides:specialised-guides-overview.adoc[Specialised Guides]  | icon:file-pdf[link="../pdf/uyuni_specialised-guides.pdf", window="_blank" role="green"]
