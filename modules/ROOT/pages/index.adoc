...
| xref:quickstart-sap:qs-sap-overview.adoc[Quickstart: SAP] | icon:file-pdf[link="../pdf/suse_manager_quickstart-sap_guide.pdf", window="_blank" role="green"]
...
| xref:quickstart-sap:qs-sap-overview.adoc[Quickstart: SAP] | icon:file-pdf[link="../pdf/uyuni_quickstart-sap_guide.pdf", window="_blank" role="green"]
