...
Also, note that public cloud images usually do not allow SSH login with user and password but only SSH certificate login. If you want to use bootstrap from the {webui}, you will need to enable SSH login with user and password.
