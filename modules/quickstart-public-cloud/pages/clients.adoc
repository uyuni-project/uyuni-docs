...
* If you are attempting to register clients that are cloned from each other, you need to do some extra configuration to prevent them from over-writing each other.
