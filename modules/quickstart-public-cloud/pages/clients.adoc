...
You can use {productname} to manage either Salt or traditional clients.
Salt clients are able to take advantage of most new features and enhancements.
...
There are other options for registering clients in a public cloud installation.
For full details, see xref:client-configuration:registration-pubcloud.adoc[].
