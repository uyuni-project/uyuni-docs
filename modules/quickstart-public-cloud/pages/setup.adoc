...
We have tested using {productname} on Amazon EC2, Google Compute Engine, and Microsoft Azure, but they should work on other providers as well, with some variation.
...
Most public cloud providers make a BYOS image of {sles} available.
...
For more information about setting up, see xref:installation:pubcloud-setup.adoc[].
