...
= Common workflows
:description: Configure and manage your SUSE Manager clients using step-by-step instructions for common workflows to install, manage, and configure client systems
:revdate: 2025-03-27
