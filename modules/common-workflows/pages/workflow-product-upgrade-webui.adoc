...
:description: Upgrading a SLE Client to a newer product version using the Web UI enables administrators to easily update their systems with minimal disruption.
:revdate: 2025-02-06
