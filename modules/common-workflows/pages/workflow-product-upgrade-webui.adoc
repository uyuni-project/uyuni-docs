...
:description: Configure a product upgrade for registered SUSE Linux Enterprise clients in the Web UI by navigating through the Admin menu, selecting the desired channels
:revdate: 2024-03-07
