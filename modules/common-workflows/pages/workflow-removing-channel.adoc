...
= Removing channel
:description: Learn how to manually remove SUSE-provided channels from SUSE Manager through a multi-step process involving identifying channel labels in the Web UI or command
:revdate: 2025-05-12
