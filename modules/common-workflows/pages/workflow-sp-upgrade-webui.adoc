...
:description: Configure service pack upgrades for registered SUSE Linux Enterprise clients through a step-by-step process in the Web UI with accompanying examples
:revdate: 2023-04-20
...
. Log in to {productname} {webui} and navigate to menu:Admin[Products] and search for "SUSE Linux Enterprise Server 15 SP5 x86_64 (BETA)"
...
* For more information on dry run, see: https://documentation.suse.com/sles/15-SP4/html/SLES-all/cha-upgrade-online.html#sec-upgrade-online-zypper-plain
