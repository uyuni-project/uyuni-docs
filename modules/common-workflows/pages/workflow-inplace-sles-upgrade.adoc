...
:description: To automate an in-place upgrade of SLES with Server, follow these step-by-step preparation instructions to ensure a consistent and supportable outcome.
:revdate: 2024-11-28
