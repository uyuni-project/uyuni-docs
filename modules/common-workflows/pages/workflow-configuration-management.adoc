...
:description: Use the YaST tools and channels in the SUSE Manager Web UI to centrally manage configuration for your clients by creating a configuration file, assigning it
:revdate: 2024-03-07
