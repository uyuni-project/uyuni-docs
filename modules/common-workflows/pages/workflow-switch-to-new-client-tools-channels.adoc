...
Channels previously named `SUSE Manager Client Tools for XYZ` (with labels such as `manager-tools-*`), used in SUSE Manager 5.0, are no longer available from version 5.1.
...
Following the introduction of new client tools channels, CLM projects can also be updated and system channels subscriptions modified, via {webui}.
