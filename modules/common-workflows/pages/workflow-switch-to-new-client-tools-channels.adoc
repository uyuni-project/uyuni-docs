...
Following the introduction of new client tools channels, and existing clients being migrated to the new channel structure, CLM projects must also be updated and system channels subscriptions modified.
This can also be achieved via {webui}.


=== Migrating from old to new client tools
