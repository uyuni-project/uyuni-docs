...
= Client onboarding
:description: Configure a SUSE Manager Server to manage new clients by setting up software channels, creating an activation key, and bootstrapping the client via SSH
:revdate: 2023-07-24
