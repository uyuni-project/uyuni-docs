...
= Client Onboarding
:description: Configure your SUSE Manager Server to onboard a new client by setting up software channels, creating an activation key, and bootstrapping the client via SSH
:revdate: 2024-11-29
