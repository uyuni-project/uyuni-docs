...
= Client Onboarding
:description: This workflow guides you through setting up your Server to onboard a Client with a supported Linux operating system, enabling management through the MLM Web UI.
:revdate: 2025-02-06
