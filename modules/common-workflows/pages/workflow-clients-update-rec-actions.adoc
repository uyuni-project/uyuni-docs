...
:description: Learn how to automate updates of Salt clients in SUSE Manager with recurring actions for efficient maintenance
:revdate: 2025-05-14
...
.Procedure: Configuring Systems to Not Reboot After the [literal]``uptodate`` State is Applied
[role=procedure]
