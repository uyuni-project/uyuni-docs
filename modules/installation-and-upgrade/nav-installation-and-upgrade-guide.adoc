...
**** Deploy Uyuni as a Container
***** xref:container-deployment/deploy-as-a-container.adoc[Deploy as a container]
***** xref:container-deployment/migrate-to-a-container.adoc[Migrate to a container]
***** xref:container-deployment/persistent-container-volumes.adoc[Persistent container volumes]
***** xref:container-deployment/mgradm-yaml-custom-configuration.adoc[Custom YAML configuratino with mgradm]
endif::[]
