4// NO COMMENTS ALLOWED IN NAV LIST FILES EXCEPT THIS ONE!
ifdef::backend-pdf[]
...
** Server
*** Deploy
**** xref:container-deployment/suma/server-vm-deployment-suma.adoc[Virtual Machine Deployment]
**** xref:container-deployment/suma/server-deployment-suma.adoc[Deploy on {sl-micro}]
...
*** Server
**** xref:container-deployment/suma/server-migration-uyuni.adoc[Server Migration]
*** Proxy
**** xref:container-deployment/suma/proxy-migration-uyuni.adoc[Proxy Migration]
*** Clients
