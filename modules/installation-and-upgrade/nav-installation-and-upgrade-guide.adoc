...
ifeval::[{suma-content} == true]
**** xref:install-vm.adoc[Install Server Using Virtual Machine Image]
endif::[]
...
**** xref:install-ignition.adoc[Boot Image Configuration]
*** {productname} Proxy
...
**** xref:install-proxy-vm.adoc[Install Proxy Using Virtual Machine Image - KVM]
**** xref:install-proxy-vmdk.adoc[Install Proxy Using Virtual Machine Image - VMware]
endif::[]
