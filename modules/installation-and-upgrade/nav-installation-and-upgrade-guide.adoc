...
*** xref:postgresql-requirements.adoc[Database]
...
*** Proxy
**** Deploy
***** xref:proxy-container-installation.adoc[Proxy Deployment]
***** xref:proxy-container-setup.adoc[Proxy Setup]
***** xref:containerized-proxy-deployment.adoc[Deployment from an Internal Registry]
...
** xref:upgrade-intro.adoc[Upgrade and Migrate]

ifeval::[{suma-content} == true]
*** xref:server-intro.adoc[Migrate Server]
**** xref:container-deployment/suma/migrate-suma-to-a-container.adoc[Migrate from 4.3 -> 5.0]
endif::[]

ifeval::[{uyuni-content} == true]
*** xref:server-intro-uyuni.adoc[Upgrade Server]
...
*** xref:proxy-intro.adoc[Upgrade Proxy]
