...
**** xref:container-deployment/suma/server-deployment-vm-suma.adoc[Deployment as Virtual Machine - KVM]
**** xref:container-deployment/suma/server-deployment-vmdk-suma.adoc[Deployment as Virtual Machine - VMware]
