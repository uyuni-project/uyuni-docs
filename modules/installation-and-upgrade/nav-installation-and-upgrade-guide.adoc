...
*** Server
**** xref:container-deployment/uyuni/migrate-uyuni-server-from-micro55-tumbleweed.adoc[Migrate from openSUSE Leap Micro 5.5 to Tumbleweed]
...
*** Proxy
**** xref:container-deployment/uyuni/migrate-uyuni-proxy-from-micro55-tumbleweed.adoc[Migrate Proxy from openSUSE Leap Micro 5.5 to Tumbleweed]
