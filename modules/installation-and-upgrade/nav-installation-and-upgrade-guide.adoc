...
* xref:installation-and-upgrade-overview.adoc[Installation, Deployment and Upgrade]
endif::[]

ifeval::[{uyuni-content} == true]
* xref:uyuni-installation-and-upgrade-overview.adoc[Installation, Deployment and Upgrade]
endif::[]
** Requirements
