...
ifeval::[{uyuni-content} == true]
***** xref:container-deployment/uyuni/deploy-leap-micro-on-kvm.adoc[Setup, Install, and deploy on KVM]
***** xref:container-deployment/uyuni/opensuse-leap-micro-deployment.adoc[{leapmicro} {microversion}]
***** xref:container-deployment/uyuni/migrate-uyuni-to-a-container.adoc[Migrate {productname} to a container]
endif::[]

ifeval::[{suma-content} == true]
***** xref:container-deployment/uyuni/deploy-sle-micro-on-kvm.adoc[Setup, Install, and deploy on KVM]
***** xref:container-deployment/suma/deploy-from-sle-micro.adoc[Deploy from {micro} {microversion}]
...
***** xref:container-management/update-container-images.adoc[Update the container image]
...
//TODO - scope ***** xref:container-management/container-security.adoc[Container security]
