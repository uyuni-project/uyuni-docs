...
*** Proxy
**** Deploy
***** xref:container-deployment/uyuni/proxy-container-setup.adoc[Proxy Setup]
***** xref:container-deployment/uyuni/proxy-container-installation.adoc[Proxy Deployment]
***** xref:container-deployment/uyuni/containerized-proxy-deployment.adoc[Deployment from an Internal Registry]
***** xref:container-deployment/uyuni/proxy-container-k3s-installation.adoc[Deploy on K3s]
**** Install the Proxy
