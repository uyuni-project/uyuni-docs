...
**** Uyuni container deployment
***** xref:container-deployment/uyuni/deploy-as-a-container.adoc[Deploy a container from {opensuse} {opensuse-version}]
***** xref:container-deployment/uyuni/migrate-uyuni-to-a-container.adoc[Migrate productname to a container]
endif::[]

ifeval::[suma-content} == true]
**** SUSE Manager container deployment
