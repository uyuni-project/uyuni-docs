...
**** xref:container-deployment/deployment-as-a-container.adoc[Deploy as a container]

ifeval::[{uyuni-content} == true]
***** xref:container-deployment/uyuni/deploy-from-opensuse.adoc[Deploy a container from {opensuse} {opensuse-version}]
***** xref:container-deployment/uyuni/migrate-uyuni-to-a-container.adoc[Migrate {productname} to a container]
endif::[]

ifeval::[{suma-content} == true]
***** xref:container-deployment/suma/deploy-from-sle-micro.adoc[Deploy from {micro}]
***** xref:container-deployment/suma/deploy-from-sles.adoc[Deploy from {sles}]
***** xref:container-deployment/suma/migrate-suma-to-a-container.adoc[Migrate {productname} to a container]
endif::[]

**** xref:container-management/container-management.adoc[Container management]
***** xref:container-management/start-and-stop-containers.adoc[Start and stop containers]
***** xref:container-management/update-container-images.adoc[Update container images]
***** xref:container-management/monitoring-container-storage-space.adoc[Montior container storage space]
...
//***** xref:container-management/container-security.adoc[Container security]
***** xref:container-management/custom-policy.adoc[Custom policies]
