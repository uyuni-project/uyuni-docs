...
= Server - Major Upgrade
:description: Learn how to successfully perform a major upgrade on SUSE Manager Server using the procedure for upgrading core components like PostgreSQL, Salt, and openSUSE
:revdate: 2024-08-02
