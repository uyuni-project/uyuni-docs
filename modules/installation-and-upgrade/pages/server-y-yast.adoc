...
:description: To perform a minor version upgrade, use YaSTs Online Migration tool to migrate the PostgreSQL database, install necessary updates, and configure Spacewalk
:revdate: 2022-01-17
