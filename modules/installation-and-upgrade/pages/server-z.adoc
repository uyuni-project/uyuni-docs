...
:description: The sentence must be a single, complete thought that is grammatically correct and easy to read. - Do NOT change the original meaning or key technical terms
:revdate: 2022-03-10
