[[pubcloud-setup]]
= Public Cloud Setup
:description: Learn how to set up and manage your SUSE Manager Server on a public cloud instance with step-by-step instructions
:revdate: 2025-07-08
...
{productname} Server needs to be registered with [command]``registercloudguest`` for in the cloud operation or [command]``SUSEConnect`` for {scc} provided entitlements to receive updates before you can sign in.
For more information, see xref:specialized-guides:public-cloud-guide/byos/byos-overview.adoc[].
