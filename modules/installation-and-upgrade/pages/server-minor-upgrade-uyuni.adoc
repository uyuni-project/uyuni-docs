...
= Server - Minor Upgrade
:description: Learn about performing a minor upgrade of your SUSE Manager Server through a step-by-step procedure that includes package updates, repository refreshes,
:revdate: 2022-02-02
