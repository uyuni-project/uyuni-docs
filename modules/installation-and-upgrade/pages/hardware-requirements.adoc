...
By default the {productname} Server container stores packages in the [path]``/var/spacewalk/`` directory.
...
By default the {productname} Proxy container caches packages in the [path]``/var/cache/`` directory.
