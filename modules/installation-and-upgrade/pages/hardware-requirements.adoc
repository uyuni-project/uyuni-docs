...
* per {suse} product and Package Hub 50{nbsp}GB required
* per Red Hat product 360{nbsp}GB required
...
|
| [path]``/var/spacewalk``
| Minimum 100{nbsp}GB per SUSE product and 360{nbsp}GB per Red Hat product


|
|
| Additional 50{nbsp}GB when using Package Hub repositories (optional)
