...
It is highly recommended to move to the Hub setup and involve consultancy once you have more than 10 000 clients, as this can lead to performance issues.
