...
[IMPORTANT]
====
{productname} performance depends on a number of underlying resources, for example network bandwidth and latency between clients and servers.
...
It is strongly recommended to move to Hub setup and involve consultancy once you have more than 10 000 clients, as this can lead to performance issues.
