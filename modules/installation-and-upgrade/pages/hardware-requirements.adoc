...
:description: Learn about hardware and software requirements for SUSE Manager Server and Proxy on various architectures such as x86-64, ARM, ppc64le, and s390x,
:revdate: 2025-06-26
...
One of {sle-micro} {microversion} or {sles} {bci-suma} is the operating system of the container host.
