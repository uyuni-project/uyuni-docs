...
{sl-micro} {microversion} is the operating system of the container host and requires as free disk space:
...
The cloud image of {sl-micro} {microversion} has just a 5 GB [literal]``/`` partition. Both work flawlessly with {productname}.
...
|===
//        ^^^
// CHECK  ^^^ or shall we change this back to 100 GB?
// //////////////////////////////////////////////////
...
You cannot set option directly in [path]``squid.conf``.
