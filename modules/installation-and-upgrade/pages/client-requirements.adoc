...
:description: Determine which supported operating systems and architectures can be used for both traditional and Salt clients by examining this comprehensive table outlining
:revdate: 2025-02-28
...
Older minor releases might still work, but will only be supported on a limited and reasonable-effort basis. 
If issues arise on an outdated minor release, users will be asked to upgrade to the latest available minor version before further support is provided.
====
...
ifdef::backend-pdf[]
include::../../client-configuration/partials/eol-clients.adoc[]
endif::[]
