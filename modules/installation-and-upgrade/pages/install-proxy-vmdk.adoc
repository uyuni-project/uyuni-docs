...
. For registering {productname} Proxy with SCC, preparing  {productname} Proxy storage, and further steps, proceed with xref:installation-and-upgrade:install-vm.adoc#minimal.susemgrproxy.prep[].
