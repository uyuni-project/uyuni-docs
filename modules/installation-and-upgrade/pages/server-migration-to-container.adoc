= Migrating  the {proudctname} server to a containerized environment
...
See: xref:installation-and-upgrade:containerzied-server-deployment.adoc[Persistent volume list]
