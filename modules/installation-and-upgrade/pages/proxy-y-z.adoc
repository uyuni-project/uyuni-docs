...
:description: Learn how to upgrade a SUSE Manager Proxy to the latest version using step-by-step instructions for scheduling and performing minor version or patch-level
:revdate: 2022-05-23
