...
To update a proxy, go to the system details.
Click menu:Software[Product Migration] and from the list [label]``Target Products`` select the version of the product you want to migrate current proxy to.

[guimenu]``Product Migration``:
