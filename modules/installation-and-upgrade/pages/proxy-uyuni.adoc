[[proxy-uyuni-upgrade]]
= Proxy - Major Upgrade
:description: Upgrade your SUSE Manager Proxy with a major update by stopping the service, replacing software repositories, updating the software, and restarting it, all
:revdate: 2024-08-02
...
+
////
At least not for the migration from 15.2 to 15.3.
