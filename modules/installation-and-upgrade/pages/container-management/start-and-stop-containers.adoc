...
:description: Learn how to manage and control the SUSE Manager 5.0 Server lifecycle using the mgradm tool to execute restart, start, and stop commands in a Linux environment
:revdate: 2024-02-13
