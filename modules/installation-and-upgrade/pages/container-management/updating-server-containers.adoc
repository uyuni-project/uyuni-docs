...
Before running the upgrade command, it is recommended to update the host operating system.
The [literal]``mgradm`` tool, included in the {productname} tooling, must be upgraded as a prerequisite for the Server upgrade process.
