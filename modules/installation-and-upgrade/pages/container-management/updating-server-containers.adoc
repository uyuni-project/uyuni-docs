...
:description: Upgrade your Server to the latest version by following the outlined procedure and commands, ensuring a secure and updated systems.
:revdate: 2025-07-29
...
include::../container-deployment/snippet-database-backup-volume.adoc[leveloffset=+1]