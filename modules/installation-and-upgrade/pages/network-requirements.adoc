...
== Deployment behind http/https OSI level 7 proxy
Some environment enforce internet access through a http/https proxy.
This could be a squid server or similar.
To allow the {productname} server internet access in such configuration, you need to configure:
