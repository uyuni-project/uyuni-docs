...
It is recommend to take measures for network isolation of the {productname} environment according to your policies.
...
You can find additional details on whitelisting the specified URLs and their associated IP addresses in this article: https://www.suse.com/support/kb/doc/?id=000021034[Accessing SUSE Customer Center and SUSE registry behind a firewall and/or through a proxy].
