[[setup-wizard]]
= Setup Wizard
:description: Configure and complete the setup process for SUSE Manager by navigating through the Setup Wizards steps, configuring an HTTP proxy, providing organization
:revdate: 2022-11-07
