...
This chapter provides procedures how you can deploy a Kernel Virtual Machine (KVM) or VMware image.
...
// FIXME: add note here: now firstboot
//                       ignition is optional now
...
// FIXME: replace the following with firstboot (see 5.0 docs)
