...
{productname} Proxy systems are Salt or traditional clients that are installed with the Unified Installer and registered to {productname} using bootstrap script or {webui}.
