...
:description: Configure a SUSE Manager Proxy by registering it as a client with an activation key, then set up software channels in the SUSE Manager Web UI
:revdate: 2024-11-29
