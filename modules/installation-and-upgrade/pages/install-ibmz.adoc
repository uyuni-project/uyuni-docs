...
= Installing on {ibmz}
:description: Learn how to install SUSE Manager Server on IBM Z systems, including key procedures and requirements
:revdate: 2023-12-19
...
For general information about deploying a product on {ibmz} hardware, see https://documentation.suse.com/sles/15-SP4/html/SLES-all/cha-zseries.html.
