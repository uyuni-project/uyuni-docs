...
:description: Here is the corrected sentence Learn how to configure a containerized SUSE Manager Proxy installation with system requirements and step-by-step setup
:revdate: 2024-07-18
