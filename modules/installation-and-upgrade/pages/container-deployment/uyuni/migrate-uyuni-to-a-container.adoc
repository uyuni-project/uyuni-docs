...
The command can fail if there already is an XFS filesystem, for example.
====
...
[IMPORTANT]
====
If something goes wrong with the migration it is possible to restart the source system.
