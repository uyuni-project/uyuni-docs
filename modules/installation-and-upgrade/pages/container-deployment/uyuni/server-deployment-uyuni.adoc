= {productname} Server Deployment on {leapmicro} {microversionforuyuni}
:revdate: 2025-07-09
...
[NOTE]
====
This section assumes you have already configured an {leapmicro} {microversionforuyuni} host server, whether it is running on a physical machine or within a virtual environment.
...
An {leapmicro} {microversionforuyuni} server should be installed from installation media. 
...
.Procedure: Installing Uyuni Tools on {leapmicro} {microversionforuyuni}
. On your local host open a terminal window or start up a virtual machine running {leapmicro} {microversionforuyuni}
. Log in.
...
----
+
. Add the following repository to your {leapmicro} {microversionforuyuni} server:
+
----
