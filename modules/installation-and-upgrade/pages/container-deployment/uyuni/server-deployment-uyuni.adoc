= {productname} Server Deployment on {leapmicro} 5.5
:revdate: 2025-07-09
...
[NOTE]
====
This section assumes you have already configured an {leapmicro} 5.5 host server, whether it is running on a physical machine or within a virtual environment.
