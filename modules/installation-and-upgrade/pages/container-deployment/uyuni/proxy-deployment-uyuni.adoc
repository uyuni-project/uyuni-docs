...
= {productname} Proxy Deployment on {leapmicro} {microversionforuyuni}
:revdate: 2025-02-06
...
. Install {leapmicro} {microversionforuyuni} on a bare-metal machine.
+
...
[NOTE]
====
The supported operating system for the container host is {leapmicro} {microversionforuyuni}.
