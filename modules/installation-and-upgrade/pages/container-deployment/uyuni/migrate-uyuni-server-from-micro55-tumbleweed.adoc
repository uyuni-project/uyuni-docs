= Migrate {productname} Server from SUSE Micro 5.5 to Tumbleweed
:revdate: 2025-10-27
...
.Procedure: Install Tools and Prerequisites
[role="procedure"]
____
...
.Procedure: Prepare Persistent Storage
[role="procedure"]
____
