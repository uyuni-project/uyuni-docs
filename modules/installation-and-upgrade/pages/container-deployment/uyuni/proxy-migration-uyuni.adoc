= Proxy Migration
:description: Learn how to migrate and configure a SUSE Manager containerized proxy in SUSE Manager 5.0 for simplified management, allowing for streamlined infrastructure
:revdate: 2024-10-17
