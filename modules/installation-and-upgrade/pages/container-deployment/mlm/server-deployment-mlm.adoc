...
This guide shows you how to install and configure a {productname} {productnumber} container on {sle-micro} {microversion} or {sles} {bci-mlm}.
...
[NOTE]
====
The supported operating system for the container host is {sle-micro} {microversion} or {sles} {bci-mlm}.
...
.Procedure: {sl-micro} {microversion} Installation
...
== Install {productname} on {sles} {bci-mlm}

Alternatively, you can install {productname} on {sles} {bci-mlm}.
...
----
. Finish the {productname} installation on {sles} {bci-mlm} by running command:
