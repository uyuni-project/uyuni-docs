...
[IMPORTANT]
====
An in-place migration from {productname} 4.3 to {productnumber} is unsupported because the host operating system has changed from {sles} 15 SP4 to {sl-micro} {microversion}.
