= Proxy Migration
:description: This document guides you through the process of upgrading a SLE Micro 5.5 host running MLM 5.0 Proxy to an SL Micro 6.1 environment with MLM 5.1 Proxy.
:revdate: 2025-06-17
