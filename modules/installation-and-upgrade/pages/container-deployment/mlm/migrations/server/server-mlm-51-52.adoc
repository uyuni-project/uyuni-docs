...
== {sle-micro} 6.1 to {sl-micro} 6.1



This document provides the tested procedure to upgrade a {sl-micro} 6.1 host deployed with {productname} 5.1 Server to {sl-micro} 6.1 with {productname} {productnumber}.


=== Prerequisites

* {productname} 5.1 is installed and running on {sle-micro} 6.1.
...
* Base OS: `SUSE Linux Enterprise Micro 6.1`
...
The system is now running {productname} 5.2 on SL Micro 6.1.
