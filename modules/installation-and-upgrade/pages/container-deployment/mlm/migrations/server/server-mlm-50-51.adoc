...
[IMPORTANT]
====
{sl-micro} 6.1 uses NetworkManager as the network managing service. If your server is using wicked as the network manager it **must** be migrated to NetworkManager before upgrading the Operating System.
On how to migrate to NetworkManager see: https://documentation.suse.com/sle-micro/5.5/html/SLE-Micro-all/cha-nm-vs-wicked.html#sec-switching-wicked
====
