...
ifeval::[{uyuni-content} == true]
The following table displays distributions that can be used as container hosts for {productname} Proxy containers.

.Supported container host OS
[cols="1,1"]
|===
|{opensuse} Leap |Versions

| Supported | 15.3, 15.4, 15.5, 15.6
|===
endif::[]
