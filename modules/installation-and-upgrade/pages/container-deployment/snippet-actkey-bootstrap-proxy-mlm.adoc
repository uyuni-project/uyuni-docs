:description: Bootstrap your Proxy host as a Client by selecting the activation key created previously and waiting for the process to complete successfully.
