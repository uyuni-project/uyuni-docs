:description: Use the `transactional-update` command to register and update your SL Micro and MLM 5.1 Proxy, then reboot as needed for changes to take effect.
