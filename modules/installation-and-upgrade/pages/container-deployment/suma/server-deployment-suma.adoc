...
The following procedure describe the main steps of the installation process.

.Procedure: Installing {productname} on {sles} {bci-suma}
. Locate and downlaod {sles} {bci-suma} [literal]``.iso`` at https://www.suse.com/download/sles/.
