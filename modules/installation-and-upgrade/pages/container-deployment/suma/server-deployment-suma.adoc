...
== [DRAFT] Install SLES 15 SP6

.Procedure
. Download ISO
. install sles15sp6
. the SCC code must have Extensions enabled 
. at the Extensions screen select the MLM extension
. don't forget to add Containers Module too
. complete the installation
. log in to the server
. zypper install podman
. followed by manually installing mgr... install podman
