[[deploy-suma-server]]
= {productname} {productnumber} Server Deployment on {sle-micro} or {sles}
ifeval::[{uyuni-content} == true]
:noindex:
endif::[]

This guide shows you how to install and configure a {productname} {productnumber} container on {sle-micro} {microversion} or {sles} {sles-version} {sp-version}.
...
// 2025-02-20, ke: For HTML output, keep white-space (empty line with spaces
//                 and indentation, 2x) in this table!
...
[NOTE]
====
The supported operating system for the container host is {sle-micro} {microversion} or {sles} {sles-version} {sp-version}.
