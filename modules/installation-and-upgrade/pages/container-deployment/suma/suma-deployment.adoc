...
If you added {productname} {productnumber} as an extension during {micro} {microversion} installation then you can skip this step. However, you can also optionally skip registration during {micro} {microversion} installation by selecting the btn:[Skip Registration].
