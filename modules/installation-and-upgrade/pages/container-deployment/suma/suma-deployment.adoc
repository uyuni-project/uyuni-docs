...
[IMPORTANT]
====
Before proceeding, ensure that you have registered {productname} {productnumber}. If you initially skipped registration and now need to register from the command line, follow the steps below to login to the registry:
