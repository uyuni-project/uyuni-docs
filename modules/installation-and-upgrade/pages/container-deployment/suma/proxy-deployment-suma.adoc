...
. During the installation, register {sle-micro} or {sles} along with the {productname} Proxy extension.
...
ifndef::backend-pdf[]
include::installation-and-upgrade:partial$prepare-micro-host.adoc[leveloffset=+1]
endif::[]

ifdef::backend-pdf[]
include::../../../partials/prepare-micro-host.adoc[leveloffset=+1]
endif::[]
...
ifndef::backend-pdf[]
include::installation-and-upgrade:partial$prepare-sles-host.adoc[leveloffset=+1]
endif::[]

ifdef::backend-pdf[]
include::../../../partials/prepare-sles-host.adoc[leveloffset=+1]
endif::[]
...
ifndef::backend-pdf[]
include::installation-and-upgrade:partial$actkey-bootstrap-proxy-suma.adoc[]
endif::[]

ifdef::backend-pdf[]
include::../../../partials/actkey-bootstrap-proxy-suma.adoc[]
endif::[]

// (New) Snippet for bootsrapping the proxy

ifndef::backend-pdf[]
include::installation-and-upgrade:partial$bootstrap-proxy-client.adoc[]
endif::[]

ifdef::backend-pdf[]
include::../../../partials/bootstrap-proxy-client.adoc[]
endif::[]

ifndef::backend-pdf[]
include::installation-and-upgrade:partial$generate_proxy_config.adoc[]
endif::[]

ifdef::backend-pdf[]
include::../../../partials/generate_proxy_config.adoc[]
endif::[]

ifndef::backend-pdf[]
include::installation-and-upgrade:partial$transfer_proxy_config.adoc[]
endif::[]

ifdef::backend-pdf[]
include::../../../partials/transfer_proxy_config.adoc[]
endif::[]
