...
= Deploy a {productname} {productnumber} Proxy on {sle-micro}
...
.Procedure: Sync the Proxy Parent Channel and Proxy Extension
...
.Procedure: Copy the Proxy Configuration
