...
include::../prepare-micro-host.adoc[leveloffset=+1]
...
include::../prepare-sles-host.adoc[leveloffset=+1]
...
It adjusts the configuration file for the httpd service, where **+registry.opensuse.org/uyuni/proxy-httpds+** is the image to use and [literal]``0.1.0`` is the version tag, before restarting it.
