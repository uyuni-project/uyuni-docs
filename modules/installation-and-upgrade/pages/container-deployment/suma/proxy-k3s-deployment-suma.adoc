...
:description: Deploy a SUSE Manager 5.0 Proxy on K3s, including installation and configuration of necessary packages and persistent volumes to facilitate a seamless
:revdate: 2024-12-17
...
ifndef::backend-pdf[]
include::installation-and-upgrade:partial$generate_proxy_config.adoc[tags=generate-proxy-config-section]
endif::[]

ifdef::backend-pdf[]
include::../../../partials/generate_proxy_config.adoc[tags=generate-proxy-config-section]
endif::[]
