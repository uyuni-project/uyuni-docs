...
<<<<<<< HEAD:modules/installation-and-upgrade/pages/container-deployment/suma/proxy-k3s-deployment-suma.adoc
Generate the configuration for the {productname} Proxy as documented in xref:installation-and-upgrade:container-deployment/suma/proxy-deployment-suma.adoc[].
=======
...
>>>>>>> master:modules/installation-and-upgrade/pages/container-deployment/suma/proxy-container-k3s-installation.adoc
