= Deploy {productname} as a container using {micro}

== Deployment preparations

In this section, you will gain expertise in setting up and deploying a {productname} {productnumber} Server.
...
== Requirements
// Add requirements here or insert snippet
