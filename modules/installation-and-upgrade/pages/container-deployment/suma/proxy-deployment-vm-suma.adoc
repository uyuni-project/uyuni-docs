...
:description: Configure SUSE Manager Proxy as a virtual machine using KVM settings and deployment images for both testing and production environments
:revdate: 2025-05-28
...
| OS:                 | Linux
| Version:            | {productname}-Proxy.x86_64-5.0.0-*.qcow2
| Memory:             | Minimum *)
| CPU's:              | Minimum *)
...
For settings, see xref:installation-and-upgrade:container-deployment/suma/proxy-deployment-vm-suma.adoc#proxy-quickstart.sect.kvm.settings[].
...
ifndef::backend-pdf[]
include::installation-and-upgrade:partial$register-proxy-suma.adoc[]
endif::[]

ifdef::backend-pdf[]
include::../../../partials/register-proxy-suma.adoc[]
endif::[]
...
ifndef::backend-pdf[]
include::installation-and-upgrade:partial$start_proxy.adoc[]
endif::[]

ifdef::backend-pdf[]
include::../../../partials/start_proxy.adoc[]
endif::[]
