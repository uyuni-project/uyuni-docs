...
ifndef::backend-pdf[]
include::installation-and-upgrade:partial$container-deployment/register-proxy-suma.adoc[]
endif::[]
...
ifndef::backend-pdf[]
include::installation-and-upgrade:partial$container-deployment/start_proxy.adoc[]
endif::[]
