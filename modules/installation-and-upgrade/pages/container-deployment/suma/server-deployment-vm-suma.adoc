...
. During image installation you will be prompted to enter a root password. In the next message box click btn:[Confirm root Password].
...
.Procedure: Preparing {minimalsles} for {productname} Deployment
