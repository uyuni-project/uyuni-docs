...
To migrate a {productname} 4.3 Server to a container, you require a new machine with {sle-micro} 5.5 and [litaral]``mgradm`` installed. 
...
[IMPORTANT]
====
You need to have {sle-micro} 5.5 with [litaral]``mgradm`` installed. 
