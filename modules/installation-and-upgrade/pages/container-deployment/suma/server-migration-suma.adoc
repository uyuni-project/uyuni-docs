...
[[prepare-micro-host]]
ifndef::backend-pdf[]
include::installation-and-upgrade:partial$container-deployment/prepare-micro-host.adoc[leveloffset=+2]
endif::[]
...
[[deploy-sles-host]]
ifndef::backend-pdf[]
include::installation-and-upgrade:partial$container-deployment/prepare-sles-host.adoc[leveloffset=+2]
endif::[]
