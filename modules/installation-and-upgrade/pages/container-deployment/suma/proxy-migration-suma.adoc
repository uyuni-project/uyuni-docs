= Proxy Migration
:description: Migrate your SUSE Manager proxy to a new version with ease using one of three deployment methods RPM-based, containerized with Podman or K3s
:revdate: 2025-07-03
