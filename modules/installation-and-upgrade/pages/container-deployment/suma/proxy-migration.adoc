...
.Task: Migrating a {productname} 4.3 Proxy to {productname} {productnumber} Containerized Proxy
...
== Generate a Proxy Configuration using spacecmd and the Self Signed Certificate

You can also generate a Proxy configuration using spacecmd.
...
== Generate a Proxy Configuration using spacecmd and a Custom Certificate
