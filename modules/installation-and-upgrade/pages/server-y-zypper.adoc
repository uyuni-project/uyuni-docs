...
:description: Configure your server for a minor version upgrade with zypper, using the Zypper migration tool to select the target and follow prompts through database
:revdate: 2023-10-09
