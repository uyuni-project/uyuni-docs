...
While there were not many big files, the high number of smaller files resulted in high number of established connections as new TCP connection is created for every single transferred file.
