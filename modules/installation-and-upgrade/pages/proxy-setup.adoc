...
:description: Configure your SUSE Manager Proxy according to detailed step-by-step instructions for a successful deployment
:revdate: 2025-07-03
...
. Install a new {productname} Proxy.
  For installation instructions, see xref:installation-and-upgrade:install-proxy-unified.adoc[Proxy Installation].
