...
* provides customized {payg} product images (eg. SLES, SLES for SAP...)
...
* valid {scc} credentials iare entered in [guimenu]``Admin > Setup Wizard > Organization Credentials``, even they provide only limited access to products
