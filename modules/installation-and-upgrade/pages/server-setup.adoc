...
. First describe your certificate information and a password. The information are the same than <<proc-quickstart-certificate-information-yast>>.
+
----
CERT_O="SUSE"
CERT_OU="SUSE"
...
[WARNING]
====
Don't create RDS with the same user than `MANAGER_USER`
====
