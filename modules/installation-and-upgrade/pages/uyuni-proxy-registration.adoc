...
:description: Configure SUSE Manager Proxy registration by creating software channels on the server, generating a bootstrap script for the proxy, and activating it with an
:revdate: 2024-08-02
