...
[IMPORTANT]
====
Ensure the container proxy has a unique FQDN. This should NOT be the same as the FQDN of the container host host, and should be resolvable for any assigned clients of the proxy.
====
