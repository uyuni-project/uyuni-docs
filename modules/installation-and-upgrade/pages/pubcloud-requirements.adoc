...
[WARNING]
====
When you run {productname} on public clouds, you should apply security measures to limit access to the instance.
A world-accessible {productname} instance is highly discouraged by {suse}.
====
