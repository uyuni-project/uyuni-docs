...
Ensure you have saved the installation software in the same file path on each client.
...
On the {productname} Server, open the ``/etc/salt/minion`` configuration file and add or amend this line:
