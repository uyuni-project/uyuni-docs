...
*** xref:autoinst-pxeboot.adoc[Installation via PXE Boot]
*** xref:autoinst-cdrom.adoc[Installation via a CD-ROM]
*** xref:autoinst-distributions.adoc[Autoinstallation Distributions]
