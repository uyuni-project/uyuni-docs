...
| rhel9-pool-x86_64
| -
| res9-suse-manager-tools-x86_64
...
| {redhat} 9 | RHEL 9 Base           | rhel9-pool-x86_64
|===
...
//For more information, see ``Registering Older Clients`` at xref:administration:troubleshooting/tshoot-intro.adoc[Troubleshooting].
//====
