...
<<<<<<< HEAD
For more information, see xref:administration:troubleshooting/tshoot-clients-registeringolderclients.adoc[].
=======
For more information, see ``Registering Older Clients`` at xref:administration:troubleshooting/tshoot-clients.adoc[].
>>>>>>> 64009c2b42e09ebb32ee9c2116cd0999eeda78dc
====
