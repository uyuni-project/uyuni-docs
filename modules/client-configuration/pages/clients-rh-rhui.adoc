...
:description: Learn to connect Red Hat Enterprise Linux clients to RHUI with SUSE Manager Server, managing their subscriptions in the process
:revdate: 2024-08-05
...
We automated this task now by using the same mechanism as for SUSE {payg} instances. See also xref:installation-and-upgrade:connect-payg.adoc[].
