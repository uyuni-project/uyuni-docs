...
[IMPORTANT]
====
The PAYG connection regularly checks with the client to get the latest authentication data.
It is important that the client stays running and is regularly updated.
