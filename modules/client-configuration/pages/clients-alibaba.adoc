...
:description: Register Alibaba Cloud Linux clients with SUSE Manager Server by adding software channels and synchronizing them afterwards
:revdate: 2023-08-17
...
[IMPORTANT]
====
* {alibabaclo} repository URLs are available from {scc}
