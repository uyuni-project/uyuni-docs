...
| {es} 8
| RHEL or SLES ES and SUSE Linux Enterprise Server with Expanded Support 8 x86_64
|===
...
| {es} 8     | RHEL or SLES ES | RES8-Manager-Tools-Pool for x86_64 and RES8-Manager-Tools-Updates for x86_64
