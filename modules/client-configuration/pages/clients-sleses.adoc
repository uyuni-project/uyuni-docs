...
:description: Learn how to register and configure SUSE Liberty Linux clients with Salt or using traditional methods
:revdate: 2025-03-10
...
Initial packages must be obtained directly from Red Hat or CentOS before applying updates from {sll}. 
