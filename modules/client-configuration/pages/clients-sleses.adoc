...
Traditional clients are not available on {es}{nbsp}8 or {es}{nbsp}9.
{es}{nbsp}8 or {es}{nbsp}9 clients are only supported as Salt clients.
...
| {es} 9
| RHEL or SLES ES 9 Base and SUSE Linux Enterprise Server with Expanded Support 9 x86_64
|===
...
| {es} 9     | RHEL or SLES ES 9 Base | RES9-Manager-Tools-Pool for x86_64 and RES9-Manager-Tools-Updates for x86_64
