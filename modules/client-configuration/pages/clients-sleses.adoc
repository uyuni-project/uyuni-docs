...
| {es} 9
| RHEL or SLES ES and SUSE Linux Enterprise Server with Expanded Support 9 x86_64
...
| {es} 9     | RHEL or SLES ES                  | RES9-Manager-Tools-Pool for x86_64 and RES9-Manager-Tools-Updates for x86_64
...
//{es} 6 is now at end-of-life, and the ISO images provided in the repository are out of date.
//Bootstrapping new {es} 6 clients using these packages will fail.
//If you need to bootstrap new {es} 6 clients, follow the troubleshooting procedure in xref:administration:troubleshooting/tshoot-intro.adoc[Troubleshooting].
//====
...
| rhel8-pool-x86_64
| -
| res9-manager-tools-pool-x86_64
