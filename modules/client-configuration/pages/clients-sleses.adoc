...
Traditional clients are not available on {es}{nbsp}8 or 9.
{es}{nbsp}8 and 9 clients are only supported as Salt clients.
...
//[NOTE]
//====
//{sll} 6 is now at end-of-life, and the ISO images provided in the repository are out of date.
//Bootstrapping new {sll} 6 clients using these packages will fail.
//If you need to bootstrap new {redhat} 6 clients, follow the troubleshooting procedure in xref:administration:troubleshooting/tshoot-intro.adoc[Troubleshooting].
//====
...
| {sll} 9     | RHEL and Liberty 9 Base          | RES9-Manager-Tools-Pool for x86_64 and RES9-Manager-Tools-Updates for x86_64
...
//{sll} 6 is now at end-of-life, and the ISO images provided in the repository are out of date.
//Bootstrapping new {sll} 6 clients using these packages will fail.
//If you need to bootstrap new {sll} 6 clients, follow the troubleshooting procedure in xref:administration:troubleshooting/tshoot-intro.adoc[Troubleshooting].
//====
...
. Create a directory to contain the media content.
    Replace [command]``<os_name>`` with either ``sleses7``, ``sleses8``, or ``sleses9``:
+
----
