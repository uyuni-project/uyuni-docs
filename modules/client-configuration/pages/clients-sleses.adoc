...
If you need to bootstrap new {redhat} 6 clients, follow the troubleshooting procedure in xref:administration:tshoot-intro.adoc[Troubleshooting].
====
...
{es} 6 is now at end-of-life, and the ISO images provided in the repository are out of date.
Bootstrapping new {es} 6 clients using these packages will fail.
If you need to bootstrap new {es} 6 clients, follow the troubleshooting procedure in xref:administration:tshoot-intro.adoc[Troubleshooting].
====
...
For more information about how to resolve this error, see ``Registering Older Clients`` at xref:administration:tshoot-intro.adoc[Troubleshooting].
====
