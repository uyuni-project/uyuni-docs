...
If you need to bootstrap new {redhat} 6 clients, follow the troubleshooting procedure in xref:administration:troubleshooting/tshoot-clients.adoc[].
====
...
Bootstrapping new {es} 6 clients using these packages will fail.
<<<<<<< HEAD
If you need to bootstrap new {es} 6 clients, see xref:administration:troubleshooting/tshoot-clients-registeringolderclients.adoc[].
=======
If you need to bootstrap new {es} 6 clients, follow the troubleshooting procedure in xref:administration:troubleshooting/tshoot-clients.adoc[].
...
<<<<<<< HEAD
For more information about how to resolve this error, see xref:administration:troubleshooting/tshoot-clients-registeringolderclients.adoc[].
=======
For more information about how to resolve this error, see ``Registering Older Clients`` at xref:administration:troubleshooting/tshoot-clients.adoc[].
>>>>>>> 64009c2b42e09ebb32ee9c2116cd0999eeda78dc
====
