...
They are sometimes also called SLESES, Liberty, RES or {redhat} {es}.
...
| {es} 9     | RHEL, Liberty and Clones Base    | RES9-Manager-Tools-Pool for x86_64 and RES9-Manager-Tools-Updates for x86_64
