...
:description: Register SUSE Liberty Linux clients by setting up base channels, importing Red Hat or CentOS packages as custom child channels, and synchronizing required
:revdate: 2025-08-19
