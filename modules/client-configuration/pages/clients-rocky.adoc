...
:description: Configure Rocky Linux clients as Salt clients by adding required software channels, synchronizing them, creating an activation key, and checking the
:revdate: 2025-03-10
...
Traditional clients are not available on {rocky}.
{rocky} clients are only supported as Salt clients.
