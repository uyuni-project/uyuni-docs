...
:description: Discover which features are available on your Server, Client, or Proxy based on your operating system variant, including SLES for SAP and for HPC.
:revdate: 2024-05-10
