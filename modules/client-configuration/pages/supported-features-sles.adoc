...
:description: Heres the corrected sentence Learn about the supported features for SUSE and openSUSE client systems, available on various operating system variants
:revdate: 2022-12-21
