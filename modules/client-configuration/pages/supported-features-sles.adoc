...
:description: Learn about feature availability on SUSE and openSUSE clients regarding registration, package installation, and system management
:revdate: 2024-05-10
...
{leap} is supported by the {suse} community.
====
