...
== Bootstrap Repository for End-of-Life Product

Bootstrap repositories of supported products are automatically created and regenerated on the {productname} Server for every synchronized product.
But if a product passes end-of-life and is unsupported, you must create a bootstrap repository for such a product manually in case you need it.
