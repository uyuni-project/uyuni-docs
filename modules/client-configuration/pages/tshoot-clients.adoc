...
* Cause: Older clients ({centos}{nbsp}6, {oracle}{nbsp}6, {rhel}{nbsp}6, or {sleses}{nbsp}6 clients) need to have scp. python, and perl installed, and the server needs to support older types of SSL encryption, in order to successfully register them.
...
* Fix: Before registering {centos}{nbsp}6, {oracle}{nbsp}6, {rhel}{nbsp}6, or {sleses}{nbsp}6 clients:
+
* Ensure you have installed python and scp
* Force Apache to accept a greater range of protocol versions.
...
Additionally, the clients must have Python, Perl, and ``scp`` packages installed before registration.
...
To fix this error, ensure that the clients have both Python, Perl, and ``scp`` packages installed before registration.
Additionally, you need to force Apache on the server to accept a greater range of protocol versions.
