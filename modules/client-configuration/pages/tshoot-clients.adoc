...
. On the {productname} Server, at the command prompt, remove the repositories provided by the {centos} 6 ISO:
+
----
rm CentOS-Base.repo CentOS-Debuginfo.repo CentOS-fasttrack.repo
----
. Add a new repository:
+
----
zypper addrepo -f http://vault.centos.org/6.10/os/$basearch/
----
+
// Maybe we need to write the file from scratch? --LKB 2021-02-12
+
----
[C6.10-base]
