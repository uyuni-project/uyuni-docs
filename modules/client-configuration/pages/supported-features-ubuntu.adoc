...
:description: Learn about supported features and their availability on Ubuntu clients for use with SUSE Manager, including both client and server support
:revdate: 2025-08-18
