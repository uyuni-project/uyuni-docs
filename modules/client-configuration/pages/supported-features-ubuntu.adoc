...
| Basic Virtual Guest Management {star} | {salt} | {salt}
| Advanced Virtual Guest Management {star} | {salt} | {salt}
...
| System deployment (PXE/Kickstart) | {cross} | {cross}
...
| Software crash reporting | {cross} | {cross}
| Staging (pre-download of packages) |  {question} | {question}
