...
<<<<<<< HEAD
If you need to bootstrap new {oracle} 6 clients, see xref:administration:troubleshooting/tshoot-clients-registeringolderclients.adoc[].
=======
If you need to bootstrap new {oracle} 6 clients, follow the troubleshooting procedure in xref:administration:troubleshooting/tshoot-clients.adoc[].
