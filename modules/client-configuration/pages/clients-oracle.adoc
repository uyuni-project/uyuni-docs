...
Traditional clients are not available on {oracle} 9 and 8.
{oracle} 9 and {oracle} 8 clients are only supported as Salt clients.
...
To set up a local ULN mirror, consult the Oracle documentation provided at this https://docs.oracle.com/en/operating-systems/oracle-linux/software-management/sfw-mgmt-UseSoftwareDistributionMirrors.html#local-uln-mirror[link].
====
...
//If you need to bootstrap new {oracle} 6 clients, follow the troubleshooting procedure in xref:administration:troubleshooting/tshoot-intro.adoc[Troubleshooting].
//====
