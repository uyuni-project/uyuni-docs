...
:description: Register and manage Oracle Linux clients, running either traditional or SaltStack architectures, with SUSE Manager Server
:revdate: 2025-03-10
...
ifndef::backend-pdf[]
include::client-configuration:partial$appstream_admon.adoc[]
endif::[]

ifdef::backend-pdf[]
include::../partials/appstream_admon.adoc[]
endif::[]
