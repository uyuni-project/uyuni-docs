...
:description: Configure clients to connect exclusively to SUSE Manager Proxy servers for Salt operations, package downloads, and other tasks through the Web UI, command-line
:revdate: 2023-10-24
