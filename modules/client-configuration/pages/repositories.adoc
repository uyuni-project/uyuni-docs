...
[WARNING]
====
In general, client systems should not have local repositories configured.
Local repositories can cause management troubles because you do not know what is available on the client system and you can get packages installed you did not expect.
====
