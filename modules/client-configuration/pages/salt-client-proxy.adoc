...
The following section covers registering Salt clients on a {productname} Proxy.
When registered the clients connect to the proxy exclusively for Salt operations and normal HTTP package downloads.
