...
// FIXME: change Salt bundle, when implemented
// If you use the Salt bundle, which now is the default, the needed Python environment will be provided automatically.
// For more information, see xref:client-configuration:registration-methods-saltbundle.adoc[].
