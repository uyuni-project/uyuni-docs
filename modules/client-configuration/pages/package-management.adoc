[[package-management]]
= Package Management
:description: Manage Client software packages by installing, upgrading, and removing applications in accordance with system profiles and settings on Server.
:revdate: 2024-11-21
