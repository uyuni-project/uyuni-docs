[[package-management]]
= Package Management
:description: Configure client software packages through the SUSE Manager Web UI to install, uninstall, and upgrade software efficiently; manage profiles for streamlined
:revdate: 2024-10-07
