...
* A repository removes a package.
  By default, in {productname} 5.0, we also unlink such package from the channel, but do not remove it.
  In {productname} 4.3, this was the strict mode behavior.
