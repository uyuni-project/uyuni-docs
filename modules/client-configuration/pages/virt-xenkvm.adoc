...
:description: Learn how to manage Xen and KVM virtualized clients in SUSE Manager by setting up a virtual host and configuring autoinstallation with AutoYaST or Kickstart
:revdate: 2025-07-09
