...
The [guimenu]``Virtualization`` tab allows you to create and manage virtual guests, and manage storage pools and virtual
...
. The new virtual guest will start as soon as it has successfully been created.
