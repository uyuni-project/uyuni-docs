[[virtualization]]
= Virtualization
:description: Learn how to effectively manage virtualized clients using SUSE Manager by configuring and controlling virtual hosts, guests, storage pools, and virtual networks
:revdate: 2024-09-04
