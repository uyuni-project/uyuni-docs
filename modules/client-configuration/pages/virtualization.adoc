...
In this type of installation, a virtualization host is installed on the {productname} Server to manage any number of virtual guests.
Within this document, instead of "virtualization host" sometimes the short form "virtual host" is used.
