...
|===
| Feature | {oracle}{nbsp}6 | {oracle}{nbsp}7 | {oracle}{nbsp}8
...
| Apply patches (requires CVE ID) | icon:check[role="green"] | icon:check[role="green"] | ``Salt``
...
| Software crash reporting | icon:check[role="green"] | icon:check[role="green"] | ``Salt``
