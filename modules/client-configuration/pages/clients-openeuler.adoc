...
This section contains information about registering traditional and Salt clients running {openeuler} operating systems.
...
[IMPORTANT]
====
* {openeuler} repository URLs are available from {scc}
...
[IMPORTANT]
====
Traditional clients are not available on {openeuler}{nbsp}22.03.
{openeuler}{nbsp}22.03 clients are only supported as Salt clients.
====
