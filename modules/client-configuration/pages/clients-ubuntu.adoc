...
* Base channel: [systemitem]``ubuntu-20.04-pool for amd64``
...
// I have left the examples as bionic for now. We will need to update them to focal at some point, though. --LKB 2020-04-29
