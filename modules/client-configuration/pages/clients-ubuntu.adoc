...
These examples are for {ubuntu} 20.04 (focal).
...
* In the [guimenu]``Repository URL`` field, type [systemitem]``http://archive.ubuntu.com/ubuntu/dists/focal/main/binary-amd64/``.
...
* In the [guimenu]``Repository Label`` field, type [systemitem]``ubuntu-focal-main-updates``.
* In the [guimenu]``Repository URL`` field, type [systemitem]``http://archive.ubuntu.com/ubuntu/dists/focal-updates/main/binary-amd64/``.
* In the [guimenu]``Repository Type`` field, select [systemitem]``deb``.
* Leave all other fields as the default values.
. Click btn:[Create Repository].
...
* In the [guimenu]``Repository Label`` field, type [systemitem]``ubuntu-focal-main-security``.
* In the [guimenu]``Repository URL`` field, type [systemitem]``http://archive.ubuntu.com/ubuntu/dists/focal-security/main/binary-amd64/``.
* In the [guimenu]``Repository Type`` field, select [systemitem]``deb``.
* Leave all other fields as the default values.
. Click btn:[Create Repository].
...
ubuntu-2004-amd64-main-updates \
ubuntu-2004-amd64-main-security
----
...
// Uncomment the following lines we add the Ubuntu 20.04 there (Leap 15.2 server is require first)
For {ubuntu} 20.04:
----
spacewalk-common-channels \
