...
:description: Learn how to register Ubuntu clients (20.04, 22.04, 24.04) with SUSE Manager using Salt bootstrapping, or add software channels and synchronize for supported
:revdate: 2025-08-18
