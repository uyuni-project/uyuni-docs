...
== Troubleshooting: Install `spacecmd`

The installation of [package]``spacecmd`` may fail with:
...
. On the client, in [path]``/etc/apt/sources.list`` uncomment the universe repositories.
