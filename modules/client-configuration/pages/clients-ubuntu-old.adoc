...
If you need to bootstrap new {ubuntu} 16.04 clients, follow the troubleshooting procedure in xref:administration:troubleshooting/tshoot-clients.adoc[].
====
...
{ubuntu} 16.04 is now at end-of-life, and the ISO images provided in the repository are out of date.
Bootstrapping new {ubuntu} 16.04 clients using these packages will fail.
If you need to bootstrap new {ubuntu} 16.04 clients, follow the troubleshooting procedure in xref:administration:troubleshooting/tshoot-intro.adoc[].
====
