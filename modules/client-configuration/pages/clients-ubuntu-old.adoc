...
{productname} supports {ubuntu} 16.04 LTS, 18.04 LTS, 20.04 LTS and 22.04 LTS clients using Salt.
...
For more information about GPG keys, see see xref:client-configuration:gpg-keys.adoc[].
