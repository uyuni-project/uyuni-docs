...
This section contains information about registering Salt clients running {ubuntu} 16.04 LTS and 18.04 LTS operating systems.

ifeval::[{suma-content} == true]
{productname} supports {ubuntu} 16.04 LTS, 18.04 LTS, and 20.04 LTS clients using Salt.
For information about registering Salt clients running {ubuntu} 20.04 LTS, see xref:client-configuration:clients-ubuntu.adoc[].
endif::[]
...
For instructions, see the ``Granting Root User Access`` procedure in the <<ubuntu-root-access>> section.
