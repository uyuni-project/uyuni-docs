...
:description: Learn how to register and onboard Ubuntu 18.04 LTS clients using Salt with SUSE Manager, configure software channels, sync metadata, and manage client
:revdate: 2024-08-28
