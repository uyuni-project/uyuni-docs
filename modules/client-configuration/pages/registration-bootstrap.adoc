...
Registering clients with a bootstrap script gives you good control over parameters, and can help if you have to register a large number of clients at once.
