...
It is posible to avoid installing Salt bundle and keep using [package]``salt-minion`` if you need it for some reason. See xref:client-configuration:registration-methods-saltbundle.adoc[Client Registration with Salt Bundle] for details.
====
