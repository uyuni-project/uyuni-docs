...
[NOTE]
====
A bootstrap repository is needed for all SLE and non-SLE clients. It is automatically created and regenerated on the SUSE Manager Server when products are synchronised.
