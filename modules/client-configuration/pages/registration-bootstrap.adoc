...
:description: Register clients quickly and efficiently using a bootstrap script, which can be customized for large deployments and ensures necessary packages are deployed.
:revdate: 2025-06-10
