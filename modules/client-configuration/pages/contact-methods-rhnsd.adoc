...
:description: Configure and manage the SUSE Manager daemon (rhnsd) to periodically check for new updates, perform notifications, and execute scheduled actions
:revdate: 2021-01-19
