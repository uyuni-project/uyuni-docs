...
The {productname} daemon ([command]``rhnsd``) is only used on {sle}{nbsp}11 and {rhnminrelease6}, as these systems do not use systemd.
...
If you set the interval below one hour, it changes back to the default of four hours (240 minutes).
