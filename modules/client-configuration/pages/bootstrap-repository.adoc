...
You can create a bootstrap repository on the {productname} Server.

When you have created the bootstrap repository, the packages in the repository will be installed during client registration.


== Prepare to Create a Bootstrap Repository

Before you create the bootstrap repository, ensure client is fully synchronized with your vendor channel.
...
== Generate a Bootstrap Repository
