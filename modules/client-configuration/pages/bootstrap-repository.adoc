...
:description: To create a bootstrap repository in Automatic Mode, configure the required options for the Server to generate it automatically during product synchronization.
:revdate: 2025-02-06
