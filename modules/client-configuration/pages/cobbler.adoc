...
The process can take a few minutes, and the system automatically shutd down when it is complete.
...
However, you can not schedule provisioning, it happens automatically as soon as the system is configured and powered on.
