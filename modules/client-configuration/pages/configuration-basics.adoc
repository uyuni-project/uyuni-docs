...
= Configuration Basics
:description: Learn about preparing your environment for client registration and the use of various operations in SUSE Manager, following a series of initial configuration
:revdate: 2022-01-03
