...
:description: Configure the required software channels on your SUSE Manager Server, then add Amazon Linux clients, synchronize them, create an activation key associated
:revdate: 2025-03-27
