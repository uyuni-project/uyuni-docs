...
[NOTE]
====
For {amazon} 2, make sure you also add and sync `amazonlinux2-extra-docker` channel if you plan to use Docker at your {amazon} instances.
====

[NOTE]
====
For {amazon} 2023, make sure you also add and sync `amazonlinux2023-kernel-livepatch` channel if you plan to use Kernel Live patches at your {amazon} instances.
====
