...
The node to be joined might need manual configuration before joining the cluster. Ensure the machine is used used exclusively as a {caasp} node and that swap is turned off.
