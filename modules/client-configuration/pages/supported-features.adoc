...
:description: Here is the corrected sentence Discover and explore a comprehensive list of supported client systems and architectures for SUSE Manager. I removed the redundant
:revdate: 2025-08-18
