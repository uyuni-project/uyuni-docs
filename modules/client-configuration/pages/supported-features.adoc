...
:description: Learn about the supported client operating systems and technologies for SUSE Manager, including details on client features and hardware options
:revdate: 2025-08-18
