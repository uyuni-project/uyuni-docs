[[system-locking]]
= System Locking
:description: Learn how to effectively implement system and package locking in SUSE Manager to prevent unauthorized actions, manage production software, and maintain
:revdate: 2024-12-12
