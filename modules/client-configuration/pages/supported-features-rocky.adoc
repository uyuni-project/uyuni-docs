...
|===
| Feature | {rocky}{nbsp}8 | {rocky}{nbsp}9

| Client | {check} (plain {rocky}) | {check} (plain {rocky})
| System packages | {rocky} Community | {rocky} Community
...
| Product migration {star} | {check} | {check}
| Basic Virtual Guest Management {star}{star} | {check} | {check}
| Advanced Virtual Guest Management {star}{star} | {check} | {check}
| Virtual Guest Installation (Kickstart), as Host OS | {cross} | {cross}
| Virtual Guest Installation (image template), as Host OS | {check} | {check}
| System deployment (PXE/Kickstart) | {check} | {check}
| System redeployment (Kickstart) | {check} | {check}
...
| Snapshots and profiles | {check} Profiles supported, Sync not supported | {check} Profiles supported, Sync not supported
| Power management | {check} | {check}
| Monitoring server | {cross} | {cross}
| Monitored clients | {check} | {check}
| Docker buildhost | {cross} | {cross}
| Build Docker image with OS | {cross} | {cross}
| Kiwi buildhost | {cross} | {cross}
| Build Kiwi image with OS | {cross} | {cross}
| Recurring Actions | {check} | {check}
| AppStreams | {check} | {check}
| Yomi | N/A | N/A
|=== 
