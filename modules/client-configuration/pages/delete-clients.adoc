[[delete.clients]]
= Client Deletion
:description: Configure client deletion using the Web UI or command-line options in your SUSE Manager Server, removing clients safely without uninstalling packages to allow
:revdate: 2025-04-28
