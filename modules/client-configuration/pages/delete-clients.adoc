[[delete.clients]]
= Client Deletion
:description: Configure and delete clients from your SUSE Manager Server using either the Web UI or command-line interfaces for traditional and Salt clients
:revdate: 2025-04-28
