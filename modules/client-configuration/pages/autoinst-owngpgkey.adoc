...
:description: Provide your own GPG key for autoinstallation to securely sign package metadata without using insecure kernel parameters or signature checks.
:revdate: 2024-07-10
