[[ssm]]
= System Set Manager
:description: Learn how to manage multiple clients simultaneously with SSM by creating ephemeral client sets or using system groups for permanent configurations
:revdate: 2024-11-21
