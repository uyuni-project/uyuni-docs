[[ssm]]
= System Set Manager
:description: Learn how to use System Set Manager (SSM) to perform bulk actions on multiple clients at once, including installing patches, upgrading packages, and more.
:revdate: 2024-11-21
