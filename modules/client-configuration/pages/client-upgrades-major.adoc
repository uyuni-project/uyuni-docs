...
// Uyuni is Salt clients only.  Uyuni does not manage traditional clients.
// Thus this should be a default action.
Use the ``spacewalk/minion_script`` snippet to register the client again after migration has completed.
endif::[]
