...
This guide covers clients registered to {redhat} CDN or RHUI.
...
[NOTE]
====
If your {redhat} client is using RHUI (public cloud) repositories, you would need to use a different set CA and entitlement certificates. As an example:
