...
[NOTE]
====
If your {redhat} client is using Red Hat Update Infrastructure (RHUI) repositories, you would need to use a different set CA and entitlement certificates. As an example:
