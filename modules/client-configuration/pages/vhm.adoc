...
[NOTE]
====
Only BYOS instances (bring your own subscription) are passed to the subscription matcher.
If your public cloud instances are PAYG (pay as you go), they will be excluded from the subscription matcher counting.
====
