...
[NOTE]
====
Only BYOS (Bring-Your-Own-Subscription) instances are passed to the subscription matcher. In case your Public Cloud instances are PAYG (Pay-As-You-Go), these will be excluded from the subscription matcher counting.
====
