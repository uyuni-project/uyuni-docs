...
== Add Software Channels and Client Tools

Before you register {sle-micro} clients to your {productname} Server, you need to add the required software channels and client tools for some channels.
When the required channels are properly added, you must synchronize them.
...
The products you need for the {webui} procedure are:
