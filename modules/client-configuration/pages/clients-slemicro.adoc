...
:description: Register SLE Micro clients with your SUSE Manager Server and configure required software channels for transactional updates
:revdate: 2024-07-25
...
This section contains information about registering clients running these {nbsp}{sle-micro} operating systems 5.1, 5.2, 5.3, 5.4 and 5.5 {x86_64}, {arm64}, and {zsystems} (s390x).

The {sle-micro} is an ultra-reliable, lightweight operating system purpose built for edge computing.
...
Before you register {sle-micro} clients to your {productname} Server, you need to add the required software channels, and synchronize them.
...
| {sle-micro} 5.5
| suse-microos-5.5-uyuni-client

| {sle-micro} 5.4
| suse-microos-5.4-uyuni-client
