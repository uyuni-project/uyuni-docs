...
:description: Register clients on the command line using Salt by manually configuring and registering them to the SUSE Manager Server, then follow these rules
:revdate: 2025-01-21
