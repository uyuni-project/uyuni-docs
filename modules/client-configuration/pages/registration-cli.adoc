...
Both use differently located configuration files, but the filenames are the same, and a differently named systemd service file.
...
For more information about the Salt bundle, see xref:client-configuration:registration-methods-saltbundle.adoc[].
