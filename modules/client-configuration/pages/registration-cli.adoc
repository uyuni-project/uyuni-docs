...
----
. In the file add or edit the FQDN of the {productname} Server or of the Proxy, the activation key and the other configuration parameters as per the following example:
+
----
