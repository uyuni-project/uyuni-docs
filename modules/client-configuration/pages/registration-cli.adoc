...
:description: Register a Client on your Salt Server manually by editing the minion configuration file and providing the Server's fully qualified domain name.
:revdate: 2025-03-28
