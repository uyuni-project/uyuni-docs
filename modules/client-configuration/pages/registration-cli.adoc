...
:description: Configure manual registration of Salt clients to the SUSE Manager Server by editing the Salt minion files, providing the FQDN and activation key as specified
:revdate: 2025-01-21
