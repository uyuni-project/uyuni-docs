...
:description: Navigate to Systems Custom System Info in the Client OS and click Create Key to store custom system information as categorized and searchable key-value pairs.
:revdate: 2024-03-05
