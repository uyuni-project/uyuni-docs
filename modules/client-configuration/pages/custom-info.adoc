...
:description: Learn how to create and manage customized system information for clients using key-value pairs that can be assigned to specific clients or groups within the
:revdate: 2024-03-05
