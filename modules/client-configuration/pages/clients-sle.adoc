...
:description: Configure SUSE Linux Enterprise clients with required software channels and synchronize them to your SUSE Manager Server
:revdate: 2025-06-02
...
| {sles} 16.0
| sle-product-sles16.0-pool-x86_64
