:description: Add software channels to your Client system for automatic updates and access to necessary packages by checking and adding required products in the Setup Wizard.
