:description: Add software channels to the Server at the command prompt on the container host to enable synchronization and updates for specified channels and their children.
