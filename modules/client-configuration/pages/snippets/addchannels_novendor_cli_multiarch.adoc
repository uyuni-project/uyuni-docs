:description: Add software channels at the command prompt on your Server by specifying architecture and channel names to enable repository synchronization.
