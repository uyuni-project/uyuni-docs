...
When a software channel with GPG key information is assigned to a client, the key ges trusted as soon the channel is refreshed or the first package gets installed from this channel.
