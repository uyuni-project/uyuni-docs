:description: Navigate to the Products tab in Admin or the Repositories tab in Software Manage Channels to view synchronization progress for all products.
