...
spacewalk-common-channels -u admin -a amd64-deb debian-9-amd64-uyuni-client-devel
----
For {debian}{nbsp}10:
+
----
...
spacewalk-common-channels -u admin -a amd64-deb debian-10-amd64-uyuni-client-devel
----
