...
:description: Learn how to register and manage Salt clients on Debian operating systems with SUSE Manager, including bootstrapping and configuring clients for initial state
:revdate: 2025-03-10
...
////
// 2022-07-26, ke: old and probably outdated statement
[IMPORTANT]
====
...
These instructions have been tested on {debian}{nbsp}11.
