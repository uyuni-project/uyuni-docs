[[channels]]
= Software Channels
:description: This page serves as a starting point for accessing detailed information about software channels in MLM, including base and child channels, subscription.
:revdate: 2024-12-12
