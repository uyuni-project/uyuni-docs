[[channels]]
= Software Channels
:description: Manage software channels in SUSE Manager by learning how to configure base and child channels, subscribe clients, and implement content lifecycle management
:revdate: 2024-12-12
