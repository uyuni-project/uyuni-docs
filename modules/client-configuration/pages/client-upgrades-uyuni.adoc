...
:description: Configure Uyuni clients by synchronizing channels, updating repositories, and applying package upgrades through the SUSE Manager Server Web UI or with Salt
:revdate: 2022-10-04
