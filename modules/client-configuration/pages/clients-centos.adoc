...
.CentOS Channels - Wizard
|===
| OS Version | Package Name   | Channel Name
| {centos} 6 | centos6-x86_64 | CentOS 6 x86_64
| {centos} 7 | centos7-x86_64 | CentOS 7 x86_64
| {centos} 8 | centos8-x86_64 | CentOS 8 x86_64
|===
...
.CentOS Channels - Wizard
|===
| OS Version | Base Package | Uyuni Client Package | Updates Package
