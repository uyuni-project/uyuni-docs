...
include::ROOT/pages/snippets/add_channels_wizard.adoc[]
...
include::ROOT/pages/snippets/add_channels_mgrsync.adoc[]
...
ifeval::[{uyuni-content} == true]
include::snippets/add_channels_cli_multiarch.adoc[]
endif::[]
ifeval::[{suma-content} == true]
...
The authors of CEFS provide patches or errata on a best-effort basis, in the hope they will be useful but with no guarantees of correctness or currency.
