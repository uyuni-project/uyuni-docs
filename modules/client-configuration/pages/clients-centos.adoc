...
include::/../../modules/ROOT/pages/snippets/add_channels_mgrsync.adoc[]
...
include::{snippet}/add_channels_mgrsync.adoc[]
...
include::snippets/add_channels_scc_multiarch.adoc[]
