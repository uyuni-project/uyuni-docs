...
= Supported {sle-micro} Client Features
:description: Learn about the supported features for SLE Micro Client and their availability on Salt and on traditional clients
:revdate: 2024-07-25
