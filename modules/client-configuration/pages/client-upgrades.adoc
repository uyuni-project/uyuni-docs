[[client-upgrades]]
= Client Upgrades
:description: Learn how to efficiently upgrade client software using the YaST tools within the SUSE Manager Web UI, automate upgrades with a Content Lifecycle Manager,
:revdate: 2024-11-29
