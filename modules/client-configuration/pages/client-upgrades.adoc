...
For more information about product migration such as service pack upgrades or openSUSE Leap to {sle} migration, see xref:client-configuration:client-upgrades-product-migration.adoc[].
// endif::[]
