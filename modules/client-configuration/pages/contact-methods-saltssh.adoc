...
This image demonstrates the Push via SSH Push process path.
...
Additionally, the required Python version will be installed with the {salt} Bundle on the client system.
