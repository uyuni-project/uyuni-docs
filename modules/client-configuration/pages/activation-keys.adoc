...
You can use a reactivation key with a bootstrap script or the registration dialog of the {webui}.
For more information about bootstrap scripts, see xref:client-configuration:registration-bootstrap.adoc[].

Also the registration UI has a field to enter a reactivation key.
For more information about the registration with the {webui}, see xref:client-configuration:registration-webui.adoc[].
