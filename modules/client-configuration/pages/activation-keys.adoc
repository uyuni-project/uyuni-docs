[[activation-keys]]
= Activation Keys
:description: Use an activation key to configure software entitlements, channel assignments, and group subscriptions for your clients, simplifying their registration process.
:revdate: 2025-02-11
