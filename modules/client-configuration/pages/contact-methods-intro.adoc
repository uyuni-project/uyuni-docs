...
:description: Learn about the contact methods available for Server to communicate with clients using Salt protocols and their respective implementation options.
:revdate: 2024-09-27
