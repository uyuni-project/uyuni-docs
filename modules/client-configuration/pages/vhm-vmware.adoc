...
:description: Learn how to configure and use VMware virtual machines with SUSE Manager, which involves setting up a virtual host manager (VHM) for data collection
:revdate: 2024-09-04
