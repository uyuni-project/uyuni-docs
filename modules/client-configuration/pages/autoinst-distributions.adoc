...
For more information, see xref:client-configuration:autoinst-distributions.adoc#based-on-iso-image[Distribution Based on an ISO Image].

Alternatively, you can install package [package]``tftpboot-installation``.
For more information, see xref:client-configuration:autoinst-distributions.adoc#based-on-rpm-package[Distribution Based on an RPM Package].
...
For more information, see xref:client-configuration:autoinst-distributions.adoc#declare-distribution[Declare an Autoinstallable Distribution].
...
== Distribution Based on an RPM Package
...
You will find it on the {productname} Server in the products you mirrored with the command [command]``find /var/spacewalk -name "tftpboot-installation-*"``.
