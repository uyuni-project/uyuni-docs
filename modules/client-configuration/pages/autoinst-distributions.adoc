...
:description: Synchronize a base channel on your Server for the same operating system version as those files, and declare the distribution to associate installation files.
:revdate: 2025-02-06
