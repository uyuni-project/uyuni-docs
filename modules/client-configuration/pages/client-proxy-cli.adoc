...
:description: To register clients to a Proxy on the command line, configure the minion file with the Proxy's FQDN as the master and restart the salt-minion service on the.
:revdate: 2024-11-21
