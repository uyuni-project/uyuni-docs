[[system-types]]
= System Types
:description: Assigning an add-on system type helps categorize clients by their specific operational roles, such as virtualization host or container build host.
:revdate: 2023-11-23
