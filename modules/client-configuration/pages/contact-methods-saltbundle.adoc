...
= Salt Bundle
:description: Configure a single binary package containing Salt Minion and Python 3 on client systems that dont support specific Salt version requirements
:revdate: 2025-07-16
