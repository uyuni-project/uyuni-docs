...
= Salt Bundle
:description: Learn how to configure and deploy the Salt Bundle for streamlined Salt Minion management, including bootstrapping and SSH actions, with no requirement for a
:revdate: 2025-07-16
