...
= Salt Bundle
:description: The Salt Bundle is a pre-packaged binary package containing everything required to run Salt on a Client, eliminating dependency on system Python versions.
:revdate: 2025-07-14
