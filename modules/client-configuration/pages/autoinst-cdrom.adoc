...
:description: When preparing a bootable CD-ROM or USB key for autoinstallation, learn how to create an ISO image with Cobbler and various options for customizing it.
:revdate: 2024-11-27
