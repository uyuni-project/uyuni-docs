...
:description: Configure bootable CD-ROMs or USB keys for system installation using YaSTs tools with Cobbler or KIWI, which provide network-free installation options
:revdate: 2024-11-28
