...
:description: Register and configure AlmaLinux clients in a SUSE Manager environment by following these rules strictly
:revdate: 2025-03-10
...
[IMPORTANT]
====
Traditional clients are not available on {almalinux}.
{almalinux} clients are only supported as Salt clients.
====
