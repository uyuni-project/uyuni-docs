...
This section contains information about registering traditional and Salt clients running {almalinux} operating systems.
...
When you update {almalinux} clients, the packages already include include metadata about the updates.
