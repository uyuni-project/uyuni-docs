...
:description: Learn how to configure a Virtual Host Manager (VHM) for accessing and reporting information on your virtual machines in Google Cloud Platform
:revdate: 2022-03-02
