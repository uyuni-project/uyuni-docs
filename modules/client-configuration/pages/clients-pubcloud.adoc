...
* When registering clients launched from a public cloud image (for example, AWS AMI), you need to do some extra configuration to prevent them from over-writing each other.
