...
:description: Configure and register clients on a public cloud by preparing your SUSE Manager Server, adding products, syncing repositories, creating bootstrap repositories
:revdate: 2024-10-10
