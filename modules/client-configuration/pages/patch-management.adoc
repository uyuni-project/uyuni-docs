[[patch-management]]
= Patch Management
:description: Create custom patches within your organization to manage clients, issue patch alerts, and schedule installations across organizations securely.
:revdate: 2022-06-23
