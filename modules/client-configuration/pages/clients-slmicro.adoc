...
:description: Learn how to register SL Micro clients to the SUSE Manager Server by adding required software channels and synchronizing them via Web UI or command-line
:revdate: 2025-02-05
...
This section contains information about registering clients running {sl-micro} operating system {x86_64}, {arm64}, and {zsystems} (s390x).
