...
:description: Configure SL Micro clients to register with your SUSE Manager Server by adding software channels, synchronizing them, and then complete the registration
:revdate: 2025-01-08
...
| {sl-micro} {microversion} {x86_64}
| SUSE Linux Micro 6.1 x86_64

| {sl-micro} {microversion} {arm64}
| SUSE Linux Micro 6.1 arch64

| {sl-micro} {microversion} {s390x}
