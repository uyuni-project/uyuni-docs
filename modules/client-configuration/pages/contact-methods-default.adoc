...
:description: Learn how to configure Salt protocol as the default contact method, deploy the YaST tools package, including the venv-salt-minion, in support of SUSE Manager
:revdate: 2024-09-30
