...
.Raspberry Pi OS Products - WebUI
|===

| OS Version | Product Name
| {raspberrypios} 12 | Raspberry Pi OS 12 (bookworm) main for arm64
|===
...
[[raspberrypios-channels-suma-cli]]
[cols="1,1", options="header"]
.Raspberry Pi OS Channels - CLI
|===

| OS Version | Base Channel
| {raspberrypios} 12 arm64 | raspberrypios-12-pool-arm64
| {raspberrypios} 12 armhf | raspberrypios-12-pool-armhf
|===
...
[[raspberrypios-arm64-other-channels-cli-uyuni]]
[cols="1,1", options="header"]
.Raspberry Pi OS 12 arm64 other channels - CLI
|===

| {raspberrypios} arm64           | {nbsp}
...
[[raspberrypios-armhf-other-channels-cli-uyuni]]
[cols="1,1", options="header"]
.Raspberry Pi OS 12 armhf other channels - CLI
|===

| {raspberrypios} armhf           | {nbsp}
