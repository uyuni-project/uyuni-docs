...
:description: Learn how to automatically register clients created by Terraform with SUSE Manager using either the cloud-init or remote execution provisioner
:revdate: 2024-03-05
