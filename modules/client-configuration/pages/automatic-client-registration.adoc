...
:description: Learn how to automatically register virtual machines created by Terraform using either cloud-init or remote-exec provisioner registration methods.
:revdate: 2024-03-05
