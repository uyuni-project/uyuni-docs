...
[IMPORTANT]
====
* Always verify the type of image (PAYG or BYOS) prior to initiating the bootstrapping process with {productname} to ensure a smooth and error-free process.
