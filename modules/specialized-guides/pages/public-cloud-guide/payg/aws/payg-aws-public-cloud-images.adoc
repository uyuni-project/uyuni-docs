...
:description: Configure the SUSE Manager 5.0 PAYG image on AWS by following step-by-step instructions to locate it in the available images, which can be found either using
:revdate: 2025-02-26
