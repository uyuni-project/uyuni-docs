= {payg} Limitations
:description: Configure BYOS instances of SUSE products in SUSE Manager PAYG by setting valid SUSE Customer Center credentials to avoid onboarding restrictions and repository
:revdate: 2025-02-26
