= {payg} Limitations
:description: Onboarding instances without valid credentials prevents management and access to repositories, leading to HTTP 401 Unauthorized errors until credentials are.
:revdate: 2025-02-26
