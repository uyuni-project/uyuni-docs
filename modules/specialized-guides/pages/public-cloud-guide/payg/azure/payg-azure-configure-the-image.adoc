...
:description: Configure virtual machines in Microsoft Azure using SUSE Manager images, following detailed step-by-step guidance for settings and configurations
:revdate: 2023-11-30
