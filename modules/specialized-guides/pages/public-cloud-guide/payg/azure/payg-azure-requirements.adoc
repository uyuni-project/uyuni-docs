...
:description: Here's the meta description Learn about the specific instance requirements and resource group configurations needed for a Managed Application in Azure.
:revdate: 2025-06-06
