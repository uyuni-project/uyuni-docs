[[azure-server-setup]]
= Initial Setup
:description: Configure storage using mgr-storage-Server for standard setups, or use mgr-storage-Proxy for Proxy configurations within the Managed Resource group.
:revdate: 2025-03-03
