[[azure-server-setup]]
= Initial Setup
:description: Configure your Microsoft Azure instance with SUSE Manager PAYG by updating the system, setting up storage with the mgr-storage-server or mgr-storage-proxy
:revdate: 2025-02-28
