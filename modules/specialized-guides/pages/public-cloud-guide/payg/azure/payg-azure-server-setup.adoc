[[azure-server-setup]]
= Initial setup
:description: Configure your Microsoft Azure instance for SUSE Manager setup by completing initial system updates and configuring storage using suma-storage
:revdate: 2024-12-30
