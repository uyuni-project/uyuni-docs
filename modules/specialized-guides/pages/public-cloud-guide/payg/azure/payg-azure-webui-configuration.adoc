...
:description: Configure SUSE Manager on Microsoft Azure by following setup procedures to ensure that the instance-flavor-check tool and PAYG schedule check are functioning
:revdate: 2023-11-30
