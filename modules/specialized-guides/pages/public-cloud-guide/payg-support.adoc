...
To open a new support case for your cloud pay-as-you-go instance, you need to generate a supportconfig file and then follow the steps listed on https://scc.suse.com/cloudsupport
