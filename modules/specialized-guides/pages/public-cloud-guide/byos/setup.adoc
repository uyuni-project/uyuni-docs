...
= Initial Setup
:description: Learn how to set up and run SUSE Manager quickly in a public cloud environment like Amazon EC2, Google Cloud Platforms Compute Engine, or Microsoft Azure
:revdate: 2025-02-26
