...
= Initial Setup
:description: This guide helps you quickly set up and configure your Server or Proxy in a public cloud environment using BYOS services from providers like Amazon EC2, Google.
:revdate: 2025-02-26
