...
[IMPORTANT]
====
For a customer with 10+ PAYG SLES for SAP Applications instances and wants access to the SUMA BYOS Lifecycle subscription, you must send an email to susemanagerkey@suse.com, including proof of running at least 10 instances of SLES for SAP PAYG. 
