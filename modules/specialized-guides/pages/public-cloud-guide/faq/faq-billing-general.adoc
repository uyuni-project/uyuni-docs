= Billing - General
:description: Information on using managed instances with PAYG pricing in the cloud for SLES for SAP deployments procured through the provider's marketplace.
:revdate: 2025-02-26
