= Billing - General
:description: calculates the amount of managed instances to bill for based on the number of active nodes, including temporary deployments and bursting usage.
:revdate: 2025-02-26
