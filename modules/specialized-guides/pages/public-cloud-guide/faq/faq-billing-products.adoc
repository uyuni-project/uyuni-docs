= Billing - Products
:description: Understand the key differences between the MLM PAYG product on cloud marketplaces and versions run in your own data center to make informed decisions.
:revdate: 2025-02-26
