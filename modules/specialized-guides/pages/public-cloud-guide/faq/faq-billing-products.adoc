= Billing - Products
:description: Configure a new SUSE Manager PAYG instance from the cloud marketplace, onboard existing instances using standard processes, and manage workloads in hybrid
:revdate: 2024-02-07
