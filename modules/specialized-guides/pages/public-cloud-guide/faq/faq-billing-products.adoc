= Billing - Products
:description: Deploy and manage your SUSE workloads in the cloud using SUSE Manager PAYG, a scalable solution for hybrid environments
:revdate: 2025-02-26
...
Please note: Whilst the SUSE Manager Proxy usage is included as part of the {productname} {payg} subscription, an LCM+ subscription will be billed if the proxy is also a managed workload, so in other words it counted as a managed client.
