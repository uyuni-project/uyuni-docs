= Billing - Technical
:description: Learn how to deploy a SUSE Manager instance with an embedded billing engine from the cloud marketplace, and then manage your subscriptions independently
:revdate: 2025-02-26
