...
:description: Learn how to deploy SUSE Manager in the cloud with flexible PAYG and BYOS options for streamlined billing
:revdate: 2026-07-13
...
The listings can be found in the {aws} Marketplace. 
...
You should pick the listing that reflects in which country your {aws} account gets billed.
...
You can find out more about confirming your tax location for {awslongform}, it depends on the *tax address* of the account, see link:https://aws.amazon.com/tax-help/location[Tax help based on location]
...
It is not possible to transact/bill {productname} {payg} via {aws} Marketplaces in China. 
