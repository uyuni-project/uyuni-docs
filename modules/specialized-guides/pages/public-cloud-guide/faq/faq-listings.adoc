...
You can find out more about confirming your tax location for {awslongform}.
It depends on the *tax address* of the account, see link:https://aws.amazon.com/tax-help/location[Tax help based on location].
