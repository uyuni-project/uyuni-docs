...
:description: To resolve or avoid this issue, copy the underlying data into the new partitions by following the steps to create a backup and transfer the necessary files.
:revdate: 2025-02-26
