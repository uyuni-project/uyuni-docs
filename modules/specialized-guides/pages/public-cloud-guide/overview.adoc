[[public-cloud-guide]]
= Public Cloud Guide
:description: Learn how to deploy SUSE Manager in a public cloud environment using either on-demand or Bring-your-own-subscription services
:revdate: 2026-07-14
...
[NOTE]
====
{payglongform} or {byoslongform} services currently work on {awslongform}.
====
