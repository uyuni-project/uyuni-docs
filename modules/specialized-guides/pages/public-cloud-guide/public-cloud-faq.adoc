...
:description: Deploy SUSE Manager in the public cloud through AWS and Azure, utilizing a pay-monthly pricing model
:revdate: 2026-07-14
...
To support customers that prefer a cloud centric billing model, SUSE has recently published a new listing to the {aws} Marketplaces, {productname}.
