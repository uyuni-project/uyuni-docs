[[dhcpd-formula]]
= DHCPd Formula
:description: Learn how to configure the DHCP service on your branch server by navigating through the YaST tools and setting key parameters domain name, DNS server, listen
:revdate: 2025-06-06
