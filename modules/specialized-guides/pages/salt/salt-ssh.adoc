[[salt.ssh]]
= Salt SSH
:description: Configure Salt SSH connections for secure execution of Salt commands on clients over SSH, without exposing HTTP or HTTPS connections in firewall systems.
:revdate: 2025-02-06
