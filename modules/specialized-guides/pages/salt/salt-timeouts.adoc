[[salt.timeouts]]
= {salt} timeouts
:description: Configure Salt timeouts for optimal performance and accuracy in detecting unresponsive clients during presence pings and command execution.
:revdate: 2025-05-13
