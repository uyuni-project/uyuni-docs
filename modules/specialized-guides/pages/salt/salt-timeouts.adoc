[[salt.timeouts]]
= Salt timeouts
:description: Learn how to configure and understand timeout parameters in Salt, including timeout, gatherjobtimeout, and presence ping timeout values, which control waiting
:revdate: 2025-05-13
