[[salt.timeouts]]
= Salt timeouts
:description: Configure Salt timeout parameters to manage job execution timing, including the default values set by SUSE Manager and customization options for balancing
:revdate: 2025-05-13
