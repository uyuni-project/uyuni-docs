[[custom-states]]
= Custom Salt States
:description: Learn how to create and manage custom Salt states in SUSE Manager using centrally managed configuration channels with the YaST tools
:revdate: 2024-08-02
...
The custom states that you create using the {webui} are stored on the {productname} Server in the [path]``/srv/susemanager/salt/<organization>/`` directory.
