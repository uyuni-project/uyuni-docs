...
[[liberate-formula]]
= Liberate Formula
:description: To successfully migrate EL clients to Liberty Linux using the Liberate formula, configure MLM with required credentials and channels, then assign the formula.
:revdate: 2025-03-10
