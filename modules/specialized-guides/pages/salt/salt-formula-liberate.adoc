...
[[liberate-formula]]
= Liberate Formula
:description: Configure the Liberate formula in SUSE Manager to migrate EL clients, including CentOS 7 and Red Hat Enterprise Linux 9, to SUSE Liberty Linux during client
:revdate: 2025-03-10
