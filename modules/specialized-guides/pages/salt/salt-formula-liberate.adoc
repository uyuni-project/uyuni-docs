...
== Example Secure boot on {rhel} 8.10
...
For a fresh {rhel} 8.10 server with secure boot, [literal]`shim-x64-15.8-2.el8_10.x86_64` package is installed during liberation.
...
. Ensure that [literal]`shim-x64-15.8-2.el8_10.x86_64` is installed.
...
----
install grub2-*-2.02-156.el8.1
upgrade kernel-4.18.0-553.16.1.el8_10.1
----
