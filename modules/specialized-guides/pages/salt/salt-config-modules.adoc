...
:description: Learn how to configure your SUSE Manager and Uyuni servers with the Uyuni configuration modules, which provide a set of tools for defining, applying,
:revdate: 2024-12-12
...
They are especially useful if you have multiple {productname} Servers, for example in Hub installations, but they are also useful for smaller installations.
