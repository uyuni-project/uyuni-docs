[[monitoring-formula]]
= Monitoring Formula
:description: Configure and enable monitoring services in SUSE Manager using formulas with forms for Grafana visualizations and Prometheus data collection, including setting
:revdate: 2023-02-16
...
For more information on how to change the password, see xref:administration:monitoring.adoc[].
====
