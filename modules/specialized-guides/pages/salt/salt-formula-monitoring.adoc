[[monitoring-formula]]
= Monitoring Formula
:description: Configure Grafana and Prometheus formulas to enable monitoring of Server and clients, as well as PostgreSQL, Apache HTTPD, Kubernetes clusters, and other.
:revdate: 2025-02-06
