...
:description: Configure the Salt Master to transparently decrypt GPG-encrypted Pillar data on the fly using its built-in decryption mechanism with a specified GPG keyring
:revdate: 2022-03-01
