...
:description: Configure the GitFS fileserver backend in SUSE Manager using configuration options from either the /etc/salt/master file or a separate master.d directory
:revdate: 2024-12-12
