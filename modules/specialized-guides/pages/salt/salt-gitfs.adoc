...
:description: Learn how to configure and use the GitFS fileserver backend in SUSE Manager, a supported feature that enables storing files in one or more Git repositories
:revdate: 2024-12-12
