[[saltboot-formula]]
= {saltboot} Formula
:description: Learn about configuring disk images and partitioning for your specific hardware type using the Saltboot formula
:revdate: 2023-07-25
...
For more information on troubleshooting problems with the {saltboot} formula, see xref:administration:troubleshooting/tshoot-saltboot.adoc[].
