...
:description: Learn how to deploy and manage formulas provided by SUSE Manager using its pool software channel, including activation via the Web UI and using command-line
:revdate: 2022-01-05
