...
:description: Configure formulas provided by SUSE Multi-Linux Manager, or those installed from RPM packages, for activation via the SUSE Multi-Linux Manager Web UI
:revdate: 2025-02-06
