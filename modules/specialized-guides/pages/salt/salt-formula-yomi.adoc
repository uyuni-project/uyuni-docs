[[yomi-formula]]
= Yomi Formula
:description: Configure and customize formulas with forms for the Yomi installer on SUSE and openSUSE operating systems by following a comprehensive, step-by-step guide
:revdate: 2024-11-29
