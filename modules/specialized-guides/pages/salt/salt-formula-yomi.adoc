[[yomi-formula]]
= Yomi Formula
:description: Configure Yomi formulas with forms for SUSE and openSUSE operating systems. Then, install packages, restart services, prepare clients for provisioning,
:revdate: 2022-01-05
