[[salt.formulas]]
= Salt Formulas
:description: Learn how to create and manage Salt Formulas collections of states with generic parameters that enable reliable reproduction of complex configurations
:revdate: 2022-01-11
