[[salt.formulas]]
= Salt Formulas
:description: Learn how to create and manage reliable configurations with Salt Formulas, which include reusable collections of States and parameter fields
:revdate: 2022-01-11
