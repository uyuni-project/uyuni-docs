[[salt.command]]
= Salt Command
:description: Configure salt commands by combining target clients, groups, modules, and functions in a specific format to execute tasks with customizable arguments
:revdate: 2024-12-12
