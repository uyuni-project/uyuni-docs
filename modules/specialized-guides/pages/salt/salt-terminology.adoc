[[salt.terminology]]
= Terminology
:description: Learn how to configure and manage your Salt clients with SUSE Manager, including beacons, brokers, formulas, grains, highstate, key fingerprints, masters
:revdate: 2024-12-12
