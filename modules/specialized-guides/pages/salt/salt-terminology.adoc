[[salt.terminology]]
= Terminology
:description: To effectively configure and manage your SaltStack infrastructure, understand key concepts like beacons, brokers, environments, formulas, grains, highstates
:revdate: 2024-12-12
