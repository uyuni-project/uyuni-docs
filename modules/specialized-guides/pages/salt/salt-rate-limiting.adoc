[[salt.rate.limiting]]
= Salt Rate Limiting
:description: Configure your Salt rate-limiting parameters, including batch size and delay settings, to manage system load and parallelism within your environment
:revdate: 2022-01-11
