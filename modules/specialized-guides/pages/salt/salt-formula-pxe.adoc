[[pxe-formula]]
= PXE Formula
:description: Configure PXE booting on your branch server using the SUSE Manager Web UI, following a step-by-step procedure to set up necessary parameters
:revdate: 2023-11-07
