[[pxe-formula]]
= PXE Formula
:description: Configure PXE booting on the branch Server by setting specific parameters in the MLM Web UI, ensuring a successful connection between the Proxy and Server.
:revdate: 2025-06-12
