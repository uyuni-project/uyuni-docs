...
= Branch Network Formula
:description: Configure the networking services required by your Branch Server, including DHCP, DNS, TFTP, PXE, and FTP, for Proxy 4.3 to connect with Server 5.1.
:revdate: 2025-06-12
