...
= Branch Network Formula
:description: Configure branch servers for deployment with either dedicated or shared LANs, providing DHCP, DNS, TFTP, PXE, and FTP services through SUSE Manager
:revdate: 2022-01-05
