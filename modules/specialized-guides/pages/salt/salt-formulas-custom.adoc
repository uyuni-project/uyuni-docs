...
Based on the operating system, the placeholder <serving directory> needs to be replaced to [path]``/srv`` for SUSE based systems or [path]``/var`` for Red Hat based systems.
