...
Based on the operating system, the placeholder <serving directory> should be replaced with [path]``/srv`` for SUSE based systems or [path]``/var`` for Red Hat based systems.
