...
:description: Configure custom Salt formulas with forms in SUSE Manager, including formula structure, directory requirements, and metadata, to create dynamic, user-editable
:revdate: 2024-12-12
