...
= Configure Clients
:description: Configure SAP clients with SUSE Manager by installing and enabling formulas that include configurations for HANA databases and clustering setups
:revdate: 2023-10-16
