...
= Configure Clients
:description: Configure SAP clients in SUSE Manager using formulas with forms to enable and configure HANA database and clustering settings, ensuring proper integration
:revdate: 2023-10-17
