...
= Preparing Clients
:description: Learn how to prepare client systems for an SAP cluster by installing SUSE Linux Enterprise Server, configuring redundancy, and enabling failover protection
:revdate: 2023-11-29
