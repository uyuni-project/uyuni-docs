...
= Prepare Server
:description: Configure and set up your SUSE Manager Server by installing the required packages, running the setup script, and configuring administration access to the Web
:revdate: 2022-05-31
