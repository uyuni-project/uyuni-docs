...
= Prepare Server
:description: Learn how to deploy and configure the SUSE Manager Server using the mgradm command by selecting the SUSE Manager Server product during installation,
:revdate: 2024-11-29
