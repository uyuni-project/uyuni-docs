[[lsd-hub-reporting]]
= Hub Reporting
:description: Learn how to configure and manage reporting in SUSE Manager Hub by setting up databases, schema, and schedules for combined data aggregation and integrating
:revdate: 2025-08-04
