...
[NOTE]
====
The connection between hub and peripheral servers is now primarily established using xref:specialized-guides:large-deployments/hub-online-sync.adoc[Hub Online Synchronization (ISS v3)].
