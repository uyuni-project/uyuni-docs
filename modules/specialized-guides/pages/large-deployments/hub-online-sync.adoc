...
//FIX THIS: Awaiting developer's esponse baout the exact UI path to this form: . Go to menu:option_1[option_2].
//  You will see page [literal]``Sync Channels from Hub to Peripheral``.
. Open page [literal]``Sync Channels from Hub to Peripheral``.
