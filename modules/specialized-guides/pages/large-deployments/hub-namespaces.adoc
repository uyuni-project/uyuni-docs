...
:description: Learn about the Hub XMLRPC API Namespaces, which support targeting specific servers or hubs with various authentication and redirection methods
:revdate: 2022-01-05
