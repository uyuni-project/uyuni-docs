...
:description: Learn how to configure a scalable SUSE Manager deployment, utilizing multiple servers in a hub topology to simplify management of tens of thousands of clients
:revdate: 2024-03-19
