...
:description: Learn how to effectively monitor large-scale deployments using Prometheus and Grafana with SUSE Manager Server and Proxy, which provides self-health metrics
:revdate: 2024-03-07
