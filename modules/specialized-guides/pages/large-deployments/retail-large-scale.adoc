...
:description: Retail organizations can manage and maintain large-scale deployments of point-of-service terminals using this open source infrastructure management solution.
:revdate: 2025-05-20
