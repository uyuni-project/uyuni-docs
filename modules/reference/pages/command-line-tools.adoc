[[ref-cli]]
= Command Line Tools
:description: Master advanced system administration with various SUSE Manager command-line tools for managing configuration, package synchronization, bootstrapping,
:revdate: 2020-10-15
