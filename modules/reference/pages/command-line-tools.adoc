[[ref-cli]]
= Command Line Tools
:description: Reduce complexity and streamline tasks by using command line tools for package synchronization, bootstrapping, and database management on Server Client systems.
:revdate: 2024-06-24
