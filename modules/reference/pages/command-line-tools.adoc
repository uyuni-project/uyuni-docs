[[ref-cli]]
= Command Line Tools
:description: Configure and manage your SUSE systems using command-line tools like spacewalk-repo-sync, mgr-sync, mgr-create-bootstrap-repo, smdba, and others, which offer
:revdate: 2024-06-24
