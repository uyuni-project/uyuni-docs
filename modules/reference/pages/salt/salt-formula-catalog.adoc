...
= Formula Catalog
:description: Navigate to the Systems Details page for each client, then access the Formulas tab to configure or install the desired SUSE Manager formulas
:revdate: 2022-01-13
