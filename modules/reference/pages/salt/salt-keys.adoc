[[ref-salt-keys]]
= Keys
:description: The Salt Keys page displays the current key fingerprints for all connected Salt clients and facilitates identity verification with the Server.
:revdate: 2020-09-11
