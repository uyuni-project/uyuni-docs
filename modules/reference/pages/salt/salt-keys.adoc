[[ref-salt-keys]]
= Keys
:description: Learn to manage and verify Salt clients securely through key fingerprint exchange between SUSE Manager Server and clients in the Salt Keys List
:revdate: 2020-09-11
