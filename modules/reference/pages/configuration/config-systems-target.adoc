...
= Target Systems
:description: Check the box next to each profile name and then click the Enable SUSE Multi-Linux Manager Configuration Management button to configure and prepare your target
:revdate: 2024-11-29
