...
:description: View and manage all files currently stored in your central configuration channel, including details for each file, across your organizations network
:revdate: 2020-10-27
