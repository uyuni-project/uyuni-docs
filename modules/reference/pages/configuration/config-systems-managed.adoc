...
= Managed Systems
:description: Configure systems using the YaST tools where listed systems have been fully prepared for configuration file deployment, with system details accessible through
:revdate: 2020-10-27
