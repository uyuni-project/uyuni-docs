...
= Provisioning
:description: Configure provisioning for a selected client, including auto-installation scheduling and power control, using the YaST tools in the Systems menu
:revdate: 2023-11-14
