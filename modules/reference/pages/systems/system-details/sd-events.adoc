...
= Events
:description: The Events page in the Systems menu displays past, current, and scheduled actions for the selected Client, providing visibility into system activity.
:revdate: 2020-09-11
