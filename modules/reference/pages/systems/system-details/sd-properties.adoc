...
= Properties
:description: Learn how to edit detailed settings for clients in the Systems Details Properties section, including system name, hostname, base system type, and notification
:revdate: 2020-09-11
