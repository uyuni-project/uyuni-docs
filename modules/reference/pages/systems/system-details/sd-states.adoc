...
= States
:description: Manage Salt states on selected clients, including configuring package states, configuration channels, and highstates for streamlined system administration
:revdate: 2023-04-19
