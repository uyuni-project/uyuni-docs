...
= Product Migration
:description: Learn how to successfully upgrade clients to the latest service pack of their underlying operating system using YaST tools, migrate openSUSE Leap to SLES SP
:revdate: 2025-03-10
