...
= Custom Info
:description: Learn how to configure and manage custom system information for your clients using the YaST tools to apply new keys, edit existing values, and access detailed
:revdate: 2020-09-11
