...
To change the primary network interface on the client, select the correct interface in the [guimenu]``Primary Network Interface`` fiels in the [guimenu]``Networking`` section, and click btn:[Update Properties].