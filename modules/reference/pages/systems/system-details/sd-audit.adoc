...
= Audit
:description: Schedule scans for the selected Client on Linux systems, including Server and Client roles, to achieve compliance checking with SCAP specifications.
:revdate: 2020-09-11
