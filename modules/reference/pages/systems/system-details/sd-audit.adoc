...
= Audit
:description: Learn how to analyze and troubleshoot OpenSCAP scan results using the detailed table columns and navigation options in the Audit menu subtab
:revdate: 2020-09-11
