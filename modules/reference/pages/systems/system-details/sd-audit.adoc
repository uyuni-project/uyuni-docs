...
= Audit
:description: Deploy security scans with OpenSCAP through SUSE Manager by analyzing detailed results in the Systems[Audit] section, configuring custom scans, and scheduling
:revdate: 2020-09-11
