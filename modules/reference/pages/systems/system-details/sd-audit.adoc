...
= Audit
:description: The menu Systems[Audit] subtab displays openSCAP scan results, enabling you to view and analyze compliance checking solutions for your Linux infrastructure.
:revdate: 2020-09-11
