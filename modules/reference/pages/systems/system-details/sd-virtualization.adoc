[[ref-systems-sd-virt]]
= Virtualization
:description: Manage your virtualization setup by accessing and configuring virtual guests, storage pools, networks, and provisioning new guests with SUSE Linux Enterprise
:revdate: 2021-05-17
