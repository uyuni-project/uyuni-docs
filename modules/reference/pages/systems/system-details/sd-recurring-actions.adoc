...
= Recurring Actions
:description: Configure recurring actions on selected Salt clients to execute highstates or custom states at desired intervals via the Systems Menu within SUSE Manager
:revdate: 2023-04-19
