...
= Software Channels
:description: Configure software channels on a current client by selecting base channels with their associated child channels, which can be mandatory, recommended,
:revdate: 2023-09-21
