...
= Software Channels
:description: Manage software channels on your current Server or Client by changing the base channel subscription and configuring associated Child Channels.
:revdate: 2023-09-18
