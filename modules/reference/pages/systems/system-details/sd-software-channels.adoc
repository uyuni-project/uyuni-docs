...
= Software Channels
:description: Configure and manage software channels on the current client by selecting a new base channel, scheduling changes, reviewing associated child channels,
:revdate: 2023-09-18
