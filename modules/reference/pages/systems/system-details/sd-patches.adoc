...
= Patches
:description: Learn how to effectively manage and apply patches from a centralized location, schedule installations, and track installation status across multiple clients
:revdate: 2020-09-11
