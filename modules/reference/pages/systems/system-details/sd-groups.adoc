...
= Groups
:description: Learn how to manage client system groups, assignments, and subscriptions by navigating the YaST menu, where you can view assigned groups, remove unwanted
:revdate: 2020-09-11
