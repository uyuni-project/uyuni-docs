...
= Configuration
:description: Configure and manage configuration files for selected clients across both centrally and locally managed channels. Deploy, compare, or subscribe
:revdate: 2020-10-27
