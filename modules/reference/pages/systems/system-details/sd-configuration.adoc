...
= Configuration
:description: Configure client configurations using menu options like the Configuration Overview section, where available configuration files and channel subscriptions are
:revdate: 2026-04-20
...
The page shows a list of all available configuration files.
