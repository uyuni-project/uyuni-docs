...
= Packages
:description: Manage packages on a Client by refreshing the list of available packages and selecting actions to install, upgrade, remove, or compare package installations.
:revdate: 2024-02-13
