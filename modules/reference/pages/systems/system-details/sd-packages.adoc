...
= Packages
:description: Manage packages on a selected client through various subtabs, including List/Remove to uninstall outdated packages, Upgrade to apply new versions, Install
:revdate: 2024-02-13
