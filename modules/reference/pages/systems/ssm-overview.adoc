...
:description: Configure clients in your SUSE Manager system with an overview of features such as client management, patch management, package management, system groups
:revdate: 2021-06-16
