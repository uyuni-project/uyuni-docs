[[ref-systems-list]]
= Systems List
:description: View a comprehensive list of all clients within your SUSE Manager environment, including physical and virtual systems, updates, and other details
:revdate: 2022-11-07
