[[ref-systems-list]]
= Systems List
:description: This page serves as a starting point for accessing various Client management features, including viewing clients by system type, status, and other attributes.
:revdate: 2025-05-20
