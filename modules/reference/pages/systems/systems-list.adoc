[[ref-systems-list]]
= Systems List
:description: Explore your SUSE Manager environment by viewing clients listed in the Systems List section, including their status, updates, and system details, which enables
:revdate: 2024-08-19
