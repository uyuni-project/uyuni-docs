[[ref-systems-keys]]
= Activation Keys
:description: Learn how to manage and track multiple activation keys for your organizations clients by listing, enabling, and monitoring their usage in the Systems Activation
:revdate: 2020-09-11
