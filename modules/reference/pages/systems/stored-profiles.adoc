...
= Stored Profiles
:description: Learn how to manage stored profiles for your organization and compare installed packages across clients with these customizable comparison tools
:revdate: 2020-09-11
