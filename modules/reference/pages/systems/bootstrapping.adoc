...
= Bootstrapping
:description: Configure Salt clients with specific registration options, including SSH authentication and activation keys, and then register them accordingly
:revdate: 2020-09-11
