...
The menu:Systems[] menu contains submenu entries in the left navigation bar and as its overview page displays menu:Systems[System List > All] listing all client systems registered to the {productname} Server.
...
* [guimenu]``System List``
* [guimenu]``System Groups``
* [guimenu]``System Set Manager``
* [guimenu]``Bootstrapping``
* [guimenu]``Proxy Configuration``
* [guimenu]``Advanced Search``
* [guimenu]``Activation Keys``
* [guimenu]``Stored Profiles``
* [guimenu]``Custom System Info``
* [guimenu]``Autoinstallation``
* [guimenu]``Virtual Host Managers``
