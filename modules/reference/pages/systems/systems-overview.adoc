...
= Systems Overview
:description: View a comprehensive list of all registered systems on your SUSE Manager Server, including available updates and subscription details
:revdate: 2023-07-03
...
* image:fa-rocket.svg[Rocket,scaledwidth=1.6em] -- System is being deployed using {ay} or Kickstart.
