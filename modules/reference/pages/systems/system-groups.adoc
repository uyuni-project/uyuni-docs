[[ref-systems-groups]]
= System Groups
:description: Learn how to manage and monitor system groups for your organization, including updating client statuses and accessing detailed update information
:revdate: 2023-08-23
