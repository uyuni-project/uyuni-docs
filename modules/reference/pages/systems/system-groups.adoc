[[ref-systems-groups]]
= System Groups
:description: Navigate the list to configure and manage your organizations system groups, add or delete clients, view update status icons, and resolve necessary actions
:revdate: 2023-08-23
