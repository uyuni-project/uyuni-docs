...
= OpenSCAP Menu
:description: Learn how to configure and interpret OpenSCAP scan results in SUSE Manager, which implements SCAP standards through automated compliance checks
:revdate: 2022-08-18
