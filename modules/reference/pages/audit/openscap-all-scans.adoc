[[ref-audit-all-scans]]
= All Scans
:description: Learn how to configure and interpret OpenSCAP scan results on clients by understanding the Security Content Automation Protocol and analyzing detailed
:revdate: 2022-08-18
