...
= filepreservation
:description: Configure and manage kickstart file preservation lists using spacecmd commands to create, delete, display, and list details of all existing file preservations
:revdate: 2021-08-10
