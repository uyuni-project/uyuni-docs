[[ref-spacecmd-help]]
= help
:description: Review the original sentence to identify areas for improvement The sentence is a single, complete thought that conveys the idea of learning about spacecmd
:revdate: 2021-02-15
