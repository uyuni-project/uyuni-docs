[[ref-spacecmd-help]]
= help
:description: Learn about navigating and utilizing spacecmd commands using the help function, which includes detailed explanations for each command, such as usercreate
:revdate: 2021-02-15
