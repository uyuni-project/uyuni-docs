[[ref-spacecmd-help]]
= help
:description: Learn how to manage and maintain your system with YaST tools that include activation key management, package list manipulation, software channel configuration
:revdate: 2021-02-15
