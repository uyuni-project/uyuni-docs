...
= distribution
:description: Learn how to create, delete, and manage Kickstart distributions using spacecmd commands for various Linux distributions, including Fedora, RHEL, SUSE,
:revdate: 2021-08-10
