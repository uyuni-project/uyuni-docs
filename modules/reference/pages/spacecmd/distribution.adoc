...
= distribution
:description: Learn how to manage Kickstart trees using spacecmd commands for creating, deleting, listing, renaming, and updating autoinstall distributions on your Server.
:revdate: 2021-08-10
