...
= distribution
:description: Configure Kickstart distributions using spacecmd commands to create, delete, list, rename, and update trees for various operating system installations
:revdate: 2021-08-10
