[[ref-spacecmd-org]]
= org
:description: Here is the corrected sentence Learn to configure and manage organizations with a range of spacecmd functions such as adding trusts, creating, deleting
:revdate: 2022-05-02
