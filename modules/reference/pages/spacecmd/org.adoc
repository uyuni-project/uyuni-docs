[[ref-spacecmd-org]]
= org
:description: Manage organizations using spacecmd functions, such as adding and removing trusts, creating and deleting organizations, listing users and trusts, and modifying
:revdate: 2022-05-02
