[[ref-spacecmd-org]]
= org
:description: Learn about managing organizations using spacecmd functions, which include adding trusts, creating/deleting organizations, listing users, and displaying trusts
:revdate: 2022-05-02
