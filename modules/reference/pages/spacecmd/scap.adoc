[[ref-spacecmd-scap]]
= scap
:description: Learn how to manage and schedule OpenSCAP scans with spacecmd functions, including retrieving scan details, listing rule results, viewing completed scans,
:revdate: 2023-06-21
