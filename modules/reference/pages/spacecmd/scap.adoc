[[ref-spacecmd-scap]]
= scap
:description: Learn how to manage and automate OpenSCAP scans using spacecmd functions, which provide detailed scan results, allow scheduling of new scans with customized
:revdate: 2023-06-21
