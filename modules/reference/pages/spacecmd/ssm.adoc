[[ref-spacecmd-ssm]]
= ssm
:description: The SSM allows adding systems for efficient management and maintenance through various methods including name, search query, group, or channel specifications.
:revdate: 2023-06-21
