[[ref-spacecmd-ssm]]
= ssm
:description: Learn to effectively manage your systems using the spacecmd functions of the System Set Manager (SSM), which includes adding, removing, and replacing systems
:revdate: 2023-06-21
