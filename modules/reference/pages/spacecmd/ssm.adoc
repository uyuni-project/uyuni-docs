[[ref-spacecmd-ssm]]
= ssm
:description: Learn how to manage systems using the system set manager tool, which includes features for adding, removing, and listing systems across various formats
:revdate: 2023-06-21
