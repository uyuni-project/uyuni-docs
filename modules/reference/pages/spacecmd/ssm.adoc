[[ref-spacecmd-ssm]]
= ssm
:description: Learn how to manage your Server's system set with spacecmd functions such as adding, clearing, intersecting, listing, and removing systems from the SSM.
:revdate: 2023-06-21
