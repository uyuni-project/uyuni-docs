[[ref-spacecmd-system]]
= system
:description: Learn about system management using spacecmd functions, which include adding channels, configuring files, managing entitlements, and other tasks
:revdate: 2025-03-18
