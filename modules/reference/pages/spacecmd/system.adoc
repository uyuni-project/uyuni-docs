[[ref-spacecmd-system]]
= system
:description: Learn about managing systems with spacecmd functions that support adding child channels, configuring channels, creating configuration files, setting custom
:revdate: 2025-03-18
