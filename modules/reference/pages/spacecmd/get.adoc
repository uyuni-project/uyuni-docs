[[ref-spacecmd-get]]
= get
:description: Learn about managing your SUSE system using various spacecmd commands, such as displaying API versions, entitlement certificates, and server information
:revdate: 2024-11-29
