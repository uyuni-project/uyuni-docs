[[ref-spacecmd-group]]
= group
:description: Learn how to manage and maintain system groups effectively through various commands including adding, backing up, creating, deleting, displaying details
:revdate: 2021-08-10
