[[ref-spacecmd-group]]
= group
:description: Learn how to manage and organize system groups, including adding and removing systems, backing up, creating, deleting, listing, and restoring groups.
:revdate: 2021-08-10
