...
= softwarechannel
:description: Learn how to manage and manipulate software channels using the spacecmd tools various functions, including patch addition, cloning, creation, and deletion
:revdate: 2023-06-21
