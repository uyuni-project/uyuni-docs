...
:description: Learn how to troubleshoot common issues with spacecmd by accessing solutions and workarounds for problems with server names, kernel options, and command-line
:revdate: 2022-05-31
...
Situation::
When creating a distribution with spacecmd it will  automatically set [literal]``localhost`` as the server name instead of the FQDN of SUSE Manager.
