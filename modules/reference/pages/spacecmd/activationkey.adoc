...
= activationkey
:description: Learn how to manage and customize your organizations activation keys using spacecmd commands for adding child channels, configuration channels, entitlements
:revdate: 2023-11-29
