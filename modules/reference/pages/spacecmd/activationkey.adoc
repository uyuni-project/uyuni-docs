...
= activationkey
:description: Configure and manage activation keys using spacecmd commands to add child channels, configuration channels, and entitlements, clone existing keys, create new
:revdate: 2024-04-24
