[[ref-spacecmd-report]]
= report
:description: Configure and manage various reports using spacecmd functions such as listing duplicate system profiles, errata, inactive systems, network information, running
:revdate: 2023-06-21
