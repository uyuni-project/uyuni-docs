[[ref-spacecmd-report]]
= report
:description: A starting point for accessing spacecmd functions related to reporting, including listing duplicate system profiles and out-of-date systems.
:revdate: 2023-06-21
