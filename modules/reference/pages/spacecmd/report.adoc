[[ref-spacecmd-report]]
= report
:description: Configure and manage your SUSE systems using various spacecmd functions to list reports, errata, inactive systems, hostnames, IP addresses, running kernels,
:revdate: 2023-06-21
