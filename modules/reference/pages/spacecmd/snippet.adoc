...
= snippet
:description: Learn how to manage and customize Kickstart snippets with the spacecmd functions, which include creating, deleting, updating, listing, and showing details
:revdate: 2023-06-21
