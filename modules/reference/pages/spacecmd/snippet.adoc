...
= snippet
:description: An overview of spacecmd functions for managing Kickstart snippets, allowing administrators to create, delete, show details, list, and update snippets.
:revdate: 2023-06-21
