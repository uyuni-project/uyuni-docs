...
:description: Configure and optimize your spacecmd experience by creating a credentials file that securely authenticates with your SUSE Manager server
:revdate: 2024-06-24
...
.Procedure: Creating a [literal]``spacecmd`` credentials file
[role=procedure]
____
