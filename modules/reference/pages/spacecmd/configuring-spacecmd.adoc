...
:description: Configure a config file in the Server's hidden spacecmd directory to store spacecmd credentials, avoiding interactive shell login prompts on the Client.
:revdate: 2024-06-24
