...
:description: Learn how to configure spacecmd using a credentials file to securely connect to your SUSE Manager server without being prompted for username and password
:revdate: 2022-06-01
