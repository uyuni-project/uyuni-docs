[[ref-spacecmd-api]]
= api
:description: Configure and access the latest features in SUSE Manager using spacecmd API commands from the command line, either directly or through scripts
:revdate: 2023-06-21
