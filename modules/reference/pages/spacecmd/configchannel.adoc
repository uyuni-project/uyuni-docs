...
= configchannel
:description: Learn how to manage and manipulate configuration channels using a variety of spacecmd commands that enable tasks such as creating, cloning, backing up
:revdate: 2021-08-10
