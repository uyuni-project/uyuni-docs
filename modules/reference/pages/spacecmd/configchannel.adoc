...
= configchannel
:description: Configure configuration channels using spacecmd commands to create, backup, clone, delete, list, and synchronize configuration files across systems
:revdate: 2021-08-10
