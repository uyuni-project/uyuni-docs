...
= configchannel
:description: Learn how to manage configuration channels using spacecmd commands for tasks like creating and deleting channels, adding or removing files, listing all files
:revdate: 2021-08-10
