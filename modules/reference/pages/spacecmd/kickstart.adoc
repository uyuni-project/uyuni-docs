...
= kickstart
:description: Learn how to manage and configure Kickstart profiles using spacecmd functions, which include adding activation keys, packages, scripts, and variables, modifying
:revdate: 2023-07-03
