[[ref-spacecmd-errata]]
= errata
:description: Configure affected systems using the spacecmd commands, which offer a range of functions for applying patches, deleting existing patches, showing patch details
:revdate: 2021-08-10
