[[ref-spacecmd-user]]
= user
:description: Learn how to manage users by adding default groups, creating new ones, assigning available roles, and modifying details like email addresses and passwords
:revdate: 2023-06-21
