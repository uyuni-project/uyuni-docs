...
:description: Learn how to customize and test packages in the Content Lifecycle section, selecting software channels as sources, adjusting them for your environment,
:revdate: 2020-09-11
