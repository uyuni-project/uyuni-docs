...
= Maintenance Windows
:description: Learn how to manage maintenance window schedules in YaST tools by uploading calendar files, assigning them to clients, and restricting actions during specified
:revdate: 2020-09-11
