...
= Pending Actions
:description: To keep your system organized, cancel pending actions by checking them and clicking Cancel Actions, or archive them to move to Archived Actions.
:revdate: 2020-09-11
