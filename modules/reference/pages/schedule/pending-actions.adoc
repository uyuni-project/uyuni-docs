...
= Pending Actions
:description: Learn how to manage and cancel pending actions in SUSE Linux, including filtering by action type and viewing detailed status reports
:revdate: 2020-09-11
