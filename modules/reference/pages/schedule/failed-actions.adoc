[[ref-schedule-failed-actions]]
= Failed Actions
:description: Configure and manage failed actions for clarity on their unsuccessful completion, archiving or rescheduling as needed
:revdate: 2025-06-23
