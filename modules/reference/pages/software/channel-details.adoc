...
= Channel Details
:description: Access detailed channel information, user management settings, patch updates, package lists, subscribed and target systems, and the AppStream module stream
:revdate: 2021-09-21
