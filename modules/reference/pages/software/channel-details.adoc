...
= Channel Details
:description: Manage channels in SUSE Manager with access to detailed channel information, user management options, patch and package lists, and subscription settings
:revdate: 2021-09-21
