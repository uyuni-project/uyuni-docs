...
= Channel Details
:description: This page serves as a starting point for accessing details about software channels, including managers, patches, packages, subscribed systems, target systems.
:revdate: 2021-09-21
