...
= Manage Repositories
:description: The menu's Manage Repositories section allows you to manage custom or third-party package repositories and link them to an existing channel.
:revdate: 2020-09-11
