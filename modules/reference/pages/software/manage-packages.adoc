...
= Manage Packages
:description: Manage your organizations packages efficiently using the Software menu section, including deleting orphaned packages and synchronizing with SUSE Manager
:revdate: 2024-10-07
