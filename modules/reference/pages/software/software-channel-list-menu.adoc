...
= Channel List Menu
:description: Learn how to effectively manage and configure your organizations software channels by viewing detailed lists of available channels, filtering through options
:revdate: 2020-09-11
