...
:description: Learn how to configure and manage distribution channel mappings to automatically assign clients to default software channels based on their architecture
:revdate: 2020-09-11
