...
:description: Configure distribution channel mappings to automatically assign clients to default base channels based on their architecture and operating system.
:revdate: 2020-09-11
