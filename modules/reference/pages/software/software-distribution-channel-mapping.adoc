...
:description: Learn how to define default base channels for clients and configure distribution channel mappings according to Client architecture and operating system.
:revdate: 2020-09-11
