[[ref-admin-bootstrap]]
= Bootstrap Script
:description: Configure the YaST tools to generate a custom bootstrap script that registers clients with SUSE Manager, specifying server hostname and other settings
:revdate: 2020-09-11
