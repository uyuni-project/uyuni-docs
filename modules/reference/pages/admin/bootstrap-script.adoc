[[ref-admin-bootstrap]]
= Bootstrap Script
:description: Learn about generating a custom bootstrap script for client registration with SUSE Manager, which involves configuring settings like server hostname and SSL
:revdate: 2024-02-08
