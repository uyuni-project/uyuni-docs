[[ref-admin-bootstrap]]
= Bootstrap Script
:description: To register clients with MLM, you need to configure a custom bootstrap script on your Server and provide specific options for Client configuration.
:revdate: 2024-02-08
