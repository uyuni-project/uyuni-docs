[[ref-admin-general]]
= General
:description: The Server's general settings can be configured on the Admin Manager Configuration page under General, including administrator email address and HTTP Proxy.
:revdate: 2024-11-29
