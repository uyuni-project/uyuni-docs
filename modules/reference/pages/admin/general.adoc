[[ref-admin-general]]
= General
:description: Configure your SUSE Manager installation settings using the General Admin pages configuration options for optimal server performance and security
:revdate: 2024-11-29
