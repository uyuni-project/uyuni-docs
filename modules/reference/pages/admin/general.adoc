[[ref-admin-general]]
= General
:description: Configure your SUSE Manager installation by setting options including administrator email address and HTTP proxy settings in the Admin Manager Configuration
:revdate: 2020-09-11
