[[ref-admin-iss-slave]]
= ISS Slave Setup
:description: Configure an inter-server synchronization slave by adding a new master with its fully qualified domain name (FQDN) and certificate authority (CA) certificate
:revdate: 2020-09-11
