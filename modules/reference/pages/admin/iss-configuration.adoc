[[ref-admin-iss]]
= ISS Configuration
:description: Configure inter-server synchronization between two or more SUSE Manager servers, where one is designated the master and others are slaves, to establish a
:revdate: 2020-09-11
