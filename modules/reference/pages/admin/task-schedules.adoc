[[ref-admin-schedules]]
= Task Schedules
:description: The Task Schedules page lists all predefined task bunches and their frequencies, allowing administrators to manage and modify them as needed.
:revdate: 2025-06-16
