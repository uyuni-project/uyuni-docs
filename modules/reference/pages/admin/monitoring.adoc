...
= Monitoring
:description: Learn how to configure and enable SUSE Manager monitoring by using YaST tools from the Admin menu, which also includes detailed setup instructions
:revdate: 2020-09-11
