...
= Relevant Patches
:description: Configure relevant patches for your SUSE clients by accessing a list of all applicable patches from SUSE, including patch types, advisory numbers, descriptions
:revdate: 2025-01-20
