[[ref-patches-all]]
= All Patches
:description: Heres the corrected sentence Learn how to manage and prioritize patches for your clients from this comprehensive list of all available patches
:revdate: 2025-01-20
