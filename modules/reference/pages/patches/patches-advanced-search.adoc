...
:description: Learn how to effectively use advanced criteria in the Patches[Advanced Search] section to search for patches by various fields and types, including different
:revdate: 2020-09-11
