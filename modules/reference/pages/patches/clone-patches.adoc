[[ref-patches-clone]]
= Clone Patches
:description: Learn how to create copies of existing patches for distribution by cloning them from your software channels, ensuring they remain up-to-date
:revdate: 2020-09-11
