[[ref-home-prefs]]
= My Preferences
:description: Configure SUSE Multi-Linux Manager Web UI options and customize settings for email notifications, timezone, and interface language on the My Preferences page
:revdate: 2024-05-10
