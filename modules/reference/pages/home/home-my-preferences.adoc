[[ref-home-prefs]]
= My Preferences
:description: Configure various options in the My Preferences section, such as email notifications, list page size, and interface settings, to customize your experience
:revdate: 2022-01-03
