[[ref-spacecmd]]
= spacecmd Reference
:description: Learn to manage SUSE Manager from the command line using spacecmd, which offers advanced search methods and complete functionality through the Spacewalk API
:revdate: 2024-11-29
