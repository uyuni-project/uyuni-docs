[[ref-spacecmd]]
= spacecmd Reference
:description: Learn how to manage most aspects of SUSE Manager remotely with spacecmds advanced command-line interface and XML-RPC API, facilitating efficient system
:revdate: 2020-09-11
