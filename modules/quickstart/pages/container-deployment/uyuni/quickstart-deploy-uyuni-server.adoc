...
However, for the purpose of this guide, we've chosen to focus on setting up a KVM environment, installed on either {opensuse} {leap} or {opensuse} {tumbleweed}, as the initial step.
