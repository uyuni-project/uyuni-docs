...
== Acquire the {leapmicro} {microversion} Image

. Proceed to: link:https://download.opensuse.org/distribution/leap-micro/5.5/product/iso/[Download {leapmicro} {microversion}]
