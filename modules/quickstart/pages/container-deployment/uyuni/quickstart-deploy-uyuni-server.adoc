...
== [Step 6:] Update the system and Install Container tools
...
. Once complete open a browser and visit link:https://leapmicro.container.lab[] to begin working with {productname}.
