...
== Troubleshooting with Duplicated Repository URLs

// https://github.com/SUSE/spacewalk/issues/12008

If you want to add two or more repositories with the same URL (client tools for openSUSE Leap 15.0, 15.1, and 15.2) in {productname} with [command]``spacewalk-common-channels``, you will see an error such as:
...
If you unfold the [systemitem]``openSUSE Leap 15.2 (x86_64)`` channel, you will see all child channels populated with packages.
