[[proxy-uyuni-upgrade]]
= Proxy - Upgrade Procedure from 2021.05 to 2021.08
...
[NOTE]
====
The upgrade from 2021.05 to 2021.08 includes the operating system upgrade from {opensuse} Leap 15.2 to 15.3.
====
