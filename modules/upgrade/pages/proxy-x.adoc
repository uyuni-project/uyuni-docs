...
{productname} Proxy can be upgraded from one major version to the next in some cases.
...
For more information about upgrading from 4.1 to 4.2, see xref:upgrade:proxy-y-z.adoc[].

The upgrade process from 3.2 to 4.1 is automated, but you will need to do some preparation steps before you can upgrade.
