...
//OM: make this instruction generic and remove the old upgrade document:
//OM If you are using an older version, such as version 9.6, see xref:upgrade:db-migration-10.adoc[].
If you are using an older version, such as version 9.6, see https://documentation.suse.com/external-tree/en-us/suma/4.1/suse-manager/upgrade/db-migration-10.html.
