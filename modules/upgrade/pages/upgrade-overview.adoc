...
If you are updating a {productname} Proxy, see xref:proxy-intro.adoc[].

If you are updating clients, see xref:client-intro.adoc[].

In addition to updating the server, you need to update other underlying technologies, including the database.
For more information about updating the database, see xref:db-intro.adoc[].
