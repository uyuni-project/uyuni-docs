...
* It is possible to target directly the underlying XMLRPC API of the Hub server, given that the HUB XMLRPC API exposes all the methods that are available on a {productname} Server XMLRPC API.
