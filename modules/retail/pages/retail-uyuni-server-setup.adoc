...
:description: Learn how to set up and configure SUSE Manager for Retail Server using YaST tools, then establish a secure administration account
:revdate: 2025-02-26
...
. Type your certificate information and provide a password.
  ...
  You must have the cericate password to set up the {productname} Proxy.
+
