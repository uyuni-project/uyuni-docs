...
// client-configuration/pages/snippets/add_channels_cli.adoc

include::ROOT:_partials:snippets/add_channels_cli.adoc[]

include::ROOT:partials:snippets/add_channels_cli.adoc[]


== Check Synchronization Status

include::ROOT:partials:snippets/check_sync_webui_uyuni.adoc[]

include::ROOT:partials:snippets/check_sync_cli.adoc[]
