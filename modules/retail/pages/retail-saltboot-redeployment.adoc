...
:description: Learn how to force Saltboot image redeployment or disk repartition on SUSE Manager systems using API calls, custom info keys, or Salt states for immediate
:revdate: 2023-07-27
