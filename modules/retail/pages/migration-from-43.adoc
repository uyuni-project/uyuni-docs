...
This guide describes how to migrate one or more {productbranch} Servers from {susemgr} Branch Server 4.3 to the {productbranch} 5.1
...
There are multiple ways to initiate {productbranch} 4.3 migration:
