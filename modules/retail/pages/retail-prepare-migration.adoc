...
= Before You Migrate
:description: Migrate SUSE Linux Enterprise Point of Service or older SUSE Manager for Retail installations to the latest version of SUSE Manager for Retail through a guided
:revdate: 2021-01-19
