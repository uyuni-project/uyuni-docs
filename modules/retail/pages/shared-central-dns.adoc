...
:description: To set up a Retail with shared network, create system groups for terminals, hardware types, and branches, and assign formulas to configure PXE, TFTP,.
:revdate: 2024-06-05
