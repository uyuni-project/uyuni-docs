...
You can use branch servers in several different network configurations, depending on your installation requirements.
...
image::retail_external_network.png[scaledwidth=80%]
