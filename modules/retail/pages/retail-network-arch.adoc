...
=== Centrally Provided Network


External DHCP server used for PXE booting.
External DNS resolves required CNAMEs for Saltboot.


image::retail_central_network.png[scaledwidth=80%]
