...
For technical background information on {smr} Branch Servers, see also the documentation on {productname} Proxy servers (xref:installation:install-proxy-unified.adoc[]).
endif::[]

ifeval::[{uyuni-content} == true]
{smr} Branch Servers are implemented as enhanced {productname} Proxies.
For technical background information on {smr} Branch Servers, see also the documentation on {productname} Proxy servers (xref:installation:install-proxy-uyuni.adoc[]).
endif::[]
