...
= Terminal Names
:description: Configure terminal names according to various parameters including hostname, FQDN, HW Type, and MAC to match physical devices with their records in the SUSE
:revdate: 2025-01-15
