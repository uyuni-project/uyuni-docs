...
:description: Learn how to configure your Retail Branch Server and Client terminals for successful MLM software channel addition, synchronization, and activation.
:revdate: 2025-06-24
