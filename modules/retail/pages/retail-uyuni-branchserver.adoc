...
:description: To learn how to install and set up SUSE Manager for Retail Branch Server, follow these steps Add Software Channels, Check Synchronization Status, Trust GPG Keys
:revdate: 2025-02-26
...
ifndef::backend-pdf[]
include::client-configuration:partial$add_channels_cli.adoc[]
endif::[]

ifdef::backend-pdf[]
include::../../client-configuration/partials/add_channels_cli.adoc[]
endif::[]
