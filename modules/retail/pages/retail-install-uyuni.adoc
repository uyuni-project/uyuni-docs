...
:description: Learn how to successfully install Uyuni Retail Server on openSUSE by configuring a resolvable fully qualified domain name, setting up variables for repository
:revdate: 2025-02-26
