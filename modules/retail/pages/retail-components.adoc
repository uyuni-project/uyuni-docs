[[retail-components]]
= Components
:description: Configure your retail environment using SUSE Multi-Linux Manager for Retail, a customized solution that simplifies device management by combining hardware
:revdate: 2023-12-13
