[[retail-components]]
= Components
:description: Learn about managing retail environments with SUSE Manager for Retail, a platform that streamlines device management using Salt formulas and hardware types
:revdate: 2023-12-19
