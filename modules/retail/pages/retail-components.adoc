[[retail-components]]
= Components
:description: The Server contains infrastructure, network topology, and automation tools for managing branches and terminals across various Client OS systems.
:revdate: 2023-12-13
