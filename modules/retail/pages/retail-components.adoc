[[retail-components]]
= Components
:description: Configure and manage SUSE Manager for Retail components such as servers, build hosts, branch servers, point-of-sale terminals, and hardware types
:revdate: 2023-12-13
