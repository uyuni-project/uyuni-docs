...
= Deployment basics
:description: To successfully deploy point-of-service terminals, create hardware type groups that reflect their specific architecture and configuration requirements.
:revdate: 2024-06-05
