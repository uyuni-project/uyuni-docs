...
= Deployment basics
:description: Deploy point-of-service terminals using the following steps create hardware type groups and assign Saltboot formulas in the SUSE Manager Server
:revdate: 2023-07-25
