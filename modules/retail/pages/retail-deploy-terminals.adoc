...
= Deployment basics
:description: Learn how to deploy point-of-service terminals by creating hardware type groups, assigning Saltboot formulas, and synchronizing images with the SUSE Manager
:revdate: 2024-06-05
