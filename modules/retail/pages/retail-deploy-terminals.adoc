...
For other methods of booting terminals, including using a UWSB device, or booting over a wireless network, see xref:retail:retail-deploy-terminals-other.adoc[].
