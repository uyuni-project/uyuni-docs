...
= Retail Guide
:description: Use Retail Guide to streamline installation, configuration, and software updates across your Retail's servers, workstations, and POS terminals.
:revdate: 2025-05-21
