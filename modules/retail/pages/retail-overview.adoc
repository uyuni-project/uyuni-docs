...
[[retail-overview]]
= Retail Guide
:description: Configure your retail infrastructure with SUSE Manager for Retail, a comprehensive solution for point-of-service terminals and connected devices
:revdate: 2025-03-28
