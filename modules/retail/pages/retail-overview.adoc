...
:description: Learn to configure and manage point-of-service terminals, servers, and other devices in retail environments with this open-source infrastructure management
:revdate: 2023-02-24
