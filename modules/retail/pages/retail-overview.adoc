...
[[retail-overview]]
= Retail Guide
:description: Learn how to manage complex retail environments efficiently with SUSE Multi-Linux Manager for Retail 5.1, an open-source infrastructure solution optimized
:revdate: 2025-05-21
