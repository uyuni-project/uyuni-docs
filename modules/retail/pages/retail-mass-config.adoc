[[retail.mass.config]]
= Mass Configuration
:description: Here is a concise meta description Configure multiple branch or terminal systems automatically with a pre-defined YAML file, simplifying infrastructure setup.
:revdate: 2025-02-06
