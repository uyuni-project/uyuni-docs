...
= Best practices
:description: Learn how to deploy a new image on selected terminals first, test it in a controlled environment, and then configure hardware type groups to roll it out to all
:revdate: 2023-12-13
