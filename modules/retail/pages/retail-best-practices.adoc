...
= Best practices
:description: Configure a new image on selected terminals, test its performance, then deploy it to all terminals using flexible group configurations and Saltboot formula
:revdate: 2023-12-19
