...
:description: Configure a live USB image for deploying terminals by booting from a removable USB storage device, which offers an alternative to network booting with YaST
:revdate: 2023-07-25
