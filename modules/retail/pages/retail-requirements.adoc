[[retail-requirements]]
= Retail Requirements
:description: Learn how to configure and install SUSE Manager for Retail, meeting the minimum system requirements and ensuring a reliable network connection
:revdate: 2022-01-11
