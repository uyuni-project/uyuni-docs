...
:description: Learn how to configure a SUSE Manager for Retail in a dedicated network for POS terminals, and discover two configuration methods that achieve the same result
:revdate: 2025-06-06
