[[retail-install]]
= Retail Installation
:description: Learn how to configure and deploy a comprehensive retail management solution with SUSE Linux Enterprise Server Unified Installer, including step-by-step
:revdate: 2022-08-09
