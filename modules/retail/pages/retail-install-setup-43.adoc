...
:description: Configure and set up your SUSE Manager for Retail environment by preparing POS images, configuring services, and synchronizing images with branch servers
:revdate: 2024-06-05
