...
= Image Pillars
:description: Learn how to configure and manage image pillars in Salt, including generating and accessing details about built images such as location, checksums, network boot
:revdate: 2023-08-02
