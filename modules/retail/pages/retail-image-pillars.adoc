...
= Image Pillars
:description: Learn how to configure and manage image pillars for Salt subsystem access, which includes details about image locations, checksums, network boot information
:revdate: 2023-08-02
