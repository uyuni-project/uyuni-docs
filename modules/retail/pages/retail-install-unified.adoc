...
:description: Follow these steps to learn how to install SUSE Manager for Retail from SUSE Linux Enterprise Server installation media
:revdate: 2024-10-29
...
The supported way is going forward is VM based install.
====
