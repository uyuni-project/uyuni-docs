= Copyright Notice
:description: makes available GPL-licensed source code corresponding to certain software components for download at https www..com download-linux source-code.html.
:revdate: 2025-04-24
