= Copyright Notice
:description: Here is the corrected sentence The modular operating system and its accompanying components are governed by separate license terms, which are collectively
:revdate: 2024-04-30
