...
ifdef::backend-pdf[]
= THIS IS ALL-IN SUMA AND UYUNI DOCUMENT WHICH SHOULD STAY Quick Start - {productname} {productnumber}
...
* xref:quickstart-install-overview.adoc[Quick Start: SUSE Manager]
...
* xref:quickstart-install-overview.adoc[Quick Start: Uyuni]
