...
| {oracle}{nbsp}6 | {x86}     | icon:check[role="green"] | icon:check[role="green"]
| {oracle}{nbsp}7 | {x86}     | icon:check[role="green"] | icon:check[role="green"]
| {oracle}{nbsp}8 | {x86}     | icon:times[role="danger"] | icon:check[role="green"]
| {opensuse} Leap 15 | {x86}_64                       | icon:times[role="danger"]      | icon:check[role="green"]
