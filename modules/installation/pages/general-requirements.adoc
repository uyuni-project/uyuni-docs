...
In order to use the {webui} to manage your {susemgr} environment, you need to ensure you are running an up to date web browser.
...
The {productname} {webui} does not render correctly under Windows Internet Explorer.
