...
Without this password it is not possible to set up a {productname} Proxy Server.
====
...
Before you can synchronize software repositories with SCC, you need to enter organization credentials in {susemgr}.
