...
Re-install the Proxy if you want to switch to Salt. Do not remove the old proxy from the list of
registered systems and use the same activation key when reinstalling, so that you won't need to
