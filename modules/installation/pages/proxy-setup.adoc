...
The [command]``configure-proxy.sh`` script will finalize the setup of your {productname} Proxy.
...
. Shut down the proxy.
. Install a new {productname} Proxy{nbsp}{productnumber}, following xref:install-proxy-unified.adoc[Proxy Installation].
