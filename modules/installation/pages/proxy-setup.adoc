...
You can also re-register a proxy to change it from a traditional proxy to a Salt proxy.
...
You can also use re-registration to switch a traditional proxy to a Salt proxy.
In this method, instead of a reactivation key, use the same activation key you used to register the proxy in the first instance.
