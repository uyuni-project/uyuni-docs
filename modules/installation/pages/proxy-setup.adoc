...
If you need to distribute big files such as ISO images to your network through the proxy. On the PROXY_HOSTNAME system, copy the big files to the /srv/www/htdocs/pub directory.


Then, files can be downloaded from http://PROXY_HOSTNAME/pub.
