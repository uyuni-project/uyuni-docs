...
// The content in this page became modules/installation/pages/pubcloud-requirements.adoc and modules/installation/pages/pubcloud-setup.adoc in mid-2019.

You can use {productname} Server and Proxy with the Microsoft Azure public cloud.
This section discusses what you need to run {productname} in Azure, and how to set up your installation.
...
Data on this disk is destroyed after the guest has been switched off.
////
...
You also require three additional data disks:
...
You need to set the DNS zones in Azure before you can configure the {productname} Server.
...
----
// spacecmd is installed by default next time
// ^ How is so?
...
The installation finishes without further input.
////
