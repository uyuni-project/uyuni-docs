...
To install {productname} Proxy, you need to start by installing {sles} media.
...
Before you begin, you need to have created an account with {scc}, and downloaded the {sles} installation media.
