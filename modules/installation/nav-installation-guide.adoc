...
ifeval::[{uyuni-content} == true]
include::modules/installation/pages/uyuni-proxy-registration.adoc[Uyuni Proxy Registration]
include::modules/installation/pages/uyuni-proxy-setup.adoc[Uyuni Proxy Setup]
endif::[]
