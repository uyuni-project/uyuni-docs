...
=== HTML
image:https://github.com/uyuni-project/uyuni-docs/workflows/build_test_deploy_uyuni/badge.svg?branch=master["Build Status", link="https://github.com/uyuni-project/uyuni-docs", 'Build Test Deploy']
