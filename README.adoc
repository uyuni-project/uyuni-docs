...
image:https://github.com/uyuni-project/uyuni-docs/workflows/build_test_deploy/badge.svg?branch=master["Build Status", link="https://github.com/uyuni-project/uyuni-docs"]
image:https://github.com/uyuni-project/uyuni-docs/workflows/feature_tests/badge.svg?branch=master["Build Status", link="https://github.com/uyuni-project/uyuni-docs"]
