= SUSE Manager Documentation Branch
...
image:https://github.com/uyuni-project/uyuni-docs/workflows/build_test_deploy_suma/badge.svg?branch=manager-4.0["Build Status", link="https://github.com/uyuni-project/uyuni-docs/"]
image:https://github.com/uyuni-project/uyuni-docs/workflows/feature_tests_suma/badge.svg?branch=manager-4.0["Build Status", link="https://github.com/uyuni-project/uyuni-docs/"]
