...
. Navigate to the configuration directory. 
  You must create your new configuration file in the path `/etc/apache2/conf.d`, as this folder is persisted.

. Create your new configuration file (for example, `custom_tuning.conf`) and add your required Apache directives.
