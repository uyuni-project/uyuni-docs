...
.. Download the SelfInstall ISO image for the appropriate physical block size (512 or 4096) from suse.com.
   For example: [literal]``SUSE-Manager-Server.ppc64le-5.1-SelfInstall-ppc-4096-2024.12.install.iso``
...
----
.. Apply all available updates using [literal]``transactional-update pkg update``.
