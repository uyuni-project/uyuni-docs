...
= Common workflows
:description: This page shows the most common tasks you can perform when installing, managing, and configuring clients with the system and explains each step clearly
:revdate: 2025-05-21
