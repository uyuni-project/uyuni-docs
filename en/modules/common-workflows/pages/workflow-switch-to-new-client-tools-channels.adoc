...
:description: Switch to new client tools channels after upgrading to version 5.2 or later by synchronizing updated channels and updating activation keys and CLM projects
:revdate: 2026-05-26
...
This change requires some manual steps when upgrading from earlier versions to 5.2 or later.
...
Channels previously named `SUSE Manager Client Tools for XYZ` (with labels such as `manager-tools-*`), used in SUSE Manager 4.3 or 5.0, are no longer available from version 5.2.
