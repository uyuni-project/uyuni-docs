...
:description: Liberate Red Hat Enterprise Linux 8.10 server with secure boot by installing required kernel, grub2, and shim-x64 packages to specific versions
:revdate: 2026-08-31
