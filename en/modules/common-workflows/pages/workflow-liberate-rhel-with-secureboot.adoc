...
:description: Liberate a Red Hat Enterprise Linux 8.10 server with secure boot by installing and updating specific kernel, grub2, and shim-x64 packages to prevent booting.
:revdate: 2026-08-31
...
For a fresh server with secure boot, `shim-x64-15.8-2.el8_10.x86_64` package is installed during liberation.
...
* `grub2-*-2.02-156.el8.1`

* `kernel-4.18.0-553.16.1.el8_10.1`
