...
= Client Onboarding
:description: Onboard a client to your server by setting up the client system, preparing software channels, and using an activation key to bootstrap the client
:revdate: 2025-02-06
