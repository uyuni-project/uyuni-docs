...
[[mcp-server-overview]]
= MCP Server Guide
:description: Configure the MCP Server to connect Model Context Protocol clients and AI assistants to the API and use tools to inspect systems, assess patches, and CVEs
:revdate: 2026-07-29
