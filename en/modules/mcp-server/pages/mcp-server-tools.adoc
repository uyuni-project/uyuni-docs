[[mcp-server-tools]]
= Tool Reference
:description: Find tools exposed by the MCP Server and learn how to use them with their arguments, results, and effects, including how to handle system identifiers.
:revdate: 2026-07-29
