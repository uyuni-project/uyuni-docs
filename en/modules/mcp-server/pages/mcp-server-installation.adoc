...
:description: Install the MCP Server as a client-managed stdio container or standalone HTTP service by following deployment requirements and configuration steps
:revdate: 2026-07-29
