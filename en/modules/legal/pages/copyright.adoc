...
= Copyright Notice
:description: Read the copyright notice to understand the terms under which the software and documentation are licensed, including how to access source code
:revdate: 2025-04-24
