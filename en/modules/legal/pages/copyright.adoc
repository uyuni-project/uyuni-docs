...
= Copyright Notice
:description: The copyright information for the software provides details about the licenses under which it is distributed, including how to access the source code
:revdate: 2025-04-24
