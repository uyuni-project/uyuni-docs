= Trademarks
:description: How to identify and correctly use trademarks related to SUSE and third-party companies and provides information about the legal status and ownership of these
:revdate: 2025-03-27
