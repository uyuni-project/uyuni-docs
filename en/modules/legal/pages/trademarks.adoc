= Trademarks
:description: How to identify and properly use trademarks related to SUSE and third-party companies and provides information about legal status and accuracy
:revdate: 2025-03-27
