...
= Terminal Names
:description: Find out how to name terminals using hostname, FQDN, HWType, or MAC and configure these settings in the Saltboot Group or Branch Network formulas
:revdate: 2025-01-15
