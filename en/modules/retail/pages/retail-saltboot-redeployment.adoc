...
:description: Force redeploy or repartition a Saltboot image when automatic updates do not apply by using Salt grains, custom info values, or API calls to ensure the system
:revdate: 2023-07-27
