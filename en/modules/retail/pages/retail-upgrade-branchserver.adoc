...
:description: Upgrade the Retail Branch Server to the next service pack by following the procedure and applying the highstate after the proxy upgrade completes.
:revdate: 2024-10-04
