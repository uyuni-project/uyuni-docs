[[retail.offline]]
= Offline Use
:description: When the Server is offline, terminals can still be rebooted and updated using cached images stored locally allowing operations to continue even without
:revdate: 2023-07-27
