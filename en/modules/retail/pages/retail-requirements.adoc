[[retail-requirements]]
= Retail Requirements
:description: Check the minimum hardware, network, and system requirements for Retail servers, branch servers, terminals, and secure boot configurations
:revdate: 2025-05-20
...
ifndef::backend-pdf[]
include::retail:partial$snippet-server-hw-requirements.adoc[leveloffset=+1]
endif::[]
...
| Disk Space:              | `/` _(root)_ Minimum 24{nbsp}GB
|                          | `/var/lib/Kiwi` Minimum 15{nbsp}GB
|===
