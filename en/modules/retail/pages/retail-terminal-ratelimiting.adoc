...
:description: Control the rate at which commands are executed across multiple terminals to manage system load and avoid performance issues during operations like rebooting
:revdate: 2023-07-27
