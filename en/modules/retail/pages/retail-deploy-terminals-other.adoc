...
:description: Deploy terminals using a removable USB device when network booting is not possible by creating a live USB image and preparing a bootable device
:revdate: 2023-07-27
