...
----
+
For example: [command]``mgrctl exec -- cobbler buildiso --distro=POS_Image_Graphical7-7.1.0-2:S:1:Organization --profiles=MyBranchGroup:S:1:Organization --iso /root/branchiso.iso``.
+
