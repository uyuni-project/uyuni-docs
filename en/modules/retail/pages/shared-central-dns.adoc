...
:description: Set up the Retail environment with a shared network between terminals, branch servers, and system groups by creating, assigning formulas, and configuring.
:revdate: 2024-06-05
