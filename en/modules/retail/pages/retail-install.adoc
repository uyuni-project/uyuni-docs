[[retail-install]]
= Retail Installation
:description: Install the Retail server and Retail Branch server components from the 5.2 Server and Proxy containers to set up a complete retail installation environment
:revdate: 2025-02-06
