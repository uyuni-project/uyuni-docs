...
:description: Install and set up a Retail Branch Server by adding software channels, checking synchronization status, trusting GPG keys, and registering the server
:revdate: 2025-06-24
