[[retail.mass.config]]
= Mass Configuration
:description: Configure multiple branch servers and terminals using a YAML file to automatically apply settings and formulas across all systems in your infrastructure
:revdate: 2025-02-06
