[[retail.mass.config]]
= Mass Configuration
:description: Configure multiple branch servers and terminals using a predefined YAML file to automatically apply settings and formulas without configuring each system
:revdate: 2025-02-06
