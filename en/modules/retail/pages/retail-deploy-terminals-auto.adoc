...
:description: Deploy terminals and set up auto-accept keys by configuring Saltboot to send signed grains during deployment and setting the server to automatically
:revdate: 2026-04-30
