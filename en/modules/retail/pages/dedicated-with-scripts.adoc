...
:description: Set up the Retail environment with a dedicated network for the terminal using bundled scripts to configure branch server formulas and partitioning
:revdate: 2024-06-05
