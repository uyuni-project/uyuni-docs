...
:description: Create a YAML file with configuration settings for multiple terminals to use with the retail_yaml command for importing settings during mass configuration
:revdate: 2025-02-06
