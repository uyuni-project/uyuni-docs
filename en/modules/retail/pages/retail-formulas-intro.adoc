...
:description: Learn how to use formulas to configure your Retail installation by applying them through the Web UI or API, ensuring correct setup of branch servers
:revdate: 2026-04-29
