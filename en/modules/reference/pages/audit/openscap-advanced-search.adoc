[[ref-audit-search]]
= Advanced Search
:description: Use the Advanced Search section to look for specific results in OpenSCAP scans and find the information you need quickly by filtering scan data.
:revdate: 2020-09-11
