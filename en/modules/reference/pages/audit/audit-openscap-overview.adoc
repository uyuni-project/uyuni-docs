[[ref-audit-openscap]]
= OpenSCAP
:description: Use OpenSCAP to scan clients and check their compliance with security standards by running audits that identify and correct configuration issues
:revdate: 2020-09-11
