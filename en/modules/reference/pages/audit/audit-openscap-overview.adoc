[[ref-audit-openscap]]
= OpenSCAP
:description: Use OpenSCAP to scan clients and check their compliance with security standards by running automated audits that identify configuration issues and ensure
:revdate: 2020-09-11
