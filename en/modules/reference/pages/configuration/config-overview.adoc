...
:description: The Configuration Overview page shows a summary of configuration files managed by your organization, including managed systems and configuration channels.
:revdate: 2025-01-20
