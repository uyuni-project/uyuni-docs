[[ref-config-channels]]
= Channels
:description: Manage configuration channels, deploy files, and configure Salt states using SUSE Multi-Linux Manager
:revdate: 2026-04-20
...
You can remove files or copy the latest versions into other central configuration channels.
