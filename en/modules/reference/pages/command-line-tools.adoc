[[ref-cli]]
= Command Line Tools
:description: Use command line tools to perform actions such as managing package and channel synchronization, bootstrapping, and installing tools through the Web UI
:revdate: 2026-04-29
