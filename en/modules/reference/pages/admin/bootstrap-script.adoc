[[ref-admin-bootstrap]]
= Bootstrap Script
:description: Generate a custom bootstrap script in the Admin[Manager Configuration Bootstrap Script] section to register clients with the server and the script will be
:revdate: 2024-02-08
...
The generated script will be placed in `/srv/www/htdocs/pub/bootstrap/` on your {productname} Server.
