[[ref-admin-bootstrap]]
= Bootstrap Script
:description: Configure a custom bootstrap script in the Admin Managers [Configuration Bootstrap Script] section to register clients with SUSE Multi-Linux Manager
:revdate: 2024-02-08
