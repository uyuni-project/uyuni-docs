...
= Monitoring
:description: Enable monitoring with Prometheus through the Admin[Manager Configuration Monitoring] section to track system performance and identify issues in real time
:revdate: 2020-09-11
