...
Navigate to the `Last Execution Times` tab to see the task list.
Each task shows the time it was last run, and the current status of the task.

Navigate to the `Runtime Status` tab to see all tasks that have run in the past five minutes.
