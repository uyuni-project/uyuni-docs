[[ref-admin-status]]
= Task Engine Status
:description: View the Task Engine Status page to see all running tasks, check the last execution times of each task, and find details about tasks that ran in the past five
:revdate: 2020-09-11
