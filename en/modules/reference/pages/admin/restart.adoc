[[ref-admin-restart]]
= Restart
:description: Use the Restart menu option to restart the server after making configuration changes. This will temporarily make it unavailable until the process completes.
:revdate: 2020-09-11
