[[ref-admin-restart]]
= Restart
:description: Learn how to configure and restart SUSE Multi-Linux Manager successfully through its admin menu options for a seamless transition with minimal downtime
:revdate: 2020-09-11
