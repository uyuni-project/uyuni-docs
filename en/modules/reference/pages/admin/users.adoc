[[ref-admin-users]]
= Users
:description: Configure your organizations user accounts using tools that allow you to view profiles, assign roles, and edit user account details
:revdate: 2022-12-19
...
To change a user's {productname} Administrator role, check or uncheck `{productname} Admin` as required.
