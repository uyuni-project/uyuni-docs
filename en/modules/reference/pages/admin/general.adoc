[[ref-admin-general]]
= General
:description: Configure the general settings on the Admin[Manager Configuration General] page to set up your installation using the bootstrap script options.
:revdate: 2024-11-29
...
| Confirm HTTP Proxy password  | The directory where RPM packages are mirrored. | `/var/spacewalk/`
