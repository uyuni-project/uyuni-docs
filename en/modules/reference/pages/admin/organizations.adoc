[[ref-admin-orgs]]
= Organizations
:description: Manage organizations by creating new ones, editing existing ones, and viewing detailed information about each organization in the Admin[Organizations] section
:revdate: 2020-09-11
