[[ref-salt-keys]]
= Keys
:description: View the key fingerprints of your Salt clients in the Salt[Keys] menu section to verify the identity of the server and clients and ensure secure communication
:revdate: 2020-09-11
