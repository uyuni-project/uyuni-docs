[[ref-salt-keys]]
= Keys
:description: Manage your Salt keys securely, verify client identities, and establish encrypted connections between clients and servers, then review access controls
:revdate: 2020-09-11
