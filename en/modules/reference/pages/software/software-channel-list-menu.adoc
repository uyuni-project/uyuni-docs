...
= Channel List Menu
:description: View and manage software channels and packages on your clients using the Channel List Menu, which displays all available channels with details such as channel
:revdate: 2020-09-11
