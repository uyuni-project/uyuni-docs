...
= Channel List Menu
:description: Configure software channels and packages on clients for viewing a list of all available channels, including those provided by SUSE, popularly subscribed
:revdate: 2020-09-11
