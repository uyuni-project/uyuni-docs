...
= Package Search
:description: Use the Package Search section to look for software packages by entering search terms and selecting options that narrow results based on channels
:revdate: 2020-09-11
