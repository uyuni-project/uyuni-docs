...
= Manage Channels
:description: Manage custom channels by using the Software[Manage Channels] section to create, clone, and configure channels with or without specific patches as needed
:revdate: 2020-09-11
