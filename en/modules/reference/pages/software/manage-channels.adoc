...
= Manage Channels
:description: Manage custom channels by creating new ones, cloning existing ones with or without patches, or selecting specific patches to include in the channel
:revdate: 2020-09-11
