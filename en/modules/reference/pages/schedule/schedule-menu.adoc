[[ref-schedule-menu]]
= Schedule Menu
:description: Use the Schedule Menu to plan and manage tasks such as installing, upgrading, or removing packages, rebooting clients, and applying patches, changing
:revdate: 2021-09-01
