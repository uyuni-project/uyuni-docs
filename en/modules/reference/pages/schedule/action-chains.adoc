[[ref-schedule-chains]]
= Action Chains
:description: Create action chains to automate a series of sequential actions on your clients by using the Schedule menu option to organize and manage tasks efficiently
:revdate: 2024-02-08
