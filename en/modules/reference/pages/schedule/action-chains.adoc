[[ref-schedule-chains]]
= Action Chains
:description: Create action chains to automate a series of sequential actions on clients by using the Schedule menu to define tasks that run in a specific order
:revdate: 2024-02-08
