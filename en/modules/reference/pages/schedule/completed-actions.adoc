...
= Completed Actions
:description: Learn how to effectively manage and monitor completed actions in YaST by filtering their list, archiving tasks, and accessing detailed information through
:revdate: 2020-09-11
