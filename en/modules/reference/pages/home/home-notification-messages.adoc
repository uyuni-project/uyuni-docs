...
:description: View notification messages in the Home menu to see current alerts, manage unread and all messages, refresh the list, and perform bulk actions like deleting.
:revdate: 2020-09-11
