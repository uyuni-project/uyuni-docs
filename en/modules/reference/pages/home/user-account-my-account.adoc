[[ref-home-account]]
= My Account
:description: Change your personal information, such as name, password, and title, by using the Home[User Account My Account] page menu to update details in the appropriate
:revdate: 2020-09-11
