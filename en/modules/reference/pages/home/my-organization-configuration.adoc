...
:description: Configure your organization's settings using the Home[My Organization Configuration] menu to manage options related to content staging, OpenSCAP, and SCAP scan.
:revdate: 2025-05-13
...
* For more information about deleting SCAP scan results, see xref:administration:openscap.adoc#removing-scap-scan-results[].
