...
:description: Configure organization configuration channels through the Web UI by creating and applying them to your organization using the Home[My Organization] menu.
:revdate: 2020-09-11
