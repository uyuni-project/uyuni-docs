[[ref-help-docs]]
= Documentation
:description: Open the Documentation menu item to view the current version of the documentation in a new browser tab and access locally installed documentation
:revdate: 2025-06-05
