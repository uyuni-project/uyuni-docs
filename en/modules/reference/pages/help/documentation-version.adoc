[[ref-help-docs]]
= Documentation
:description: Open the Documentation menu to view the current version of the documentation in a new browser tab which displays the locally installed documentation
:revdate: 2025-06-05
