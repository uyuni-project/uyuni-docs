...
:description: Use the mgr-create-bootstrap-repo command on the server to create a new bootstrap repository by specifying the repository name or including custom channels
:revdate: 2024-06-24
...
To remove custom channel information from your bootstrap repository, use the `--flush` option when you rebuild:
