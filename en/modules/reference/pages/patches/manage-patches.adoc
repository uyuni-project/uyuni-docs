[[ref-patches-manage]]
= Manage Patches
:description: Manage patches by viewing a list of custom patches with details like type, advisory name, description, and last update date, and by using buttons to create
:revdate: 2020-09-11
