...
= Relevant Patches
:description: Learn how to manage and deploy relevant patches released by SUSE for your installed clients through the menu Patches[Patch List Relevant] section,
:revdate: 2025-01-20
...
[NOTE]
====
To receive email when new patches are available, navigate to menu:Home[My Preferences] and check `Receive email notifications`.
====
