[[ref-patches-all]]
= All Patches
:description: View all patches in the Patches[Patch List All] section to see a list of every patch released by SUSE, including patch type and advisory number.
:revdate: 2025-01-20
