[[ref-patches-all]]
= All Patches
:description: View all patches released by SUSE in the Patches[Patch List All] section to check which ones apply to your clients and see details like type and advisory number
:revdate: 2025-01-20
