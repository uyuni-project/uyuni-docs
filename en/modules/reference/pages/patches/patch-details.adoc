[[ref-patches-details]]
= Patch Details
:description: View patch details to see information about a selected patch, including advisory numbers, affected channels, packages, and systems, and use links to access
:revdate: 2021-11-02
