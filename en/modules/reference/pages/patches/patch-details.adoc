[[ref-patches-details]]
= Patch Details
:description: Learn how to view and manage detailed information, such as advisory numbers, OVAL details, vendor advisories, vendor details, package updates, and affected
:revdate: 2021-11-02
