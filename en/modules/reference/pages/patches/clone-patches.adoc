[[ref-patches-clone]]
= Clone Patches
:description: Clone patches from existing software channels to create copies that can be distributed to clients by selecting the appropriate channel and choosing the patch.
:revdate: 2020-09-11
...
See all patches that are available for cloning by selecting the channel name in the `View patches potentially applicable to:` field, and click btn:[View].
