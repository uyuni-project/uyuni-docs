...
:description: Customize and test software packages before updating production clients using the Content Lifecycle Management menu
:revdate: 2020-09-11
:page-revdate: {revdate}

In the `Content Lifecycle` section, you can customize and test packages before updating production clients.
