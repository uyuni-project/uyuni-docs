[[ref-users-details]]
= User Details
:description: Learn how to manage and configure user permissions, assign roles, and modify access levels for clients, system groups, and channels in the YaST tools User
:revdate: 2025-06-18
