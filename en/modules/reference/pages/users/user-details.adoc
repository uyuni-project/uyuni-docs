[[ref-users-details]]
= User Details
:description: Manage user account details, permissions, and settings through the User Details section, which lets you change names and passwords, assign or remove roles
:revdate: 2025-06-18
