...
= Deactivated Users
:description: View the list of deactivated users on your Server to see usernames, real names, roles, last sign-in dates, deactivation dates, and who deactivated them.
:revdate: 2020-09-15
