[[ref-users-all]]
= All Users
:description: View all activated and deactivated users on the Server and see their details including username, real name, roles, last sign-in date, and status
:revdate: 2024-08-02
