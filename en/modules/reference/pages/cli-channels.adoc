...
:description: Learn how to effectively manage channels with the YaST tools, which include listing and deleting channels in various ways using the spacewalk-remove-channel
:revdate: 2024-06-24
...
With `spacewalk-remove-channel`, list and delete channels in various ways.



== Manage Channels with `spacewalk-remove-channel`
