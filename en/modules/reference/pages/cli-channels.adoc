...
:description: Use the spacewalk-remove-channel command line tool to manage channels on the server by listing and removing them with different options and arguments
:revdate: 2024-06-24
