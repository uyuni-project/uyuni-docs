[[ref-images-stores]]
= Images Stores
:description: Manage image stores by viewing the current list, creating new stores, refreshing the display, and performing bulk deletions after selecting multiple entries
:revdate: 2020-09-11
