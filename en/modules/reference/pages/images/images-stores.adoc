[[ref-images-stores]]
= Images Stores
:description: Manage image stores by viewing the current list, creating new stores, refreshing the display, and performing bulk actions such as deleting multiple image stores
:revdate: 2020-09-11
