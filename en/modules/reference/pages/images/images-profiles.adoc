[[ref-images-profiles]]
= Images Profiles
:description: Manage image profiles by creating, refreshing, and deleting them using the Images[Profiles] menu section, where you can select multiple profiles
:revdate: 2020-09-11
