[[ref-images-profiles]]
= Images Profiles
:description: Manage image profiles by viewing the current list, creating new profiles, refreshing the display, and performing bulk actions such as deleting multiple profiles
:revdate: 2020-09-11
