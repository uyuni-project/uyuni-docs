[[ref-images-build]]
= Images Build
:description: Build operating system images for installing on clients using the Images[Build] menu section to create customized images that can be managed and deployed
:revdate: 2020-09-11
