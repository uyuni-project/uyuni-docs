[[ref-images-build]]
= Images Build
:description: Build images for installing on clients using the Images[Build] menu section, which provides options to create operating system images that can be managed
:revdate: 2020-09-11
