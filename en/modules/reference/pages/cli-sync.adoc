...
:description: Use the Synchronization CLI Tools to manage client-server updates by selecting between mgr-sync for SUSE Customer Center-connected clients
:revdate: 2024-11-29
