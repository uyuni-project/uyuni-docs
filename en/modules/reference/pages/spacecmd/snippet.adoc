...
= snippet
:description: Create a Kickstart snippet, delete a Kickstart snippet, show a snippet's contents, list available Kickstart snippets, and update a Kickstart snippet
:revdate: 2023-06-21
