[[ref-spacecmd-errata]]
= errata
:description: Use the errata commands to apply, delete, list, search, and manage patches and their details, including affected systems, CVEs, and channels to help maintain
:revdate: 2021-08-10
