...
= custominfo
:description: Create custom keys and manage their details using commands like custominfo_createkey, custominfo_deletekey, custominfo_details, custominfo_listkeys
:revdate: 2021-08-10
