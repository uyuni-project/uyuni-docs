[[ref-spacecmd-api]]
= api
:description: Learn how to use spacecmd as a wrapper for standalone commands or scripts, gaining direct access to SUSE Multi-Linux Managers latest features via the XML-RPC
:revdate: 2024-11-29
