[[ref-spacecmd-scap]]
= scap
:description: Use the scap functions to manage and retrieve information about OpenSCAP XCCDF scans including scheduling scans, listing finished scans, and getting detailed information.
:revdate: 2023-06-21
