[[ref-spacecmd-scap]]
= scap
:description: Use the scap functions to manage OpenSCAP XCCDF scans by getting scan details, listing finished scans, scheduling new scans, and retrieving rule results
:revdate: 2023-06-21
