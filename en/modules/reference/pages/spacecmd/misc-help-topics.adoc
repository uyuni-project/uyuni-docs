...
:description: Learn how to configure and manage your systems with the YaST tools by understanding explicit date formats, using delta values to specify time intervals
:revdate: 2023-06-21
