[[ref-spacecmd-system]]
= system
:description: Manage a system by adding or removing child and config channels, installing or upgrading packages, applying errata, creating or deleting package profiles
:revdate: 2025-03-18
