[[ref-spacecmd-system]]
= system
:description: Manage a system by using functions such as adding child channels, installing packages, applying errata, comparing package profiles, and configuring settings
:revdate: 2025-03-18
