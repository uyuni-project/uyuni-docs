...
= kickstart
:description: Create a Kickstart profile to automate the installation of an operating system by adding activation keys, packages, scripts, and configuration settings
:revdate: 2023-07-03
