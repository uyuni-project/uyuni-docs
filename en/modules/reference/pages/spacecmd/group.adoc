[[ref-spacecmd-group]]
= group
:description: Manage system groups by adding, removing, creating, deleting, listing, backing up, restoring, and viewing details of groups and their members using commands
:revdate: 2021-08-10
