...
= package
:description: Use the package functions to show details, list dependencies, find errata, list systems with the package installed, list orphaned packages, and remove packages
:revdate: 2024-11-29
