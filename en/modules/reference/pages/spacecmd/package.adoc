...
= package
:description: Use the package functions to show details, list dependencies, find errata, list systems with the package installed, remove the package, and search for packages
:revdate: 2024-11-29
