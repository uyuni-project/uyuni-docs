...
= softwarechannel
:description: Manage software channels by adding, removing, cloning, and syncing packages, errata, and repos using spacecmd functions to organize and maintain channels
:revdate: 2023-06-21
