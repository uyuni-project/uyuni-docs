...
= softwarechannel
:description: Use the software channel functions to manage software channels by adding, removing, listing, syncing, and cloning channels and their packages, errata, and repos
:revdate: 2023-06-21
