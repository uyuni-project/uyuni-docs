...
= softwarechannel
:description: Learn how to manage and manipulate software channels using spacecmd functions, including adding patches and errata, cloning channels, creating new ones, listing
:revdate: 2023-06-21
