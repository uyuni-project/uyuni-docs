[[ref-spacecmd-help]]
= help
:description: Use the help function to list all available spacecmd commands and find detailed information about specific commands by typing help followed by the command name
:revdate: 2021-02-15
