[[ref-spacecmd-help]]
= help
:description: Find help for all spacecmd commands by using the help function to list available commands and get detailed information about specific commands.
:revdate: 2021-02-15
