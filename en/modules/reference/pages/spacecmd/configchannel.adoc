...
= configchannel
:description: Manage configuration channels by adding, removing, and updating files, cloning channels, listing systems, exporting and importing data, and verifying files
:revdate: 2021-08-10
