...
= configchannel
:description: Use the configchannel commands to manage configuration channels by adding, removing, updating, and verifying files, backing up, cloning, creating, and deleting.
:revdate: 2021-08-10
