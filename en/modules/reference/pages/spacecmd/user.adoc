[[ref-spacecmd-user]]
= user
:description: Manage users with spacecmd functions that let you create, delete, update, and view user accounts, including adding or removing groups and roles.
:revdate: 2023-06-21
