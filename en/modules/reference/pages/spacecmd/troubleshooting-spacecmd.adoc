...
:description: Troubleshoot problems with spacecmd by checking configuration settings, escaping command arguments, and clearing caches when needed
:revdate: 2023-11-22
...
Situation::
When creating a distribution with spacecmd it will automatically set `localhost` as the server name instead of the FQDN of {productname}.
