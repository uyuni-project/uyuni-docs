[[ref-systems-search]]
= Advanced Search
:description: Perform global searches in your SUSE Multi-Linux Manager environment using criteria such as network information, hardware devices, and packages
:revdate: 2020-09-11
