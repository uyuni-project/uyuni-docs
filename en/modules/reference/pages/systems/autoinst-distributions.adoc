[[ref-systems-distros]]
= Distributions
:description: Select a distribution from the Systems[Autoinstallation Distributions] menu to view details or create a new autoinstallable distribution using Create
:revdate: 2021-05-06
