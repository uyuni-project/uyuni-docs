...
:description: Learn how to manage and monitor system tasks by configuring YaST tools to display detailed logs of client actions, including ongoing and completed operations
:revdate: 2020-09-11
...
The `All` tab lists all actions that have been performed.
The `In Progress` tab lists all actions that are currently in progress.
The `Completed` tab lists all actions that have been completed.
