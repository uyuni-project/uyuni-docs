[[ref-systems-menu]]
= Systems Menu
:description: Manage your client systems effectively through the Systems section of the SUSE Multi-Linux Manager Server, where you can monitor client listings, update
:revdate: 2025-05-20
