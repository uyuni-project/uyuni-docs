...
:description: Manage virtual host managers from the Systems menu to collect cloud instances and organize them into virtualization groups for better control and management
:revdate: 2020-09-11
