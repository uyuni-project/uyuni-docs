...
= Bootstrapping
:description: Click Bootstrap to register a single Salt client using the Systems[Bootstrapping] section and then check the client details in the Systems[System List] menu.
:revdate: 2020-09-11
