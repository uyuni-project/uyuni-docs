[[ref-systems-list]]
= Systems List
:description: Configure your SUSE Multi-Linux Manager environment using the Systems List section to view, filter, and analyze client information across categories
:revdate: 2025-05-20
