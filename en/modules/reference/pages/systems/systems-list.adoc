[[ref-systems-list]]
= Systems List
:description: The Systems List section shows all clients in your environment, including submenus that help you find and manage different types of clients such as physical
:revdate: 2025-05-20
...
In the list, the `Extra Packages` column shows the number of non-compliant packages on the client.
...
Select the period to view from the `View systems registered` field.
