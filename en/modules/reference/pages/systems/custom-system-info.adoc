...
:description: Create custom system information to help clients in your organization identify and manage systems more effectively by defining unique keys and values
:revdate: 2020-09-11
