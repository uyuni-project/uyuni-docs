...
= Reactivation
:description: Generate reactivation keys in the Systems[Details Reactivation] section to re-register a client and restore its settings after it has been removed
:revdate: 2020-09-11
