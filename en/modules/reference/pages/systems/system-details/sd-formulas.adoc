...
= Formulas
:description: Manage formulas on the selected Salt client using the Systems[Formulas] menu to view installed formulas, select those to apply, and configure them in new
:revdate: 2022-01-05
