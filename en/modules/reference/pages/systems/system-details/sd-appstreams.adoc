...
= AppStreams
:description: Manage AppStreams by selecting enabled modules from the Systems[Software AppStreams] menu, which shows all available modules for the client and allows you
:revdate: 2024-05-03
