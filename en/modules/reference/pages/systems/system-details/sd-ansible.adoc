...
= Ansible
:description: Configure Ansible playbooks and inventory files on the Control Node by using the System Details tab to define directories and view available playbooks schedule
:revdate: 2024-03-07
