...
= Ansible
:description: Configure Ansible playbooks and inventory files on the Control Node by using the System Details tab to define playbook directories and view available playbooks
:revdate: 2024-03-07
