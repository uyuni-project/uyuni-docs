...
= Notes
:description: Add notes to a client by clicking Create Note, entering a subject and details, then clicking Create to save the note which appears in the table with a time
:revdate: 2020-09-11
