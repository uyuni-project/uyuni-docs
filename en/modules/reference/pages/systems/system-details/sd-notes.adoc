...
= Notes
:description: Add notes about the selected client by clicking the Create Note button, entering a subject and details, then clicking Create to save the note which is
:revdate: 2020-09-11
