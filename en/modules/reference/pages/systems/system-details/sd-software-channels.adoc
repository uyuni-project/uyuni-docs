...
= Software Channels
:description: Manage software channels for your current client by modifying base channel subscriptions and configuring associated child channels
:revdate: 2023-09-18
...
Toggle the `include recommended` switch to also select recommended child channels.
