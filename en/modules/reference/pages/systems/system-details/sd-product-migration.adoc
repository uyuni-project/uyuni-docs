...
= Product Migration
:description: Upgrade clients to the latest service pack of their operating system or migrate to SUSE Liberty Linux using the Systems Software Product Migration section
:revdate: 2025-03-10
