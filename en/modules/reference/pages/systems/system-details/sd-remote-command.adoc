...
= Remote Command
:description: Run remote commands on a selected client using the Systems[Details Remote Command] menu after configuring the system to accept remote commands
:revdate: 2020-09-11
