...
= Transfer
:description: Select the new organization name in the Organization Name field and click Migrate System to move a client from one organization to another in Systems
:revdate: 2023-10-04
...
To move a client to a different organization, select the name of the organization in the `Organization Name` field, and click btn:[Migrate System].
