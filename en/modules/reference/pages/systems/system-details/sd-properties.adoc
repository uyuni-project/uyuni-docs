...
= Properties
:description: Edit system details in the Systems[Details Properties] section to change information such as the system name and other settings related to the selected client
:revdate: 2020-09-11
