...
= Properties
:description: Edit system details in the Systems[Details Properties] section to change information such as the system name and other related settings for the selected client
:revdate: 2020-09-11
