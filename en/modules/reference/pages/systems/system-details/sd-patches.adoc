...
= Patches
:description: View the Patches menu to see all available updates for the selected client. Select the patches you want to install. Schedule their application using the Apply
:revdate: 2020-09-11
