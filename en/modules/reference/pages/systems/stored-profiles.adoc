...
= Stored Profiles
:description: View stored profiles in the Systems menu to compare package installations across clients and manage profile details such as names and descriptions for better
:revdate: 2020-09-11
