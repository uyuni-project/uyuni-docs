...
:description: Manage clients in the system set manager by viewing system information, applying patches, upgrading or installing packages, and configuring channels and files
:revdate: 2024-02-08
