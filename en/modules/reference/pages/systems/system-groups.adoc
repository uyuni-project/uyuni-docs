[[ref-systems-groups]]
= System Groups
:description: Manage system groups by viewing their list, selecting a group to modify its clients, and checking for available updates using icons that show when changes are made.
:revdate: 2023-08-23
