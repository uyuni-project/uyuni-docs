...
**** xref:server-kubernetes-deployment.adoc[Server Deployment on {kube}]
...
**** xref:container-deployment/uyuni/proxy-k3s-deployment-uyuni.adoc[Proxy Deployment on K3s (legacy mgrpxy)]
**** xref:container-deployment/mlm/proxy-kubernetes-deployment-mlm.adoc[Proxy Deployment on {kube}]
endif::[]
...
**** xref:container-deployment/uyuni/migrate-uyuni-proxy-mgrpxy-to-helm.adoc[Migrate K3s Proxy from mgrpxy to proxy-helm]
...
**** xref:container-deployment/mlm/migrations/proxy/proxy-mlm-51-52-kubernetes.adoc[Proxy Migration 5.1 > 5.2 on {kube}]
