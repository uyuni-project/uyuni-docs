...
:description: Install, deploy, and upgrade Server and Proxy with step-by-step instructions and guidance on requirements, configuration, migration, and management
:revdate: 2026-09-08
...
include::installation-and-upgrade:partial$snippet-upgrade-terminology-mlm.adoc[]
...
include::../partials/snippet-upgrade-terminology-mlm.adoc[]
