...
:description: Configure the network settings to ensure the server can communicate properly by setting up correct domain names and connecting to a working DNS server
:revdate: 2026-09-15
