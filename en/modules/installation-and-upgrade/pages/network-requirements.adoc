...
:description: Ensure the server can connect to a working DNS server and resolve its fully qualified domain name correctly to allow proper communication between the server and the client.
:revdate: 2025-07-08
