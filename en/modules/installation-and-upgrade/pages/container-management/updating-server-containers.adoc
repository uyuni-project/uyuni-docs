...
ifndef::backend-pdf[]
include::installation-and-upgrade:partial$snippet-rpmnew-rpmsave-info-during-upgrade.adoc[]
endif::[]

ifdef::backend-pdf[]
include::../../partials/snippet-rpmnew-rpmsave-info-during-upgrade.adoc[]
endif::[]
