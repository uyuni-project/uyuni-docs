:description: Update the host, then upgrade the {productname} Server container
:revdate: 2026-08-31
:page-revdate: {revdate}

ifeval::[{mlm-content} == true]
= {productname} Server Maintenance Update
endif::[]

ifeval::[{uyuni-content} == true]
= {productname} Server Product Upgrade
endif::[]
...
ifeval::[{uyuni-content} == true]
Before running the upgrade command, it is required to update the {productname} container tooling on the host, such as the `mgradm` tool.
endif::[]

ifndef::backend-pdf[]
include::installation-and-upgrade:partial$snippet-certificate-validators.adoc[]
endif::[]

ifdef::backend-pdf[]
include::../../partials/snippet-certificate-validators.adoc[]
endif::[]
...
. Update the {productname} container tooling:

+

[source,shell]
----
zypper up mgradm mgrctl mgradm-bash-completion mgrctl-bash-completion uyuni-storage-setup-server
----
