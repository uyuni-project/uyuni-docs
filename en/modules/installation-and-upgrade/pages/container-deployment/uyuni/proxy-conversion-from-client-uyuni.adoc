...
:description: Convert a client system to a Proxy using the Web UI by configuring SSL certificates, installing required packages, and setting up proxy settings
:revdate: 2026-08-31
