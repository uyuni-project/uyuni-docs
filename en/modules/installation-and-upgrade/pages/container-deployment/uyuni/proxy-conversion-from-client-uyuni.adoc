...
:description: Convert a client system to a Proxy using the Web UI by providing certificate details and configuring settings such as Parent FQDN and SSH port
:revdate: 2026-08-31
