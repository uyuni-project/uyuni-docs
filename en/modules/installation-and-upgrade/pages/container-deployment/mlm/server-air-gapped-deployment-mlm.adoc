...
:description: Install a server in an air-gapped environment using virtual machine images or SL Micro with preloaded container packages
:revdate: 2026-07-27
...
To upgrade {productname} Server, upgrade all packages on the host system, then run `mgradm upgrade`.
