...
:description: Install and configure the 5.2 server container on SL Micro 6.2 or SUSE Linux Enterprise Server 15 SP7 by following the steps to prepare the host system
:revdate: 2026-08-12
...
ifndef::backend-pdf[]
include::installation-and-upgrade:partial$snippet-server-sw-requirements.adoc[leveloffset=+1]
endif::[]

ifdef::backend-pdf[]
include::../../../partials/snippet-server-sw-requirements.adoc[leveloffset=+1]
endif::[]



ifndef::backend-pdf[]
include::installation-and-upgrade:partial$snippet-server-hw-requirements.adoc[leveloffset=+1]
endif::[]

ifdef::backend-pdf[]
include::../../../partials/snippet-server-hw-requirements.adoc[leveloffset=+1]
endif::[]
