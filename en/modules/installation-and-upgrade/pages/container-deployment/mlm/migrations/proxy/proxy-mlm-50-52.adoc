...
:description: Upgrade the proxy extension from version 5.0 to 5.2 on systems running SUSE Linux Enterprise Micro 5.5 or SUSE Linux Enterprise Server 15 SP6
:revdate: 2026-09-14
