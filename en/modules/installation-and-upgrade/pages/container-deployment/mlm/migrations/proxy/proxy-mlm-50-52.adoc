...
[IMPORTANT]
====
Before upgrading the proxy to {productname} {productnumber}, you must update your {productname} 5.0 Proxy to the latest available maintenance update (see xref:installation-and-upgrade:container-management/updating-proxy-containers.adoc[Proxy Maintenance Update]).
====
...
* {productname} 5.0 Proxy is updated to the latest available maintenance update (see xref:installation-and-upgrade:container-management/updating-proxy-containers.adoc[Proxy Maintenance Update]).
* Proxy system is registered with the {productname} Server.
