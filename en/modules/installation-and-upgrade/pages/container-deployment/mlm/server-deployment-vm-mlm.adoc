...
:description: Create a virtual machine using KVM and Virtual Machine Manager by importing a 5.2 image and configuring RAM, CPU, and storage settings before starting
:revdate: 2026-04-29
