...
:description: Create a virtual machine using VMware by downloading the .vmdk file, copying it to your VMware storage, and making a copy through the VMware web interface
:revdate: 2026-04-29
