[[client-upgrade]]
= Upgrade Clients
:description: Upgrade clients using the versioning system of their operating system by performing upgrades within the Web UI when using SUSE operating systems.
:revdate: 2024-11-19
