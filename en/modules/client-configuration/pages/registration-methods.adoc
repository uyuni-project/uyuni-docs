...
= Registration Methods
:description: Register clients to your server using the web UI, bootstrap script, or command line method, and make sure the clients' date and time are synchronized
:revdate: 2024-02-28
