...
:description: Create your own GPG key and use it to sign the package metadata so the installer can verify the authenticity of the software without relying on insecure
:revdate: 2024-07-10
