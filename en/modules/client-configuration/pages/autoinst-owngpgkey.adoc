...
:description: Create your own GPG key and use it to sign package metadata so you can verify software integrity without relying on insecure kernel parameters
:revdate: 2024-07-10
