[[ssm]]
= System Set Manager
:description: Use the System Set Manager to select multiple clients and perform actions like changing base channels at the same time by navigating through the Systems menu
:revdate: 2024-11-21
