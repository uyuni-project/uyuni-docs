[[ssm]]
= System Set Manager
:description: Use the System Set Manager to apply actions to multiple clients at the same time by selecting them from the System List or System Groups and then choosing
:revdate: 2024-11-21
