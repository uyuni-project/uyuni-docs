...
:description: This page shows which Rocky Linux features are available, not available, or under consideration and explains how they relate to product migration
:revdate: 2026-05-21
