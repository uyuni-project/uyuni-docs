...
:description: Register clients to a proxy to use it as a package cache and broker, allowing you to manage their connection and move them between proxies or to the server
:revdate: 2024-03-05
