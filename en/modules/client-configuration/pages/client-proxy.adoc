...
:description: Register clients to a proxy to use it as a broker and package cache, allowing you to manage connections and move clients between proxies or to the server
:revdate: 2024-03-05
