...
:description: Register Ubuntu clients by adding required software channels and using Salt for bootstrapping and initial configuration
:revdate: 2026-08-24
...
To onboard using a regular user, you must edit the `sudoers` file on the client system.
