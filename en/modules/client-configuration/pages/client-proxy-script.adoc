...
:description: Create a bootstrap script on the server container using the mgr-bootstrap command line tool to register clients to a proxy by specifying the proxy's fully
:revdate: 2025-03-20
