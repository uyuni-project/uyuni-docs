...
= Salt Bundle
:description: Install the Salt Bundle to use Salt Minion with Python 3 and required modules on client systems without relying on the client's installed Python version
:revdate: 2026-08-10
