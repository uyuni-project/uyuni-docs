...
= Salt Bundle
:description: Install the Salt Bundle on a client to provide Salt Minion, Python 3, and required modules in a single package that runs independently of the client system
:revdate: 2026-08-10
