[[system-groups]]
= System Groups
:description: Create system groups to organize clients and manage updates more efficiently by grouping them based on factors like operating system, location, or workload
:revdate: 2024-04-17
