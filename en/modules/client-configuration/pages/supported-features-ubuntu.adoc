...
:description: This page shows which Ubuntu features are available, not available, or under consideration for future support, helping users understand what they can use
:revdate: 2026-07-27
