...
:description: Register clients with a bootstrap script to control parameters and register many clients at once by creating a template script that can be copied and modified
:revdate: 2026-08-19
