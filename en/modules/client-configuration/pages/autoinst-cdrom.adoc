...
:description: Create a bootable CD-ROM or USB key to install the system when network boot over PXE is not available by preparing an ISO image with Cobbler or KIWI
:revdate: 2024-11-27
