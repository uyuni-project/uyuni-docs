...
:description: Configure clients by following steps that include registering them manually or automatically and setting up their settings for use with supported Linux systems
:revdate: 2025-05-21
