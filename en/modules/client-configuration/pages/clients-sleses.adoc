...
:description: Register SUSE Liberty Linux clients by adding required software channels and importing Red Hat or CentOS packages as custom child channels
:revdate: 2026-08-31
