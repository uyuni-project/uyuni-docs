...
:description: The different ways a client can connect to a server using Salt communication methods, including the default Salt Bundle implementation, SSH Push, and SSH Pull.
:revdate: 2024-09-27
