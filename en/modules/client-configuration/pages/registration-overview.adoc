...
= Client Registration
:description: Register a client to your server by using methods that match the client's operating system. Make sure the client's clock is synchronized with the server.
:revdate: 2025-02-06
