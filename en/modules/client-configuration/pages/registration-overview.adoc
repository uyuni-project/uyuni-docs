...
= Client Registration
:description: Register a client by using the activation key and ensuring the client's date and time are synchronized with the server before beginning the registration process
:revdate: 2025-02-06
