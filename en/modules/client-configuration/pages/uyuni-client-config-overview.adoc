...
:description: Configure clients by registering them manually or automatically, then manage their settings to ensure they work correctly with your system and support.
:revdate: 2025-05-21
