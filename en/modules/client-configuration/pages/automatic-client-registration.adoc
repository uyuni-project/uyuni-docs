...
:description: Register new clients created by Terraform automatically using cloud-init based registration or remote-exec provisioner based registration to ensure
:revdate: 2024-03-05
