...
:description: Register new clients created by Terraform automatically with cloud-init or remote-exec provisioner by using a bootstrap script and activation keys to enroll
:revdate: 2024-03-05
