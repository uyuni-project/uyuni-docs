[[channels]]
= Software Channels
:description: Manage software channels to organize and control the installation and updates of software packages on client systems by grouping them into base and child channels.
:revdate: 2024-12-12
