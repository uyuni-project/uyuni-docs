[[channels]]
= Software Channels
:description: Manage software channels to organize and control access to software packages on client systems by grouping them into base and child channels.
:revdate: 2024-12-12
