...
:description: Create a bootstrap repository to provide clients with the necessary packages during registration by automatically generating it on the server when products are registered.
:revdate: 2025-02-06
