...
= Product Migration
:description: Perform product migration to upgrade SUSE Linux Enterprise-based client systems to newer supported versions directly from the Web UI including moving between
:revdate: 2026-07-08
