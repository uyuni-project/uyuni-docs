...
= Configuration Basics
:description: Configure the environment properly by following initial steps that prepare it for client registration and enable a wide range of operations after installation
:revdate: 2025-05-20
