...
:description: Upgrade a system from SUSE Linux Enterprise Server 12 to SUSE Linux Enterprise Server 15 using YaST and AutoYaST with prepared installation media
:revdate: 2026-07-21
