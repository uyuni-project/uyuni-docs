...
:description: Set up a server with separate disk partitions for cache, PostgreSQL, and Spacewalk by copying existing data to the new partitions before running setup
:revdate: 2025-02-26
...
. Set up {productname} using `yast2 susemanager_setup`.
