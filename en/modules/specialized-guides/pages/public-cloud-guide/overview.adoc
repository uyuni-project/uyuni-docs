...
[[public-cloud-guide]]
= Public Cloud Guide
:description: Learn how to set up a server in a public cloud using on-demand, Pay-as-you-go, or Bring-your-own-subscription services
:revdate: 2026-05-06
...
These procedures have been tested on {awslongform} and {azure}.

[NOTE]
====
{byoslongform} services work on both {awslongform} and {azure}.
{payglongform} is currently only supported on {awslongform}.
====
