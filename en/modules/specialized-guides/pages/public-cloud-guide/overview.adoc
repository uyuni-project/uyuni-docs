...
[[public-cloud-guide]]
= Public Cloud Guide
:description: Learn how to set up a server in a public cloud using BYOS services and install it on a single cloud instance
:revdate: 2026-05-06
...
These procedures have been tested on {awslongform}.
