...
= Initial Setup
:description: Set up your server or proxy on a public cloud by choosing a BYOS image, launching an instance, installing the required software, and activating the public cloud.
:revdate: 2025-02-26
