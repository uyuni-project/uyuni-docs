...
= Initial Setup
:description: Set up Server or Proxy on a public cloud using the BYOS method by selecting an instance, installing the image, and configuring with YaST or SUSE setup tools
:revdate: 2025-02-26
