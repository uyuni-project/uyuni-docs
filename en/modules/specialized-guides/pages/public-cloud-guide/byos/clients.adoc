...
= Client Registration
:description: Register clients by following the steps provided after setting up the Server and Proxy to ensure they are properly enrolled and can access required services
:revdate: 2025-06-25
