...
= Client Registration
:description: Register clients by following the steps provided after setting up your Server and Proxy to ensure they are properly enrolled and can access necessary services
:revdate: 2025-06-25
...
For more information about {productname}, see documentation at https://documentation.suse.com/multi-linux-manager/
