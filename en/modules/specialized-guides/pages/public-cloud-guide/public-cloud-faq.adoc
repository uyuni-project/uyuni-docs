...
:description: Find answers to common questions about using SUSE products on the cloud with a monthly pay-as-you-go pricing model
:revdate: 2026-07-15
...
To support customers that prefer a cloud centric billing model, SUSE has recently published a new listing to the {awslongform} Marketplace, {productname}.
