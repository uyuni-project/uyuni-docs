...
= Billing - Technical
:description: Find out if you need special infrastructure for billing via cloud marketplaces and how the PAYG code base handles deployment and versioning
:revdate: 2025-02-26
