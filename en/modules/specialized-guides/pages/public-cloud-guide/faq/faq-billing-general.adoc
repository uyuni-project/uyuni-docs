...
= Billing - General
:description: How billing works for general PAYG and BYOS subscriptions, including how monthly charges are calculated based on the number of managed instances.
:revdate: 2025-02-26
