...
{payg} with {productname} is an optimal solution for those seeking control, convenience, and cost savings when managing and monitoring their infrastructure on {awslongform} and {azure}.

[NOTE]
====
{productname} is not supported on {gcplongform}.
====
//:keywords: Payg, Pay-as-you-go, AWS, Amazon Web Services, Azure, cost-effective, scaling, Cloud Services, {productname}, Monitoring
...
{payg} with {productname} is an optimal solution for those seeking control, convenience, and cost savings when managing and monitoring their infrastructure on {aws} and {azure}.
...
* *Integration with Cloud Services:* Leverage {productname} {payg} on {aws} or {azure} taking advantage of cloud infrastructure for an agile systems management experience.
