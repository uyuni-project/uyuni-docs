...
:description: Connect PAYG clients to a server and register them using the setup wizard to add connection details and then follow the registration process to link them
:revdate: 2025-02-26
