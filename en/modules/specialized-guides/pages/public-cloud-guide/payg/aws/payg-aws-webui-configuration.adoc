...
:description: Log in to the Server Web UI using your defined username and password, then navigate to the Admin Setup Wizard to configure PAYG credentials and refresh
:revdate: 2025-02-26
