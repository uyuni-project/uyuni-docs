...
:description: Learn how to connect and register multiple clients using SUSE Multi-Linux Manager for full management functionality
:revdate: 2025-02-26
...
.Procedure:
. Create a new configuration file at i.a. `/etc/venv-salt-minion/minion.d/keepalive.conf` and enable `keepalive`:
+
----
tcp_keepalive: True
