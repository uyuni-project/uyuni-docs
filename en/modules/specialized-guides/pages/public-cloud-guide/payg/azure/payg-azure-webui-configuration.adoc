...
:description: Learn about configuring and scheduling checks using the instance-flavor-check tool within SUSE Multi-Linux Manager
:revdate: 2025-02-26
...
. Login to the {productname} Server {webui}.
  Use the username and password you have defined during the setup with `mgradm install podman`.
