...
= Prepare Server
:description: Configure your SUSE Multi-Linux Manager Server by deploying, configuring, and synchronizing its software channels and activation keys
:revdate: 2025-02-06
...
From the {webui}, add `SUSE Linux Enterprise Server 15 for SAP`.
...
To check if a channel has finished synchronizing navigate to menu:Admin[Setup Wizard] and select the `Products` tab.
