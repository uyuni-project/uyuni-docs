...
= Preparing Clients
:description: Configure your client systems for an SAP cluster ensure sufficient hardware, register with SUSE Customer Center, and install the required software packages
:revdate: 2024-11-29
