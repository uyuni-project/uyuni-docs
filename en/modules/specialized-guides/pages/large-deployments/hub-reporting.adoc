[[lsd-hub-reporting]]
= Hub Reporting
:description: Aggregate reporting data from all connected peripheral servers into a central reporting database on the Hub to create a unified view of system performance
:revdate: 2026-07-21
