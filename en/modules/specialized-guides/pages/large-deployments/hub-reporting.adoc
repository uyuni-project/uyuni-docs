[[lsd-hub-reporting]]
= Hub Reporting
:description: Aggregate reporting data from all connected peripheral servers into a single central reporting database on the Hub to provide a unified view of the system
:revdate: 2026-07-21
