...
:description: Manage large scale deployments in a retail environment by installing, configuring, and updating software on servers and point-of-service terminals
:revdate: 2025-05-20
