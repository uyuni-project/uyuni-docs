...
:description: Manage large scale deployments in a retail environment by installing, configuring, and updating software on servers, workstations, and point-of-service.
:revdate: 2025-05-20
