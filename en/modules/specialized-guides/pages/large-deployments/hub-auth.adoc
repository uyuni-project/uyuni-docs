...
:description: How the Hub XMLRPC API uses three authentication modes—manual, relay, and auto-connect—to let users connect to servers by providing credentials either
:revdate: 2023-05-08
...
Auto-connect mode is similar to relay mode, it uses the Hub credentials to sign in to all peripheral servers.
