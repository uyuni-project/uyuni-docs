...
:description: Find operation recommendations for large scale deployments, including client onboarding rates, entropy availability, Salt Mine disablement, and Taskomatic job.
:revdate: 2024-12-12
...
To disable a job, click the name of the job you want to disable, select `Disable Schedule`, and click  btn:[Update Schedule].
