...
:description: Find the minimum hardware requirements for the Server and Proxy. Learn how to configure storage schedulers and estimate client download times.
:revdate: 2026-08-12
