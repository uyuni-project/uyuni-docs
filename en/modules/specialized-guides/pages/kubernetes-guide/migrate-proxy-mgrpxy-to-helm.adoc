...
:description: Migrate the Proxy on K3s from mgrpxy to proxy-helm by removing the legacy deployment and installing the proxy-helm chart with correct configuration
:revdate: 2026-06-03
