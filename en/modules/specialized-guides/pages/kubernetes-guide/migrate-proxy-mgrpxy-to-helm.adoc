...
:description: Migrate the Proxy on K3s from mgrpxy to proxy-helm by uninstalling the legacy deployment and installing the proxy-helm chart with preserved configuration
:revdate: 2026-06-03
