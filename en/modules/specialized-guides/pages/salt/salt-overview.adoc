[[salt-overview]]
= Salt Guide Overview
:description: Learn how to use Salt to manage clients, configure systems, and run commands remotely by working with the Salt master on the server that controls access
:revdate: 2026-09-03
