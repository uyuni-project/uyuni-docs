[[salt-overview]]
= Salt Guide Overview
:description: Use Salt to manage clients by running commands, configuring systems, and organizing tasks through a central server that controls access and permissions
:revdate: 2026-09-03
