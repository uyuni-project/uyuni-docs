[[salt.formulas]]
= Salt Formulas
:description: Create and manage Salt Formulas to define and apply consistent system configurations using reusable Salt States which automate and document
:revdate: 2022-01-11
