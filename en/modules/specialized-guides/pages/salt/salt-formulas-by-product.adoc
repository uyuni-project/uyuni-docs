...
:description: Install formulas provided by the system using Zypper from the pool software channel then activate them through the Web UI to apply configurations to selected
:revdate: 2025-02-06
