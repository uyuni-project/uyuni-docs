[[salt-connectivity]]
= {salt} Connectivity
:description: Check connectivity between Salt clients and the Server or Proxy using test.ping commands and adjust keepalive settings to prevent connection loss
:revdate: 2024-11-28
