[[salt.timeouts]]
= {salt} timeouts
:description: The page Salt timeouts explains how Salt uses timeout and gatherjobtimeout parameters to manage job execution and client responses, including how presence
:revdate: 2025-05-13
