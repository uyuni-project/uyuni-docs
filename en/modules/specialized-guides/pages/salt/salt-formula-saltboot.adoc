[[saltboot-formula]]
= {saltboot} Formula
:description: Configure the Saltboot formula to set up disk images and partitioning for the selected hardware type by specifying disk and partition parameters
:revdate: 2024-05-14
