[[monitoring-formula]]
= Monitoring Formula
:description: Configure the Prometheus formula to set monitoring parameters, scrape intervals, TLS settings, alerting rules, and data sources for monitoring services
:revdate: 2026-07-14
