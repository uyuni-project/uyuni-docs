...
:description: Write custom Salt formulas with forms by creating a form.yml file that defines editable attributes and place the formula states and metadata in the correct
:revdate: 2025-02-06
