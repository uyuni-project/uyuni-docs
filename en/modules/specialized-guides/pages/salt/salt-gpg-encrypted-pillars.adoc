...
:description: Decrypt GPG-encrypted Pillar data on the Salt Master during Pillar rendering using the GPG keyring configured in the master or master.d directory
:revdate: 2026-01-12
