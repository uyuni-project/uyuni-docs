...
:description: Learn how to deploy Saline, a powerful tool designed as a Prometheus exporter, to collect metrics based on events from the Salt event bus
:revdate: 2025-04-07
...
To remove Saline from the {productname} Server use `mgradm upgrade podman` with `--saline-replicas 0`.
