[[dhcpd-formula]]
= DHCPd Formula
:description: Configure the DHCP service on your branch server using the step-by-step procedure for configuring DHCP settings in the SUSE Multi-Linux Manager Web UI
:revdate: 2022-01-05
