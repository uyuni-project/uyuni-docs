[[dhcpd-formula]]
= DHCPd Formula
:description: Configure the DHCP service on the branch server by using the DHCPd formula to set parameters such as domain name, IP address ranges, and network interfaces.
:revdate: 2022-01-05
