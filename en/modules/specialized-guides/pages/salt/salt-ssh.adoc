[[salt.ssh]]
= Salt SSH
:description: Use Salt SSH to run Salt commands and states directly over SSH by creating SSH connections on demand when the server performs an action on a client
:revdate: 2025-02-06
