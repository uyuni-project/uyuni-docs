[[tftpd-formula]]
= TFTPd Formula
:description: Configure the TFTP service on the branch server by using the TFTPd formula to set the internal network address, TFTP base directory, and user
:revdate: 2025-06-12
