[[salt.command]]
= Salt Command
:description: Use the Salt command to run tasks on one or more clients by specifying a target, function, and arguments where the target identifies the client or group
:revdate: 2024-12-12
