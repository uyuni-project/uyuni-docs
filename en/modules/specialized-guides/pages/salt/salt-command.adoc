[[salt.command]]
= Salt Command
:description: Use the Salt command to run tasks on one or more clients by specifying a target, selecting a function from available modules, and providing any needed parameters.
:revdate: 2024-12-12
