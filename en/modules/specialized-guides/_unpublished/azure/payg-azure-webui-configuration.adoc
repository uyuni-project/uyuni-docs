...
:description: Log in to the PAYG Web UI and configure the PAYG credentials and product list using the Setup Wizard in the Admin menu, then refresh the product list
:revdate: 2025-02-26
