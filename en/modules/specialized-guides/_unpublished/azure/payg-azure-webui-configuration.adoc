...
:description: Log in to the PAYG Web UI to configure credentials and refresh the product list, then check the status and verify that the Proxy, Server, and Free products
:revdate: 2025-02-26
...
. Login to the {productname} Server {webui}.
  Use the username and password you have defined during the setup with `mgradm install`.
