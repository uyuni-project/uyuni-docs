...
:description: Check the system requirements for Azure to understand the necessary configurations and tools, such as the *mgr-storage-server* tool, needed to set up
:revdate: 2025-06-06
