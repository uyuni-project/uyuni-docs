...
[[azure-server-setup]]
= Initial Setup
:description: Log in to the virtual machine, update the system to prepare it for use, then configure the network settings to ensure the PAYG setup is correctly connected
:revdate: 2025-03-03
