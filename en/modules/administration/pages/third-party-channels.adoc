...
= Third-party Channels
:description: Manage third-party channels by synchronizing optional repositories, importing required GPG keys, and using commands to add keys from files or remote URLs
:revdate: 2026-08-31
