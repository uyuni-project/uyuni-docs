[[compliance-as-code]]
= Compliance as Code
:description: Run compliance as code remediation using an Ansible playbook by selecting a playbook from the control node menu and scheduling it to apply
:revdate: 2025-06-12
