...
:description: Manage user roles and permissions through the Web UI or API to control access to specific functions and resources based on predefined or custom roles
:revdate: 2026-09-03
