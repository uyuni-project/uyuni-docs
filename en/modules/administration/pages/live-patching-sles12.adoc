...
:description: Install the kgraft package on SLES12 clients and apply the highstate to enable live patching then reboot the system to manage kernel updates without
:revdate: 2024-02-01
