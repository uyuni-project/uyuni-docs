...
:description: Install the kgraft package on SLES12 clients and apply the highstate to enable live patching then reboot the client to manage kernel updates without system downtime.
:revdate: 2024-02-01
