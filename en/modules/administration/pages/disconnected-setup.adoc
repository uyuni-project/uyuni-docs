[[disconnected-setup]]
= Disconnected Setup
:description: Set up a disconnected environment using RMT or SMT to synchronize software channels and repositories from SUSE Customer Center to removable storage
:revdate: 2025-05-27
