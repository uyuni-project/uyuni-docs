...
:description: Audit clients with OpenSCAP to check system security configuration and verify patches using SCAP content files
:revdate: 2026-08-18
...
| Debian | 12 | `openscap-scanner` | `scap-security-guide-debian`
