...
:description: Configure Automatic Channels Synchronization explains how to check and change automatic synchronization settings for a channel so users can control
:revdate: 2026-05-08
