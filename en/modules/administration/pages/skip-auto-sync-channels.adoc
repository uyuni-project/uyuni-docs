...
:description: Configure automatic channel synchronization to control when channels get updated from upstream repositories, allowing you to check their status using an API
:revdate: 2026-05-08
