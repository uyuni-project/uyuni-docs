[[channel-management]]
= Channel Management
:description: Manage software channels to organize packages by grouping them into base and child channels, allowing clients to install compatible packages from repositories
:revdate: 2025-02-28
