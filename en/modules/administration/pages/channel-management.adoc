[[channel-management]]
= Channel Management
:description: Manage software channels to organize packages by grouping them into base and child channels, ensuring systems install only compatible packages
:revdate: 2025-02-28
