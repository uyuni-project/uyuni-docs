...
This section is about auditing your clients.
For auditing the actions that users perform on the {productname} Server, such as logins and API calls, see xref:administration:admin-audit-logging.adoc[].
