...
= Resizing BTRFS
:description: Resize a BTRFS LVM partition on a SUSE Linux Enterprise Server by adding a new disk to the volume group and using commands to extend the logical volume
:revdate: 2026-05-13
