...
= Resizing BTRFS
:description: Resize a BTRFS LVM partition on SUSE Linux Enterprise Server by adding a new disk to the volume group and extending the logical volume to use the additional space.
:revdate: 2026-05-13
