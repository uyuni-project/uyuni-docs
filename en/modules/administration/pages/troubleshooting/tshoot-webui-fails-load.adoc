...
:description: Clear the browser cache and reload the page to fix the issue when the Web UI fails to load after migration because the new system has the same hostname and IP address.
:revdate: 2022-10-18
