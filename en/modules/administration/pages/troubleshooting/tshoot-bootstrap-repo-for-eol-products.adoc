...
:description: Create bootstrap repositories manually for end-of-life products by using the command line to list unsupported repositories and generate new ones
:revdate: 2024-10-31
