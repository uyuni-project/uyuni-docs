...
= Troubleshooting Schema Upgrade Fails
:description: Find the cause of a failed schema upgrade by checking the database version and service status, then use commands like mgradm start or version check to get
:revdate: 2024-05-15
