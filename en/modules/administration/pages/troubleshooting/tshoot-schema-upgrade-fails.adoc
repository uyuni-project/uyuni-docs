...
= Troubleshooting Schema Upgrade Fails
:description: Troubleshoot schema upgrade failure by checking database version and service status, then run commands to get debug information and fix the problem
:revdate: 2024-05-15
