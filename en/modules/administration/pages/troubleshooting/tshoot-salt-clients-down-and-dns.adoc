...
:description: Check DNS settings on the Salt client to ensure correct resolution and avoid delays during FQDN grain calculation which can cause the client to appear down
:revdate: 2024-05-15
