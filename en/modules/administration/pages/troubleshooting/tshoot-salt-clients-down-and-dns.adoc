...
:description: Check DNS settings on the Salt client to ensure they are correct because incorrect settings can cause the client to appear down during actions like
:revdate: 2024-05-15
