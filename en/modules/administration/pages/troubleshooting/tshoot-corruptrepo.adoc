...
:description: Remove corrupt or outdated repository metadata files from the cache directory and regenerate them to fix problems that prevent clients from updating correctly
:revdate: 2024-11-26
