...
:description: Remove corrupt or outdated repository metadata files from the cache directory and regenerate them to restore normal update functionality for clients
:revdate: 2024-11-26
