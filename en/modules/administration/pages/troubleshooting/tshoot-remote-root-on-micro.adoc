...
:description: Enable password-based remote root login on SL Micro by editing the SSH configuration file, setting PermitRootLogin yes, and reloading the SSH service
:revdate: 2026-04-29
