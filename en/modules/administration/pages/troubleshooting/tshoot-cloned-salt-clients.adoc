...
:description: Fix the problem when a cloned Salt client cannot register because it has the same machine ID as an existing system by changing the machine ID of the cloned client.
:revdate: 2022-10-18
