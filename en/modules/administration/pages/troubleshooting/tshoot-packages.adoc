...
:description: Check package locks and exclude lists on the client to find out if packages are locked or excluded then take action to remove or adjust them so
:revdate: 2025-02-06
