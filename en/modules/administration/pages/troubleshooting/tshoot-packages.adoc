...
:description: Check package locks and exclude lists on the client to find out if packages are locked or excluded, which can prevent the server from correctly identifying
:revdate: 2025-02-06
