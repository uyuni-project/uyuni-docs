...
:description: Learn how to protect data using hardware-based Trusted Execution Environment (TEE) and manage attestation processes for secure systems
:revdate: 2025-07-17
...
[role=procedure]
. The attestation container is enabled during the installation of {productname} with `mgradm install`.
