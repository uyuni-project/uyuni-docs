[[organizations]]
= Organizations
:description: Create and manage organizations to control user access and permissions, set up authentication methods, assign users and roles, and configure settings
:revdate: 2022-01-13
