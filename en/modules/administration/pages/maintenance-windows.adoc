[[maintenance-windows]]
= Maintenance Windows
:description: Create maintenance windows by defining a calendar with iCal format events and assigning the schedule to clients to control when restricted actions like
:revdate: 2021-09-01
