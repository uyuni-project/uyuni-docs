[[ssl-certs]]
= SSL Certificates
:description: Create and use SSL certificates to verify that clients connect to the correct server by checking the server certificate during the SSL handshake
:revdate: 2025-05-08
