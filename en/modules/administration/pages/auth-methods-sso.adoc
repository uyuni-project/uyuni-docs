...
:description: Configure your system to use single sign-on (SSO) by setting up the Security Assertion Markup Language (SAML) protocol to allow users to log in to multiple
:revdate: 2024-05-06
