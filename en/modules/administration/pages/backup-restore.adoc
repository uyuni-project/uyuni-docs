[[backup-restore]]
= Backup and Restore
:description: Create backups of your system using the mgradm backup command to ensure all important data including databases, configurations, containers, and volumes are
:revdate: 2026-04-29
