...
[IMPORTANT]
====
Due to the introduction of the xref:administration:reporting-database.adoc[Reporting Database], [command]``spacewalk-report`` now gathers by default the data from the reporting database. 
